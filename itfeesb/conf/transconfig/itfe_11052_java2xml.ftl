	...
	<MSG>
		...
		<CorrectBody1105>
			<CorrectInfo1105>
				...
				<#if var1.CorrectInfo1105.ElectroTaxVouNo?exists>
				...
				<#if var1.CorrectInfo1105.ChannelCode?exists>
				<ChannelCode>${var1.CorrectInfo1105.ChannelCode}</ChannelCode>
				</#if>
			</CorrectInfo1105>
			...
			<CorrectOld1105>
				...
				<OriTaxOrgCode>${var1.CorrectOld1105.OriTaxOrgCode}</OriTaxOrgCode>
				...
				<OriTrimSign>${var1.CorrectOld1105.OriTrimSign}</OriTrimSign>
			...
			<CorrectNow1105>
				<CorTaxOrgCode>${var1.CorrectNow1105.CorTaxOrgCode}</CorTaxOrgCode>
				...
				<CurTrimSign>${var1.CorrectNow1105.CurTrimSign}</CurTrimSign>
