...
<Voucher>
	...
	<DetailList>
	 ...
	 <Detail>
		...
		<#if var.ExpFuncCode1?exists>
		<ExpFuncCode1>${var.ExpFuncCode1}</ExpFuncCode1>
		</#if>
		<#if var.ExpFuncName1?exists>
		<ExpFuncName1>${var.ExpFuncName1}</ExpFuncName1>
		</#if>
		<#if var.ExpFuncCode2?exists>
		<ExpFuncCode2>${var.ExpFuncCode2}</ExpFuncCode2>
		</#if>
		<#if var.ExpFuncName2?exists>
		<ExpFuncName2>${var.ExpFuncName2}</ExpFuncName2>
		</#if>
		<#if var.ExpFuncCode3?exists>
		<ExpFuncCode3>${var.ExpFuncCode3}</ExpFuncCode3>
		</#if>
		<#if var.ExpFuncName3?exists>
		<ExpFuncName3>${var.ExpFuncName3}</ExpFuncName3>
		</#if>
