...
public class YakLengthProtocol extends DirectProtocol
{
  private static final Log logger = LogFactory.getLog(YakLengthProtocol.class);
  private static final int SIZE_INT = 4;
  public static final int NO_MAX_LENGTH = -1;
  private int maxMessageLength;

  public YakLengthProtocol()
  {
    this(-1);
  }

  public YakLengthProtocol(int maxMessageLength) {
    super(false, 4);
