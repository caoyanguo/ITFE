...
public class HisMainCommApplyPayBean implements IPageDataProvider {
	...
	public HisMainCommApplyPayBean(ICommApplyPayQueryService commApplyPayService, HtvPayreckBankDto maindto){
	...
	public PageResponse retrieve(PageRequest request) {
		try {
			PageResponse response = commApplyPayService.findMainByPageForHis(maindto, request, expfunccode, payamt);
