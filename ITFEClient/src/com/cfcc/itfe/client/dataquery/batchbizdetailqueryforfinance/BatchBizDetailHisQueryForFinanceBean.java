...
public class BatchBizDetailHisQueryForFinanceBean extends BasicModel implements
		IPageDataProvider {
	
	private HtfPaymentDetailsmainDto searchDto;
	...
	public BatchBizDetailHisQueryForFinanceBean() {
		super();
	...
	public String searchDtoList(Object o){
		if(o instanceof HtfPaymentDetailsmainDto){
			searchDto = (HtfPaymentDetailsmainDto)o;
		}
...
//			pagingContext.setPageNum(response.getTotalCount());
	...
	public HtfPaymentDetailsmainDto getSearchDto() {
		return searchDto;
	}

	public void setSearchDto(HtfPaymentDetailsmainDto searchDto) {
