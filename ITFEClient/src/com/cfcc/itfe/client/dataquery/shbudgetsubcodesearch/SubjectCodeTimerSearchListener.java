...
public class SubjectCodeTimerSearchListener extends KeyAdapter{
	private static Log log = LogFactory.getLog(SubjectCodeTimerSearchListener.class);
	private Composite composite;
	private ContainerMetaData metadata;
	AbstractMetaDataEditorPart editor;
	private String maname ;
	private ShbudgetsubcodesearchBean bean;

	public SubjectCodeTimerSearchListener(Composite composite, ContainerMetaData metadata,BasicModel bean,String metaname) {
		this.composite = composite;
		this.metadata = metadata;
		this.editor = MVCUtils.getEditor(metadata.editorid);
		this.bean = (ShbudgetsubcodesearchBean) bean;
