...
public class FinanceDirecPayAdjustVoucherHisBean extends BasicModel implements
		IPageDataProvider {
	
	private HtfDirectpayAdjustmainDto searchDto;
	...
	public FinanceDirecPayAdjustVoucherHisBean() {
		super();
	...
	public String searchDtoList(Object o){
		if(o instanceof HtfDirectpayAdjustmainDto){
			searchDto = (HtfDirectpayAdjustmainDto)o;
		}
...
//			pagingContext.setPageNum(response.getTotalCount());
	...
	public HtfDirectpayAdjustmainDto getSearchDto() {
		return searchDto;
	}

	public void setSearchDto(HtfDirectpayAdjustmainDto searchDto) {
