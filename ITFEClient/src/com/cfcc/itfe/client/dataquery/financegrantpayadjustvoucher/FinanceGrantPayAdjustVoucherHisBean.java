...
public class FinanceGrantPayAdjustVoucherHisBean extends BasicModel implements
		IPageDataProvider {
	
	private HtfGrantpayAdjustmainDto searchDto;
	...
	public FinanceGrantPayAdjustVoucherHisBean() {
		super();
	...
	public String searchDtoList(Object o){
		if(o instanceof HtfGrantpayAdjustmainDto){
			searchDto = (HtfGrantpayAdjustmainDto)o;
		}
...
//			pagingContext.setPageNum(response.getTotalCount());
	...
	public HtfGrantpayAdjustmainDto getSearchDto() {
		return searchDto;
	}

	public void setSearchDto(HtfGrantpayAdjustmainDto searchDto) {
