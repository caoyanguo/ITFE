 ...
 * 
 * @author t60
 * @time 12-02-24 10:44:47 子系统: DataQuery 模块:TvFinIncomeonline
...
public class TvFinIncomeonlineBean extends AbstractTvFinIncomeonlineBean
	...
	private List<TvFinIncomeonlineDto> excheckList;// 选中记录
	...
	public TvFinIncomeonlineBean() {
		...
		dto.setSacct(TimeFacade.getCurrentStringTime());// 统计日期默认当天
	...
	public String exportTable(Object o) {
		...
		String fileName = filePath + File.separator + "3129电子税票("
	...
	public String exportTableForWhere(List<TvFinIncomeonlineDto> templist,
		...
		String sql = "财政机关代码,申请日期,包流水号,国库代码,国库名称,征收机关代码,付款行行号,交易流水号,原报文编号,交易金额,付款人开户行行号,付款开户行名称,缴款单位名称,付款人账号,税票号码,开票日期,纳税人编号,纳税人名称,预算种类,调整期标志,企业代码,企业名称,企业类型,预算科目代码,预算科目名称,限缴日期,税种代码,税种名称,预算级次,预算级次名称,税款所属日期起,税款所属日期止,辅助标志,税款类型,账务日期,处理状态,备注,备注1,备注2,录入员代码,系统更新时间,业务流水号	";
