 ...
 * 组件:BigdataPayreck
 */
public class BigdataPayreckBean extends AbstractBigdataPayreckBean implements IPageDataProvider {

    private static Log log = LogFactory.getLog(BigdataPayreckBean.class);
    private List<TvPayreckBigdataListDto> sublist;
    private PagingContext tablepage;
    private ITFELoginInfo loginfo;
    private TvPayreckBigdataDto mainDto;
    private TvPayreckBigdataDto bldto;
    private List<Mapper> bankCodeList;
    protected ICommonDataAccessService commonDataAccessService = (ICommonDataAccessService)getService(ICommonDataAccessService.class);
    public BigdataPayreckBean() {
      super();
      searchdto = new TvPayreckBigdataDto();
      updatedto = new TvPayreckBigdataDto();
      bldto = new TvPayreckBigdataDto();
    ...
    public String doubleclick(Object o){
    	mainDto = (TvPayreckBigdataDto) o;
    	try {
    		TvPayreckBigdataListDto searchdto = new TvPayreckBigdataListDto();
    ...
    public String checkall(Object o){
    	...
    	if(response!=null&&response.getData()!=null&&response.getData().size()>0)
    	{
    		if(selectDataList==null)
    			selectDataList = new ArrayList<TvPayreckBigdataDto>();
	...
	public List<TvPayreckBigdataListDto> getSublist() {
		return sublist;
	}

	public void setSublist(List<TvPayreckBigdataListDto> sublist) {
	...
	public TvPayreckBigdataDto getMainDto() {
		return mainDto;
	}

	public void setMainDto(TvPayreckBigdataDto mainDto) {
		this.mainDto = mainDto;
	}

	public TvPayreckBigdataDto getBldto() {
		return bldto;
	}

	public void setBldto(TvPayreckBigdataDto bldto) {
		this.bldto = bldto;
	}
