...
public class ActiveXCompositeRecvReconciliationOcx extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositeRecvReconciliationOcx.class);
	// ole控件对象
	 ...
	 * @param parent
	 */
	public ActiveXCompositeRecvReconciliationOcx(Composite parent) {
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositeRecvReconciliationOcx.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositeRecvReconciliationOcx.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositeRecvReconciliationOcx.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	return v.getInt();
	}
...
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
	...
	public static void setStampName(String stampName) {
		ActiveXCompositeRecvReconciliationOcx.stampName = stampName;
	}
	...
	public static void setModelId(String modelId) {
		ActiveXCompositeRecvReconciliationOcx.modelId = modelId;
	}
}