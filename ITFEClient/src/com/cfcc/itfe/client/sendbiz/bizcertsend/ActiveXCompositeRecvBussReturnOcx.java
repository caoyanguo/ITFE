...
public class ActiveXCompositeRecvBussReturnOcx extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositeRecvBussReturnOcx.class);
	// ole控件对象
	 ...
	 * @param parent
	 */
	public ActiveXCompositeRecvBussReturnOcx(Composite parent) {
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositeRecvBussReturnOcx.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositeRecvBussReturnOcx.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositeRecvBussReturnOcx.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	return v.getInt();
	}
...
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
	...
	public static void setStampName(String stampName) {
		ActiveXCompositeRecvBussReturnOcx.stampName = stampName;
	}
	...
	public static void setModelId(String modelId) {
		ActiveXCompositeRecvBussReturnOcx.modelId = modelId;
	}
}