...
public class ActiveXCompositeReconciliationReturnOcx extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositeReconciliationReturnOcx.class);
	// ole控件对象
	 ...
	 * @param parent
	 */
	public ActiveXCompositeReconciliationReturnOcx(Composite parent) {
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositeReconciliationReturnOcx.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositeReconciliationReturnOcx.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositeReconciliationReturnOcx.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	return v.getInt();
	}
...
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
	...
	public static void setStampName(String stampName) {
		ActiveXCompositeReconciliationReturnOcx.stampName = stampName;
	}
	...
	public static void setModelId(String modelId) {
		ActiveXCompositeReconciliationReturnOcx.modelId = modelId;
	}
}