...
import com.cfcc.itfe.client.recbiz.voucherindividualstatement.VoucherIndividualStatementBean;
...
public class ActiveXCompositevoucherIndividualStatementOcx extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositevoucherIndividualStatementOcx.class);
	// ole控件对象
	...
	public static String getVoucherStamp(TvVoucherinfoDto vDto,String certID,String stampPosition,String stampID)  {
		...
		String voucherXML="";
		try {
			voucherXML = ((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getVoucherXMl(vDto);
	...
	public static void init(int num) {
		...
		voucherDtoList = ((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getCheckList();
		...
		int count=((VoucherIndividualStatementBean) context.getModelHolder().getModel()).queryVoucherJOintCount(infoDto);
		if(count==-1){
		...
		retList=((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getStampEnums(infoDto);
		...
		String printCounts= ((VoucherIndividualStatementBean) context.getModelHolder().getModel()).queryVoucherPrintCount(infoDto);		
		...
		if (i == 0) {
			try {				
				i = AddVoucherXmls(((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getVoucherXMl(infoDto));	
			} catch (Exception e) {
	 ...
	 * @param parent
	 */
	public ActiveXCompositevoucherIndividualStatementOcx(Composite parent) {
	...
	protected void createStampContents(Composite composite) {
		...
		context = DataBindingContext
				.createInstance("b4bcaabd-e66f-467b-aa68-00183284dff2");
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositevoucherIndividualStatementOcx.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositevoucherIndividualStatementOcx.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositevoucherIndividualStatementOcx.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	...
	private class BtnPrintSelection extends SelectionAdapter {
		...
		public void widgetSelected(SelectionEvent e) {
			try {											
				voucherDtoList = ((VoucherIndividualStatementBean) context.getModelHolder()
	...
	public boolean verifyPrintCount(TvVoucherinfoDto dto){		
		if(!(dto.getSvtcode().equals(MsgConstant.VOUCHER_NO_2301)||dto.getSvtcode().equals(MsgConstant.VOUCHER_NO_2302)||
			...
			try {
				dto=((VoucherIndividualStatementBean) context.getModelHolder()
					.getModel()).getDto(dto);
		...
		String printCount=((VoucherIndividualStatementBean) context.getModelHolder()
	...
	private class BtnReturn extends SelectionAdapter {
		...
		public void widgetSelected(SelectionEvent e) {
			try {
				IModelHolder holder = MVCUtils.openEditor("个性化对账单");
				MVCUtils.openComposite("个性化对账单", "维护界面");
				((VoucherIndividualStatementBean) context.getModelHolder().getModel())
						.getCheckList().clear();
				((AbstractMetaDataEditorPart) ((VoucherIndividualStatementBean) context
	...
	private class BtnStamp extends SelectionAdapter {
		public void widgetSelected(SelectionEvent e) {
			try{
				...
				list.add(stampName);
				list.add(((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)));
				
				String stamptCounts= ((VoucherIndividualStatementBean) context.getModelHolder().getModel()).voucherStamp(list);
				if(stamptCounts.equals("0")){
					String returnmsg = ((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSreturnerrmsg();
					((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getCheckList().get(listCount).setSreturnerrmsg(returnmsg);
					MessageDialog.openMessageDialog(null, returnmsg);
				}else if(stamptCounts.equals("1")){
					String demo = ((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSdemo();
					((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getCheckList().get(listCount).setSstatus(DealCodeConstants.VOUCHER_STAMP);
					((VoucherIndividualStatementBean) context.getModelHolder().getModel()).getCheckList().get(listCount).setSdemo(demo);
	...
	public static void setStampName(String stampName) {
		ActiveXCompositevoucherIndividualStatementOcx.stampName = stampName;
	}
}