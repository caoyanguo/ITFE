...
public class ActiveXCompositeSendBussOcx extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositeSendBussOcx.class);
	// ole控件对象
	...
	public static String modelId = "172cbbcb-ceb2-4d12-ab5b-bbbc2bf2f93a";
	/**
	 * 生成签章报文（读取UKEY印章）
	 * 
	 * @param dto
	 ...
	 * @param parent
	 */
	public ActiveXCompositeSendBussOcx(Composite parent) {
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositeSendBussOcx.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositeSendBussOcx.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositeSendBussOcx.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	return v.getInt();
	}
...
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
	...
	public static void setStampName(String stampName) {
		ActiveXCompositeSendBussOcx.stampName = stampName;
	}
	...
	public static void setModelId(String modelId) {
		ActiveXCompositeSendBussOcx.modelId = modelId;
	}
}