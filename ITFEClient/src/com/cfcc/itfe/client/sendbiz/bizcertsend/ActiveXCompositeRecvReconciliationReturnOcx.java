...
public class ActiveXCompositeRecvReconciliationReturnOcx extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositeRecvReconciliationReturnOcx.class);
	// ole控件对象
	...
	public static String modelId = "6fa4ee3f-30de-44ac-b359-8e56e625eccd";
	/**
	 * 生成签章报文（读取UKEY印章）
	 * 
	 * @param dto
	...
	public static void init(int num) {
		...
		if(context.getModelHolder().getModel() instanceof RecvReportReconciliationBean)
			voucherDtoList = ((RecvReportReconciliationBean) context.getModelHolder().getModel()).getReturnList();
		else if(context.getModelHolder().getModel() instanceof RecvBusinessReconciliationBean)
			voucherDtoList = ((RecvBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList();
	 ...
	 * @param parent
	 */
	public ActiveXCompositeRecvReconciliationReturnOcx(Composite parent) {
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositeRecvReconciliationReturnOcx.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositeRecvReconciliationReturnOcx.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositeRecvReconciliationReturnOcx.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	return v.getInt();
	}
		...
		public void widgetSelected(SelectionEvent e) {
			try {
				if(context.getModelHolder().getModel() instanceof RecvReportReconciliationBean)
				{
					...
					((RecvReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().clear();
				...
				}else if(context.getModelHolder().getModel() instanceof RecvBusinessReconciliationBean)
				{
					...
					((RecvBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().clear();
...
//						MessageDialog.openMessageDialog(null, ((VoucherReportBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSreturnerrmsg());
						...
						((RecvReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSreturnerrmsg(returnmsg);
...
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
						...
						((RecvReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSstatus(DealCodeConstants.VOUCHER_STAMP);
						((RecvReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSdemo(demo);
						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
					}
				}else if(context.getModelHolder().getModel() instanceof RecvBusinessReconciliationBean)
				{
...
//						MessageDialog.openMessageDialog(null, ((VoucherReportBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSreturnerrmsg());
						...
						((RecvBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSreturnerrmsg(returnmsg);
						MessageDialog.openMessageDialog(null, returnmsg);
					}else if(stamptCounts.equals("1")){
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
						String demo = ((RecvBusinessReconciliationBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSdemo();
						((RecvBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSstatus(DealCodeConstants.VOUCHER_STAMP);
						((RecvBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSdemo(demo);
						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
					}
				}
				init(listCount);
	...
	public static void setStampName(String stampName) {
		ActiveXCompositeRecvReconciliationReturnOcx.stampName = stampName;
	}
	...
	public static void setModelId(String modelId) {
		ActiveXCompositeRecvReconciliationReturnOcx.modelId = modelId;
	}
}