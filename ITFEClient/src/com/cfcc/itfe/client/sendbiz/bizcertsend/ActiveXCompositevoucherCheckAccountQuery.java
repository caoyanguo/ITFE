...
public class ActiveXCompositevoucherCheckAccountQuery extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositevoucherCheckAccountQuery.class);
	// ole控件对象
	...
	public static void init(int num) {		
		voucherDtoList = ((VoucherCheckAccountQueryBean) context.getModelHolder().getModel())
		.getCheckList();
		...
		int count=((VoucherCheckAccountQueryBean) context.getModelHolder().getModel()).queryVoucherJOintCount(infoDto);
		if(count==-1){
		...
		String printCounts= ((VoucherCheckAccountQueryBean) context.getModelHolder().getModel()).queryVoucherPrintCount(infoDto);		
	 ...
	 * @param parent
	 */
	public ActiveXCompositevoucherCheckAccountQuery(Composite parent) {
	...
	protected void createStampContents(Composite composite) {
		...
		context = DataBindingContext
				.createInstance("a26cd4a1-3e22-4632-a9ca-f8e849ceae2e");
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositevoucherCheckAccountQuery.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositevoucherCheckAccountQuery.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositevoucherCheckAccountQuery.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	...
	private class BtnReturn extends SelectionAdapter {
		...
		public void widgetSelected(SelectionEvent e) {
			try {
				IModelHolder holder = MVCUtils.openEditor("接收凭证对账");
				MVCUtils.openComposite("接收凭证对账", "维护界面");
				((VoucherCheckAccountQueryBean) context.getModelHolder().getModel())
						.getCheckList().clear();
				((AbstractMetaDataEditorPart) ((VoucherCheckAccountQueryBean) context
