...
public class ActiveXCompositeSendBussReturnOcx extends Composite {
	
	private static Log logger=LogFactory.getLog(ActiveXCompositeSendBussReturnOcx.class);
	// ole控件对象
	...
	public static void init(int num) {
		...
		if(context.getModelHolder().getModel() instanceof SendReportReconciliationBean)
			voucherDtoList = ((SendReportReconciliationBean) context.getModelHolder().getModel()).getReturnList();
		else if(context.getModelHolder().getModel() instanceof SendBusinessReconciliationBean)
			voucherDtoList = ((SendBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList();
	 ...
	 * @param parent
	 */
	public ActiveXCompositeSendBussReturnOcx(Composite parent) {
	...
	public int printVoucher(String voucherNo, int pageNo) {
		...
		Variant v = ActiveXCompositeSendBussReturnOcx.execActivexMethod(
	 ...
	 */
	public int pageUp() {
		Variant v = ActiveXCompositeSendBussReturnOcx.execActivexMethod(OcxConstant.PAGEUP,
				new Object[] {});
		int result = v.getInt();
	 ...
	 */
	public int pageDown() {
		Variant v = ActiveXCompositeSendBussReturnOcx.execActivexMethod(OcxConstant.PAGEDOWN,
				new Object[] {});
	return v.getInt();
	}
...
//			voucherno="";
//			if(!AdminConfirmDialogFacade.open("B_247", "凭证对账", "授权打印凭证", msg)){
		...
		public void widgetSelected(SelectionEvent e) {
			try {
				if(context.getModelHolder().getModel() instanceof SendReportReconciliationBean)
				{
					...
					((SendReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().clear();
				...
				}else if(context.getModelHolder().getModel() instanceof SendBusinessReconciliationBean)
				{
					...
					((SendBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().clear();
...
//						MessageDialog.openMessageDialog(null, ((VoucherReportBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSreturnerrmsg());
						...
						((SendReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSreturnerrmsg(returnmsg);
...
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
						...
						((SendReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSstatus(DealCodeConstants.VOUCHER_STAMP);
						((SendReportReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSdemo(demo);
						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
					}
				}else if(context.getModelHolder().getModel() instanceof SendBusinessReconciliationBean)
				{
...
//						MessageDialog.openMessageDialog(null, ((VoucherReportBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSreturnerrmsg());
						...
						((SendBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSreturnerrmsg(returnmsg);
						MessageDialog.openMessageDialog(null, returnmsg);
					}else if(stamptCounts.equals("1")){
//						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
						String demo = ((SendBusinessReconciliationBean) context.getModelHolder().getModel()).getDto(voucherDtoList.get(listCount)).getSdemo();
						((SendBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSstatus(DealCodeConstants.VOUCHER_STAMP);
						((SendBusinessReconciliationBean) context.getModelHolder().getModel()).getReturnList().get(listCount).setSdemo(demo);
						MessageDialog.openMessageDialog(null, stampName+"签章成功！");
					}
				}
				init(listCount);
	...
	public static void setStampName(String stampName) {
		ActiveXCompositeSendBussReturnOcx.stampName = stampName;
	}
	...
	public static void setModelId(String modelId) {
		ActiveXCompositeSendBussReturnOcx.modelId = modelId;
	}
}