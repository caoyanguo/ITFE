...
public class ReconcileRefundSubBean extends BasicModel implements
		IPageDataProvider {

	private TfReconcileRefundSubDto searchDto;
	...
	public String searchDtoList(Object o){
		if(o instanceof TfReconcileRefundSubDto){
			searchDto = (TfReconcileRefundSubDto)o;
		}
...
//			pagingContext.setPageNum(response.getTotalCount());
	...
	public TfReconcileRefundSubDto getSearchDto() {
		return searchDto;
	}

	public void setSearchDto(TfReconcileRefundSubDto searchDto) {
