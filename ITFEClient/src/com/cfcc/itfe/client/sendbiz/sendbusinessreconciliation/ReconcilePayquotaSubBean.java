...
public class ReconcilePayquotaSubBean extends BasicModel implements
		IPageDataProvider {

	private TfReconcilePayquotaSubDto searchDto;
	...
	public ReconcilePayquotaSubBean() {
		super();
	...
	public String searchDtoList(Object o){
		if(o instanceof TfReconcilePayquotaSubDto){
			searchDto = (TfReconcilePayquotaSubDto)o;
		}
...
//			pagingContext.setPageNum(response.getTotalCount());
	...
	public TfReconcilePayquotaSubDto getSearchDto() {
		return searchDto;
	}

	public void setSearchDto(TfReconcilePayquotaSubDto searchDto) {
