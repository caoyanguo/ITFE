...
public class ReportIncomeSubBean extends BasicModel implements
		IPageDataProvider {

	private TfReportIncomeSubDto searchDto;
	...
	public String searchDtoList(Object o){
		if(o instanceof TfReportIncomeSubDto){
			searchDto = (TfReportIncomeSubDto)o;
		}
...
//			pagingContext.setPageNum(response.getTotalCount());
	...
	public TfReportIncomeSubDto getSearchDto() {
		return searchDto;
	}

	public void setSearchDto(TfReportIncomeSubDto searchDto) {
