...
public class ReportDepositSubBean extends BasicModel implements
		IPageDataProvider {

	private TfReportDepositSubDto searchDto;
	...
	public String searchDtoList(Object o){
		if(o instanceof TfReportDepositSubDto){
			searchDto = (TfReportDepositSubDto)o;
		}
...
//			pagingContext.setPageNum(response.getTotalCount());
	...
	public TfReportDepositSubDto getSearchDto() {
		return searchDto;
	}

	public void setSearchDto(TfReportDepositSubDto searchDto) {
