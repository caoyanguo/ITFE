 ...
 * 
 * @author wangtuo
 * @time 10-04-08 12:58:21 子系统: Para 模块:TsCoderegtype 组件:TsCoderegtype
 */
public class TsCoderegtypeBean extends AbstractTsCoderegtypeBean implements
	...
	public String inputSave(Object o) {
		if (null == dto.getSregcode() || "".equals(dto.getSregcode())) {
			MessageDialog.openMessageDialog(null, "登记代码不能为空！");
			return null;
		}
		if (null == dto.getSregname() || "".equals(dto.getSregname())) {
			MessageDialog.openMessageDialog(null, "登记代码含义不能为空！");
			return null;
		}
		try {
			dto.setSorgcode(loginfo.getSorgcode());
	...
	public String delete(Object o) {
		...
		if (!org.eclipse.jface.dialogs.MessageDialog.openQuestion(this.editor
				.getCurrentComposite().getShell(), "提示", "是否要删除选择的登记代码:"
				+ dto.getSregcode())) {
			return "";
		}
		try {
