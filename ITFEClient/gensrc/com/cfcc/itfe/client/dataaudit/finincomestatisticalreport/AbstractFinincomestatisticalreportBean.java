 ...
 */
public abstract class AbstractFinincomestatisticalreportBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataaudit_finincomestatisticalreport_finincomestatisticalreport_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractFinincomestatisticalreportBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataaudit_finincomestatisticalreport_finincomestatisticalreport.properties");
			...
			log.warn("为itfe_dataaudit_finincomestatisticalreport_finincomestatisticalreport读取messages出错", e);
		}
