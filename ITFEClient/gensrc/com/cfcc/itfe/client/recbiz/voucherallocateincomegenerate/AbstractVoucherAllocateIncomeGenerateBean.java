package com.cfcc.itfe.client.recbiz.voucherallocateincomegenerate;
 ...
 * @generated
 * 子系统: RecBiz
 * 模块:VoucherAllocateIncomeGenerate
 * 组件:VoucherAllocateIncomeGenerate
 */
public abstract class AbstractVoucherAllocateIncomeGenerateBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_voucherallocateincomegenerate_voucherallocateincomegenerate_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractVoucherAllocateIncomeGenerateBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_voucherallocateincomegenerate_voucherallocateincomegenerate.properties");
			...
			log.warn("为itfe_recbiz_voucherallocateincomegenerate_voucherallocateincomegenerate读取messages出错", e);
		}
