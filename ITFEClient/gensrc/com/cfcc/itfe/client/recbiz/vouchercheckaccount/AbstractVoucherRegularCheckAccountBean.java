 ...
 * @generated
 * 子系统: RecBiz
 * 模块:voucherCheckAccount
 * 组件:VoucherRegularCheckAccount
 */
public abstract class AbstractVoucherRegularCheckAccountBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_vouchercheckaccount_voucherregularcheckaccount_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractVoucherRegularCheckAccountBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_vouchercheckaccount_voucherregularcheckaccount.properties");
			...
			log.warn("为itfe_recbiz_vouchercheckaccount_voucherregularcheckaccount读取messages出错", e);
		}
