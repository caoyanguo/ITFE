...
import com.cfcc.itfe.service.recbiz.uploadmodule.IUploadUIService;
 ...
 * 组件:UploadUI
 */
public abstract class AbstractUploadUIBean extends BasicModel {
	/** LOG */
	final Log log = LogFactory.getLog(this.getClass());
	
	/** service */
    protected IUploadUIService uploadUIService = (IUploadUIService)getService(IUploadUIService.class);
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_uploadmodule_uploadui_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractUploadUIBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_uploadmodule_uploadui.properties");
			...
			log.warn("为itfe_recbiz_uploadmodule_uploadui读取messages出错", e);
		}
