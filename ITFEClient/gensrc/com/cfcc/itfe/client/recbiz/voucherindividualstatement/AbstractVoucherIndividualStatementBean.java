 ...
 */
public abstract class AbstractVoucherIndividualStatementBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_voucherindividualstatement_voucherindividualstatement_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractVoucherIndividualStatementBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_voucherindividualstatement_voucherindividualstatement.properties");
			...
			log.warn("为itfe_recbiz_voucherindividualstatement_voucherindividualstatement读取messages出错", e);
		}
