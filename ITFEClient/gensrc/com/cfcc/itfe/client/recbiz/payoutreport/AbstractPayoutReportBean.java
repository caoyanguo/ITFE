...
import com.cfcc.itfe.service.recbiz.payoutreport.IPayoutReportService;
 ...
 * 组件:PayoutReport
 */
public abstract class AbstractPayoutReportBean extends BasicModel {
	/** LOG */
	...
	protected IPayoutReportService payoutReportService = (IPayoutReportService)getService(IPayoutReportService.class);
		
	/** 属性列表 */
    TvVoucherinfoDto dto = null;
    PagingContext pagingcontext = null;
    private Properties MESSAGE_PROPERTIES;
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_payoutreport_payoutreport_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractPayoutReportBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_payoutreport_payoutreport.properties");
			...
			log.warn("为itfe_recbiz_payoutreport_payoutreport读取messages出错", e);
		}
