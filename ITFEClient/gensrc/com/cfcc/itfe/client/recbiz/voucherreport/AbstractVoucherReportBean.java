 ...
 * 组件:VoucherReport
 */
public abstract class AbstractVoucherReportBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_voucherreport_voucherreport_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractVoucherReportBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_voucherreport_voucherreport.properties");
			...
			log.warn("为itfe_recbiz_voucherreport_voucherreport读取messages出错", e);
		}
