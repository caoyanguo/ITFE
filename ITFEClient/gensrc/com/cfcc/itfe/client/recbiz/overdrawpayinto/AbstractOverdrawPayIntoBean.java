 ...
 * 组件:OverdrawPayInto
 */
public abstract class AbstractOverdrawPayIntoBean extends BasicModel {
	/** LOG */
    ...
    TbsTvGrantpayplanMainDto searchdto = null;
    private Properties MESSAGE_PROPERTIES;
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_overdrawpayinto_overdrawpayinto_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractOverdrawPayIntoBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_overdrawpayinto_overdrawpayinto.properties");
			...
			log.warn("为itfe_recbiz_overdrawpayinto_overdrawpayinto读取messages出错", e);
		}
    ...
    public com.cfcc.itfe.persistence.dto.TbsTvGrantpayplanMainDto getSearchdto() {
        return searchdto;
    }

    public void setSearchdto(com.cfcc.itfe.persistence.dto.TbsTvGrantpayplanMainDto _searchdto) {
