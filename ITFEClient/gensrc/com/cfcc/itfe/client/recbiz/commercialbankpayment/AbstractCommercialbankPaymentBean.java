 ...
 * @generated
 * 子系统: RecBiz
 * 模块:commercialbankPayment
 * 组件:CommercialbankPayment
 */
public abstract class AbstractCommercialbankPaymentBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_commercialbankpayment_commercialbankpayment_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractCommercialbankPaymentBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_commercialbankpayment_commercialbankpayment.properties");
			...
			log.warn("为itfe_recbiz_commercialbankpayment_commercialbankpayment读取messages出错", e);
		}
