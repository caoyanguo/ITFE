 ...
 */
public abstract class AbstractVoucherFundRemainGenerateBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_voucherfundremaingenerate_voucherfundremaingenerate_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractVoucherFundRemainGenerateBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_voucherfundremaingenerate_voucherfundremaingenerate.properties");
			...
			log.warn("为itfe_recbiz_voucherfundremaingenerate_voucherfundremaingenerate读取messages出错", e);
		}
