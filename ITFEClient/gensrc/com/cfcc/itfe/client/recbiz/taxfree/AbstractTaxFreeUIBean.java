 ...
 * 组件:TaxFreeUI
 */
public abstract class AbstractTaxFreeUIBean extends BasicModel {
	/** LOG */
    ...
    TbsTvFreeDto searchdto = null;
    private Properties MESSAGE_PROPERTIES;
	private static final String MESSAGE_KEY_PREFIX = "itfe_recbiz_taxfree_taxfreeui_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractTaxFreeUIBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_recbiz_taxfree_taxfreeui.properties");
			...
			log.warn("为itfe_recbiz_taxfree_taxfreeui读取messages出错", e);
		}
	 ...
	 * messages: 
	 */
    public String goToPiliang(Object o){
    ...
    public com.cfcc.itfe.persistence.dto.TbsTvFreeDto getSearchdto() {
        return searchdto;
    }

    public void setSearchdto(com.cfcc.itfe.persistence.dto.TbsTvFreeDto _searchdto) {
