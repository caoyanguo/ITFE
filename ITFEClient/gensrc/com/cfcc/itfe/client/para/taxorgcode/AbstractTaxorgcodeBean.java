...
public abstract class AbstractTaxorgcodeBean extends BasicModel {
    ...
    public AbstractTaxorgcodeBean() {
		...
		try {
			...
			log.warn("为itfe_para_taxorgcode_taxorgcode读取messages出错", e);
		}
	 ...
	 * ename: search
	 * 引用方法: 
	 * viewers: 征收机关与节点对应关系查询结果
	 * messages: 
	 */
    public String search(Object o){
        
        return "征收机关与节点对应关系查询结果";
    }
	 ...
	 * ename: adddata
	 * 引用方法: 
	 * viewers: 征收机关与节点对应关系录入界面
	 * messages: 
	 */
    public String adddata(Object o){
        
        return "征收机关与节点对应关系录入界面";
    }
	 ...
	 * ename: updatedata
	 * 引用方法: 
	 * viewers: 征收机关与节点对应关系修改界面
	 * messages: 
	 */
    public String updatedata(Object o){
        
        return "征收机关与节点对应关系修改界面";
    }
