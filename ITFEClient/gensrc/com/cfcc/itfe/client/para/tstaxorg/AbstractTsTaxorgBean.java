 ...
 * 组件:TsTaxorg
 */
public abstract class AbstractTsTaxorgBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_para_tstaxorg_tstaxorg_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractTsTaxorgBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_para_tstaxorg_tstaxorg.properties");
			...
			log.warn("为itfe_para_tstaxorg_tstaxorg读取messages出错", e);
		}
