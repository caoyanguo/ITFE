 ...
 */
public abstract class AbstractSendReportReconciliationBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_sendreportreconciliation_sendreportreconciliation_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractSendReportReconciliationBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_sendreportreconciliation_sendreportreconciliation.properties");
			...
			log.warn("为itfe_sendbiz_sendreportreconciliation_sendreportreconciliation读取messages出错", e);
		}
