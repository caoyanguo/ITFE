 ...
 * 组件:Tspayoutbackmsg
 */
public abstract class AbstractTspayoutbackmsgBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_tspayoutbackmsg_tspayoutbackmsg_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractTspayoutbackmsgBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_tspayoutbackmsg_tspayoutbackmsg.properties");
			...
			log.warn("为itfe_sendbiz_tspayoutbackmsg_tspayoutbackmsg读取messages出错", e);
		}
