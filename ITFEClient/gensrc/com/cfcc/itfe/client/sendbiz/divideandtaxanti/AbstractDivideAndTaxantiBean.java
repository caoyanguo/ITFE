 ...
 * 组件:DivideAndTaxanti
 */
public abstract class AbstractDivideAndTaxantiBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_divideandtaxanti_divideandtaxanti_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractDivideAndTaxantiBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_divideandtaxanti_divideandtaxanti.properties");
			...
			log.warn("为itfe_sendbiz_divideandtaxanti_divideandtaxanti读取messages出错", e);
		}
