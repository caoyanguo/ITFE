 ...
 * @generated
 * 子系统: SendBiz
 * 模块:sendBusinessReconciliation
 * 组件:SendBusinessReconciliation
 */
public abstract class AbstractSendBusinessReconciliationBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_sendbusinessreconciliation_sendbusinessreconciliation_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractSendBusinessReconciliationBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_sendbusinessreconciliation_sendbusinessreconciliation.properties");
			...
			log.warn("为itfe_sendbiz_sendbusinessreconciliation_sendbusinessreconciliation读取messages出错", e);
		}
