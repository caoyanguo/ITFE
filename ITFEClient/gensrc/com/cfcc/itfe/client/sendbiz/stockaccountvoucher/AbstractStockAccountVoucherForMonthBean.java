 ...
 */
public abstract class AbstractStockAccountVoucherForMonthBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_stockaccountvoucher_stockaccountvoucherformonth_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractStockAccountVoucherForMonthBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_stockaccountvoucher_stockaccountvoucherformonth.properties");
			...
			log.warn("为itfe_sendbiz_stockaccountvoucher_stockaccountvoucherformonth读取messages出错", e);
		}
