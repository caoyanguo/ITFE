 ...
 */
public abstract class AbstractNewBusinessReconciliationBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_newbusinessreconciliation_newbusinessreconciliation_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractNewBusinessReconciliationBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_newbusinessreconciliation_newbusinessreconciliation.properties");
			...
			log.warn("为itfe_sendbiz_newbusinessreconciliation_newbusinessreconciliation读取messages出错", e);
		}
