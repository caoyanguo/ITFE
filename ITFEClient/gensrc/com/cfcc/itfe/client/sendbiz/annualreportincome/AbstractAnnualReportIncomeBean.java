 ...
 */
public abstract class AbstractAnnualReportIncomeBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_annualreportincome_annualreportincome_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractAnnualReportIncomeBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_annualreportincome_annualreportincome.properties");
			...
			log.warn("为itfe_sendbiz_annualreportincome_annualreportincome读取messages出错", e);
		}
