 ...
 * @generated
 * 子系统: SendBiz
 * 模块:directPayReturnReceipt
 * 组件:DirectPayReturnReceipt
 */
public abstract class AbstractDirectPayReturnReceiptBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_directpayreturnreceipt_directpayreturnreceipt_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractDirectPayReturnReceiptBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_directpayreturnreceipt_directpayreturnreceipt.properties");
			...
			log.warn("为itfe_sendbiz_directpayreturnreceipt_directpayreturnreceipt读取messages出错", e);
		}
