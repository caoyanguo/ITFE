 ...
 */
public abstract class AbstractDirectPayDayreportBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_sendbiz_directpaydayreport_directpaydayreport_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractDirectPayDayreportBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_sendbiz_directpaydayreport_directpaydayreport.properties");
			...
			log.warn("为itfe_sendbiz_directpaydayreport_directpaydayreport读取messages出错", e);
		}
