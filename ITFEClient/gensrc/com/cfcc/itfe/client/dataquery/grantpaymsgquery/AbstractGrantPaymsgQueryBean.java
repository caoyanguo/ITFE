 ...
 * 组件:GrantPaymsgQuery
 */
public abstract class AbstractGrantPaymsgQueryBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_grantpaymsgquery_grantpaymsgquery_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractGrantPaymsgQueryBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_grantpaymsgquery_grantpaymsgquery.properties");
			...
			log.warn("为itfe_dataquery_grantpaymsgquery_grantpaymsgquery读取messages出错", e);
		}
