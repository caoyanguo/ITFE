 ...
 * @generated
 * 子系统: DataQuery
 * 模块:BudgetIncomeQuerySubjectReport
...
public abstract class AbstractBudgetIncomeQuerySubjectReportBean extends BasicModel {
    ...
    public AbstractBudgetIncomeQuerySubjectReportBean() {
		...
		try {
			...
			log.warn("为itfe_dataquery_budgetincomequerysubjectreport_budgetincomequerysubjectreport读取messages出错", e);
		}
	 ...
	 * ename: query
	 * 引用方法: 
	 * viewers: 分科目统计分析查询结果显示界面
	 * messages: 
	 */
    public String query(Object o){
        
        return "分科目统计分析查询结果显示界面";
    }
	 ...
	 * ename: goBack
	 * 引用方法: 
	 * viewers: 分科目统计分析查询条件显示界面
	 * messages: 
	 */
    public String goBack(Object o){
        
        return "分科目统计分析查询条件显示界面";
    }
