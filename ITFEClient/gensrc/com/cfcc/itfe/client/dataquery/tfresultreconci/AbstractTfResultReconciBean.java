 ...
 * 组件:TfResultReconci
 */
public abstract class AbstractTfResultReconciBean extends BasicModel {
	/** LOG */
	final Log log = LogFactory.getLog(this.getClass());
	
	/** service */
    protected ITfResultReconciService tfResultReconciService = (ITfResultReconciService)getService(ITfResultReconciService.class);
		
	/** 属性列表 */
    TfResultReconciDto searchDto = null;
    PagingContext pagingcontext = null;
    String reportPath = null;
    List rsList = null;
    HashMap paramMap = null;
    TfResultReconciDto printDto = null;
    String reportPathDetail = null;
    List rsListDetail = null;
    HashMap paramMapDetail = null;
    private Properties MESSAGE_PROPERTIES;
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_tfresultreconci_tfresultreconci_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractTfResultReconciBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_tfresultreconci_tfresultreconci.properties");
			...
			log.warn("为itfe_dataquery_tfresultreconci_tfresultreconci读取messages出错", e);
		}
    ...
    public com.cfcc.itfe.persistence.dto.TfResultReconciDto getSearchDto() {
        return searchDto;
    }

    public void setSearchDto(com.cfcc.itfe.persistence.dto.TfResultReconciDto _searchDto) {
    ...
    public com.cfcc.itfe.persistence.dto.TfResultReconciDto getPrintDto() {
        return printDto;
    }

    public void setPrintDto(com.cfcc.itfe.persistence.dto.TfResultReconciDto _printDto) {
        printDto = _printDto;
    }
