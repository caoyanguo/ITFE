 ...
 * @generated
 * 子系统: DataQuery
 * 模块:FinBudgetRecCountReport
 * 组件:FinBudgetRecCountReport
 */
public abstract class AbstractFinBudgetRecCountReportBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_finbudgetreccountreport_finbudgetreccountreport_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractFinBudgetRecCountReportBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_finbudgetreccountreport_finbudgetreccountreport.properties");
			...
			log.warn("为itfe_dataquery_finbudgetreccountreport_finbudgetreccountreport读取messages出错", e);
		}
	 ...
	 * ename: goBack
	 * 引用方法: 
	 * viewers: 财政预算收入统计报表查询条件
	 * messages: 
	 */
    public String goBack(Object o){
        
        return "财政预算收入统计报表查询条件";
    }
