 ...
 * @generated
 * 子系统: DataQuery
 * 模块:payBankRefundQuery
 * 组件:PayBankRefundQuery
 */
public abstract class AbstractPayBankRefundQueryBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_paybankrefundquery_paybankrefundquery_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractPayBankRefundQueryBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_paybankrefundquery_paybankrefundquery.properties");
			...
			log.warn("为itfe_dataquery_paybankrefundquery_paybankrefundquery读取messages出错", e);
		}
