 ...
 */
public abstract class AbstractSelectRecordThreeGDBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_selectrecord3_selectrecordthreegd_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractSelectRecordThreeGDBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_selectrecord3_selectrecordthreegd.properties");
			...
			log.warn("为itfe_dataquery_selectrecord3_selectrecordthreegd读取messages出错", e);
		}
