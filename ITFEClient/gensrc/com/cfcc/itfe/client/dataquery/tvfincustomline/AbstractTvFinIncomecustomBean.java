 ...
 */
public abstract class AbstractTvFinIncomecustomBean extends BasicModel {
	/** LOG */
	...
	/** 属性列表 */
    TvFinCustomonlineDto dto = null;
    PagingContext pagingcontext = null;
    private Properties MESSAGE_PROPERTIES;
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_tvfincustomline_tvfinincomecustom_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractTvFinIncomecustomBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_tvfincustomline_tvfinincomecustom.properties");
			...
			log.warn("为itfe_dataquery_tvfincustomline_tvfinincomecustom读取messages出错", e);
		}
    ...
    public com.cfcc.itfe.persistence.dto.TvFinCustomonlineDto getDto() {
        return dto;
    }

    public void setDto(com.cfcc.itfe.persistence.dto.TvFinCustomonlineDto _dto) {
        dto = _dto;
    }
