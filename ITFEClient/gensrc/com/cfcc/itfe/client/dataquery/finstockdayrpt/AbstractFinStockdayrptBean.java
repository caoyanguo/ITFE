 ...
 * 组件:FinStockdayrpt
 */
public abstract class AbstractFinStockdayrptBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_finstockdayrpt_finstockdayrpt_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractFinStockdayrptBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_finstockdayrpt_finstockdayrpt.properties");
			...
			log.warn("为itfe_dataquery_finstockdayrpt_finstockdayrpt读取messages出错", e);
		}
	...
	/**
	 * Direction: 导出库存统计信息大于1万
	 * ename: exportexcelbyfamt
	 * 引用方法: 
	 * viewers: 库存日报表查询条件
	 * messages: 
	 */
