 ...
 * @generated
 * 子系统: DataQuery
 * 模块:finIncomeAndExpensesReportQuery
 * 组件:FinIncomeAndExpensesReportQuery
 */
public abstract class AbstractFinIncomeAndExpensesReportQueryBean extends BasicModel {
	/** LOG */
	...
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_finincomeandexpensesreportquery_finincomeandexpensesreportquery_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractFinIncomeAndExpensesReportQueryBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_finincomeandexpensesreportquery_finincomeandexpensesreportquery.properties");
			...
			log.warn("为itfe_dataquery_finincomeandexpensesreportquery_finincomeandexpensesreportquery读取messages出错", e);
		}
