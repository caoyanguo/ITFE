 ...
 * 组件:TfReconciliation
 */
public abstract class AbstractTfReconciliationBean extends BasicModel {
	/** LOG */
	final Log log = LogFactory.getLog(this.getClass());
	
	/** service */
    protected ITfReconciliationService tfReconciliationService = (ITfReconciliationService)getService(ITfReconciliationService.class);
		
	/** 属性列表 */
    TfReconciliationDto searchDto = null;
    PagingContext pagingcontext = null;
    String reportPath = null;
    List rsList = null;
    HashMap paramMap = null;
    TfReconciliationDto printDto = null;
    String reportPathDetail = null;
    List rsListDetail = null;
    HashMap paramMapDetail = null;
    private Properties MESSAGE_PROPERTIES;
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_tfreconciliation_tfreconciliation_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractTfReconciliationBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_tfreconciliation_tfreconciliation.properties");
			...
			log.warn("为itfe_dataquery_tfreconciliation_tfreconciliation读取messages出错", e);
		}
    ...
    public com.cfcc.itfe.persistence.dto.TfReconciliationDto getSearchDto() {
        return searchDto;
    }

    public void setSearchDto(com.cfcc.itfe.persistence.dto.TfReconciliationDto _searchDto) {
    ...
    public com.cfcc.itfe.persistence.dto.TfReconciliationDto getPrintDto() {
        return printDto;
    }

    public void setPrintDto(com.cfcc.itfe.persistence.dto.TfReconciliationDto _printDto) {
        printDto = _printDto;
    }
