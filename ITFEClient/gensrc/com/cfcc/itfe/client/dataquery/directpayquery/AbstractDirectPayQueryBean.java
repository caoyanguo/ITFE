 ...
 * 组件:DirectPayQuery
 */
public abstract class AbstractDirectPayQueryBean extends BasicModel {
	/** LOG */
	final Log log = LogFactory.getLog(this.getClass());
	
	/** service */
    protected IDirectPayService directPayService = (IDirectPayService)getService(IDirectPayService.class);
	protected ICommonDataAccessService commonDataAccessService = (ICommonDataAccessService)getService(ICommonDataAccessService.class);
		
	/** 属性列表 */
    List selectDataList = null;
    private Properties MESSAGE_PROPERTIES;
	private static final String MESSAGE_KEY_PREFIX = "itfe_dataquery_directpayquery_directpayquery_";
	
    /** Message */
    
    
    /** 构造函数 */
    public AbstractDirectPayQueryBean() {
		super();
		//
		MESSAGE_PROPERTIES = new Properties();
		try {
			InputStream is = com.cfcc.jaf.common.util.ResourceUitl
					.getClassPathInputStream("/messages/itfe_dataquery_directpayquery_directpayquery.properties");
			...
			log.warn("为itfe_dataquery_directpayquery_directpayquery读取messages出错", e);
		}
