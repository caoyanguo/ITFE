...
public class ExpReportIncome extends AbstractExpReport {
	...
	public String makeReportByBiz(TrIncomedayrptDto idto, String bizType,
		...
		// 报表查询条件
		String sqlWhere="";
		sqlWhere = CommonMakeReport.makesqlwhere(idto);
		// 数据表中的报表类型
		...
		try {
            ...
            if(null!=sfuncbdgsbtcode&&""!=sfuncbdgsbtcode){
            	sfuncbdgsbtcode = sfuncbdgsbtcode.replaceAll(",", "','");
            	sqlWhere += " AND S_BUDGETSUBCODE IN ('"+sfuncbdgsbtcode+"')";
            }
