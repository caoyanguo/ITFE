...
public class ExpDwbkReportForGZ extends AbstractExpReport {
	...
	public String makeReportByBiz(TrIncomedayrptDto idto, String bizType,
		...
		try {
			...
			String filename = CommonMakeReport.getExpFileNameByBillTypeForGZ(idto,
					bizType,taxorg);
			...
			if (resList.size() > 0) {
				...
				StringBuffer filebuf = new StringBuffer(
						"skgkdm,mdgkdm,ssgkdm,ysjc,jgdm,kmdm,zwrq,tkyydm,yszl,rlj,ylj,nlj\r\n");
