...
public class ExpCheckingReportIncomeForGZ extends AbstractExpReport {
	...
	public String makeReportByBiz(TrIncomedayrptDto idto, String bizType,
		...
		if (strimflag.equals(StateConstant.TRIMSIGN_FLAG_NORMAL)) {
			rptType=StateConstant.REPORTTYPE_FLAG_NRBUDGETBILL;
			queryDto.setSbillkind(StateConstant.REPORTTYPE_FLAG_NRBUDGETBILL);
		}else{
			rptType=StateConstant.REPORTTYPE_FLAG_TRBUDGETBILL;
			queryDto.setSbillkind(StateConstant.REPORTTYPE_FLAG_TRBUDGETBILL);
		}
