package com.cfcc.itfe.service.para.tstaxorg;
...
public class TsTaxorgService extends AbstractTsTaxorgService {
	private static Log log = LogFactory.getLog(TsTaxorgService.class);
	...
	public void addInfo(IDto dtoInfo) throws ITFEBizException {
		try {
			...
			if (e.getSqlState().equals("23505")) {
				throw new ITFEBizException("字段核算主体代码，国库代码，征收机关代码已存在，不能重复录入！", e);
			}
