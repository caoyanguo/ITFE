package com.cfcc.itfe.service.para.tsoperationform;
...
import com.cfcc.itfe.service.para.tsoperationform.AbstractTsOperationformService;
...
public class TsOperationformService extends AbstractTsOperationformService {
	private static Log log = LogFactory.getLog(TsOperationformService.class);	
    ...
    public IDto addInfo(IDto dtoInfo) throws ITFEBizException {
    	try {
			...
			if (e.getSqlState().equals("23505")) { 
				throw new ITFEBizException("字段模版ID，联标识已存在，不能重复录入！", e);
			}
