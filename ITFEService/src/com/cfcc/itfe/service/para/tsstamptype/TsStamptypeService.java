package com.cfcc.itfe.service.para.tsstamptype;
...
public class TsStamptypeService extends AbstractTsStamptypeService {
	private static Log log = LogFactory.getLog(TsStamptypeService.class);	
	...
	public void addInfo(IDto dtoInfo) throws ITFEBizException {
		try {
			...
			if (e.getSqlState().equals("23505")) { 
				throw new ITFEBizException("该签章类型代码已存在，不能重复录入！", e);
			}
