package com.cfcc.itfe.service.sendbiz.finincomecheckresendrequest;
...
public class FinincomecheckresendrequestService extends AbstractFinincomecheckresendrequestService {
	private static Log log = LogFactory.getLog(FinincomecheckresendrequestService.class);	
	/**
	 * sendMsg
    ...
    public void sendMsg(TvSendlogDto dto) throws ITFEBizException {
		...
		headdto.set_msgNo(MsgConstant.MSG_NO_9116);
		try {
