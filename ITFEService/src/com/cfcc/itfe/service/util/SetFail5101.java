...
public class SetFail5101 {
	...
	public void setFail(IDto dto, String orgcode)throws ITFEBizException{
		if(dto instanceof TbsTvPayoutDto){
			TbsTvPayoutDto paydto = (TbsTvPayoutDto)dto;
		...
		try {
			...
			logger.error("实拨5101业务异常!", e);
			throw new ITFEBizException("实拨5101业务异常!", e);
		}
	}
	}
