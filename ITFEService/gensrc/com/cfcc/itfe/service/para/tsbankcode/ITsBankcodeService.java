 ...
 * codecomment: 
 */
public interface ITsBankcodeService extends IService {
   ...
   public abstract void modInfo(IDto dtoInfo) throws ITFEBizException;
	 ...
	 * @throws ITFEBizException	 
	 */
   public abstract PageResponse findBanknoByPage(TsBankcodeDto findDto, PageRequest pageRequest) throws ITFEBizException;
