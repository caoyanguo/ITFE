 ...
 * codecomment: 
 */
public interface ITsConverttaxorgService extends IService {
   ...
   public abstract void delInfo(IDto dtoInfo) throws ITFEBizException;
	 ...
	 * @throws ITFEBizException	 
	 */
   public abstract void modInfo(IDto initdto, IDto dtoInfo) throws ITFEBizException;
	 ...
	 * @throws ITFEBizException	 
	 */
   public abstract void dataimport(String filepath, String importtype) throws ITFEBizException;
