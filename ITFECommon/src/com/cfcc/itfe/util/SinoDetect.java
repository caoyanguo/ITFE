...
public class SinoDetect {
	...
	public static void main(String argc[]) {
		String fileName = "e:/201303187301250.txt";
		String test = "2334324r32ÄãºÃ,maldsjfaklhe";
		try {
...
//			System.out.println("File encode " + SinoDetect.nicename[detect.detectEncoding(buffer)]);
			System.out.println("String encode " + SinoDetect.nicename[detect.detectEncoding(test.getBytes())]);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
