...
public class VoucherDto2MapFor5901 implements IVoucherDto2Map {

	private static Log logger = LogFactory.getLog(VoucherDto2MapFor5901.class);
	...
	private List getDataList(TvVoucherinfoDto vDto, SQLExecutor execDetail)
		...
		try {
			...
			if (vDto.getSext4() == null || vDto.getSext4().equals("")
				...
				dto.setSorgcode(vDto.getSorgcode());
				dto.setScreatstatus("1");// 没有生成过5901
