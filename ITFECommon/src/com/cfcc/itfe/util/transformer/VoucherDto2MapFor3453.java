...
public class VoucherDto2MapFor3453 implements IVoucherDto2Map{

	private static Log logger = LogFactory.getLog(VoucherDto2MapFor3453.class);
...
//		sDto.setStrecode(vDto.getStrecode());
	...
	private Map tranfor(List<TrStockdayrptDto> dtoList,TvVoucherinfoDto vDto) throws ITFEBizException{
		...
		{
			if(!sdto.getSaccno().contains("371"))//核算主体代码加371开头的账户代码不生成
			{
