...
public class VoucherDto2MapFor3455 implements IVoucherDto2Map{

	private static Log logger = LogFactory.getLog(VoucherDto2MapFor3455.class);
	...
	private List tranforList(TrIncomedayrptDto dto,TvVoucherinfoDto vDto) throws ITFEBizException
	{
		...
		try {
			...
			else
			{
				...
				where = " (S_TRECODE = '"+dto.getStrecode()+"'"+orsql.toString()+") AND (S_RPTDATE = '"+dto.getSrptdate()+"' ) ";//"S_FINORGCODE='"+cDto.getSfinorgcode()+"' and
			}
