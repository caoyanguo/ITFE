...
public class Dto2MapFor9008 {
	...
	public static Map tranfor(HeadDto headdto,ContentDto contentdto) throws ITFEBizException{
		...
		HashMap<String, Object> msgMap9008 = new HashMap<String, Object>();
		...
		//报文内容
		msgMap.put("LogoutInfo9008",msgMap9008 );
		msgMap9008.put("Password",contentdto.get_logPass());
		return map;
	}
