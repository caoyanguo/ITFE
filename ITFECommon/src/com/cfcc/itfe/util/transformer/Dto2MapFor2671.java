...
public class Dto2MapFor2671 {
	
	private static Log logger = LogFactory.getLog(Dto2MapFor2671.class);
...
//		batchHeadMap.put("AllAmt", "0.00");
		...
		turnAccountMap.put("FundSrlNo", MtoCodeTrans.transformString(list.get(0).getStranom())); // 资金收纳流水号
...
//		turnAccountMap.put("PayeeTreName", MtoCodeTrans.transformString(null)); // 收款国库名称
		...
		for (int i = 0; i < list.size(); i++) {
			...
			payment7211Map.put("TraNo", list.get(i).getSvoucherno()); // 交易流水号
