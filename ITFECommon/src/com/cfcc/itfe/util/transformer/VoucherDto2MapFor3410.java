...
public class VoucherDto2MapFor3410 implements IVoucherDto2Map{

	private static Log logger = LogFactory.getLog(VoucherDto2MapFor3410.class);
	...
	private List getVoucher(TvVoucherinfoDto vDto) throws ITFEBizException
	{
		...
		List<TrTaxorgPayoutReportDto> detailList=new ArrayList<TrTaxorgPayoutReportDto>();
		try {
			...
			detailList=  (List<TrTaxorgPayoutReportDto>) execDetail.runQuery(stockDayRptDetailSql,TrTaxorgPayoutReportDto.class).getDtoCollection();
		...
		{
			List<TrTaxorgPayoutReportDto> tempList = null;
			String danhao=null;
