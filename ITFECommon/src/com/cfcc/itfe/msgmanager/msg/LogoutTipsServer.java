...
public class LogoutTipsServer extends AbstractMsgManagerServer {
	private static Log logger = LogFactory.getLog(LogoutTipsServer.class);
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		// 登陆Tips报文
		Map xmlMap = Dto2MapFor9008.tranfor(headdto,contentdto);
		// 设置消息体
		eventContext.getMessage().setProperty(MessagePropertyKeys.MSG_NO_KEY,
				MsgConstant.MSG_NO_9008);
