...
import com.cfcc.itfe.util.transformer.Dto2MapFor3000;

public class Send3000TbsMsgServer extends AbstractMsgManagerServer {
	private static Log logger = LogFactory.getLog(Send3000TbsMsgServer.class);
	/**
	 * 报文信息处理
	 */
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		// 连接性测试报文
		Map xmlMap = Dto2MapFor3000.tranfor(headdto);
		// 设置消息体
		muleMessage.setProperty(MessagePropertyKeys.MSG_NO_KEY,
				MsgConstant.MSG_TBS_NO_3000);
