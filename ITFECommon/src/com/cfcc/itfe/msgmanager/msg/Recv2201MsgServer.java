...
/**
 *（报文编号涉及：5101商业银行办理支付－划款申请转发tips）
 * 
 * @author zhouchuan
 * 
 */
public class Recv2201MsgServer extends AbstractMsgManagerServer {

	private static Log logger = LogFactory.getLog(Recv2201MsgServer.class);
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		/**
		 * 解析批量业务头 msgMap-->batchhead2201
		 */
		HashMap batchhead2201 = (HashMap) msgMap.get("BatchHead2201");
		// 出票单位
		String finorgcode = (String) batchhead2201.get("AgentBnkCode");
		// 国库代码
		String trecode = (String) batchhead2201.get("TreCode");
		// 委托日期
		String entrustdate = (String) batchhead2201.get("EntrustDate");
		// 包流水号
		String packno = (String) batchhead2201.get("PackNo");
		// 总笔数
		Integer allnum = Integer.valueOf((String) batchhead2201.get("AllNum"));
		// 总金额
		BigDecimal allamt = MtoCodeTrans.transformBigDecimal(batchhead2201.get("AllAmt"));
		/*
		 * 接收/发送日志
		 */
