...
public class Voucher2671MsgServer extends AbstractMsgManagerServer {

	private static Log logger = LogFactory.getLog(Voucher2671MsgServer.class);
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		try {
			...
			logger.error("解析非税收入缴库单2671报文出现错误！", e);
			throw new ITFEBizException("解析非税收入缴库单2671报文出现错误！", e);
		...
		for (int i = 0; i < VoucherBodyList.size(); i++) {
			try {
				...
				String TraNoM = elementVoucher.elementText("TraNoM"); // 资金交易流水号
