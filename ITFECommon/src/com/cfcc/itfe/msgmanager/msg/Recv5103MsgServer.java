...
/**
 *（报文编号涉及：5101授权支付额度-财政发起授权支付额度转发tips）
 * 
 * @author zhouchuan
 * 
 */
public class Recv5103MsgServer extends AbstractMsgManagerServer {

	private static Log logger = LogFactory.getLog(Recv5103MsgServer.class);
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		/**
		 * 解析批量业务头 msgMap-->BatchHead5103
		 */
		HashMap batchhead5103 = (HashMap) msgMap.get("BatchHead5103");
		// 国库代码
		String trecode = (String) batchhead5103.get("TreCode");
		// 委托日期
		String entrustdate = (String) batchhead5103.get("EntrustDate");
		// 财政机构代码
		String finorgcode = (String) batchhead5103.get("BillOrg");
		// 包流水号
		String packno = (String) batchhead5103.get("PackNo");
		// 总笔数
		Integer allnum = Integer.valueOf((String) batchhead5103.get("AllNum"));
		// 总金额
		BigDecimal allamt = MtoCodeTrans.transformBigDecimal(batchhead5103.get("AllAmt"));
		
		/**
		 * 解析批量业务信息 msgMap-->Bill5103
		 */
		List<Object> Bill5103 = (List<Object>) msgMap.get("Bill5103");
		String agentBankCode="";//经办单位(代理行号)
		if(Bill5103!=null&&Bill5103.size()>0){
			HashMap bill5102Map=(HashMap) Bill5103.get(0);
