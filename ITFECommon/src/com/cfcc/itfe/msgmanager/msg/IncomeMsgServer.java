...
public class IncomeMsgServer extends AbstractMsgManagerServer {

	private static Log logger = LogFactory.getLog(IncomeMsgServer.class);
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		try {
			...
			// DTO -> MAP
			Map xmlMap = Dto2MapFor7211.tranfor(list, orgcode, filename, packno,isRepeat);
			...
			int num = Integer.parseInt(batchHead7211.get("AllNum").toString());
			// 设置消息体
