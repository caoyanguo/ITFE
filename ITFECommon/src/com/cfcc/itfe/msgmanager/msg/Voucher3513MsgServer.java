...
public class Voucher3513MsgServer extends AbstractMsgManagerServer {
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		try {
			...
			logger.error("解析库款账户报表对账请求信息3513报文出现错误！",e);
			throw new ITFEBizException("解析库款账户报表对账请求信息3513报文出现错误！",e);
		...
		for(int i=0;i<VoucherBodyList.size();i++){
			...
			try {
				...
				logger.error("校验库款账户报表对账请求信息3513报文出现错误！", e1);
				throw new ITFEBizException("校验库款账户报表对账请求信息3513报文出现错误！");
			...
			try {
				...
				logger.error("保存库款账户报表对账请求信息数据库异常", e1);
				throw new ITFEBizException("保存库款账户报表对账请求信息数据库异常");
			}
