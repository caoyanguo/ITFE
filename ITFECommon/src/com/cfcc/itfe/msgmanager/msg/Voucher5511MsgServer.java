...
public class Voucher5511MsgServer extends AbstractMsgManagerServer {
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		try {
			...
			String sql = null;
			String sumIncomeAmt = null;//累计金额
			String curIncomeAmt = null;//本期金额
			String budgetSubjectCode = null;//收入分类科目代码
			String budgetType = null;//资金性质
			...
			logger.error("解析收入报表对帐回执5511报文出现错误！", e);
			throw new ITFEBizException("解析收入报表对帐回执5511报文出现错误！", e);
