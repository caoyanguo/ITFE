...
/**
 *（报文编号涉及：1105财政发起更正提交tips）
 * 
 * @author zhouchuan
 * 
 */
public class Recv1105MsgServer extends AbstractMsgManagerServer {

	private static Log logger = LogFactory.getLog(Recv1105MsgServer.class);
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		 ...
		 */
		HashMap batchHead1105 = (HashMap) msgMap.get("BatchHead1105");
		// 征收机关代码
		String taxorgcode = (String) batchHead1105.get("TaxOrgCode");
		// 委托日期
		String entrustdate = (String) batchHead1105.get("EntrustDate");
		// 包流水号
		String packno = (String) batchHead1105.get("PackNo");
		// 回执期限
//		Integer returnterm = Integer.valueOf((String) batchhead1102.get("ReturnTerm"));
		// 总笔数
		Integer allnum = Integer.valueOf((String) batchHead1105.get("AllNum"));
		// 总金额
		BigDecimal allamt = MtoCodeTrans.transformBigDecimal(batchHead1105.get("AllAmt"));
		/*
		 * 接收/发送日志
		 */
