...
import com.cfcc.itfe.util.transformer.Dto2MapFor9117;

/**
 * @author wangtuo
 * 
 */
public class Send9117MsgServer extends AbstractMsgManagerServer {

	private static Log logger = LogFactory.getLog(Send9117MsgServer.class);
	...
	public void dealMsg(MuleEventContext eventContext) throws ITFEBizException {
		...
		HeadDto dto = (HeadDto) eventContext.getMessage().getProperty(
		...
		String entrustdate = (String) eventContext.getMessage().getProperty(
				MessagePropertyKeys.MSG_DATE);

		// 连接性测试报文
		Map xmlMap = Dto2MapFor9117.tranfor(headdto, dto,sorgcode);
		// 设置消息体
		...
		muleMessage.setProperty(MessagePropertyKeys.MSG_SEND_LOG_DTO,
				MsgLogFacade.writeSendLogWithResult(_ssendno, null,
						sorgcode,
						ITFECommonConstant.DES_NODE, entrustdate, headdto
