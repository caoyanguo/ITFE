...
/**
 * <p>Title: PK of table: HTF_RECONCILE_PAYINFO_SUB</p>
...
public class HtfReconcilePayinfoSubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReconcilePayinfoSubPK))
            return false;

        HtfReconcilePayinfoSubPK bean = (HtfReconcilePayinfoSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReconcilePayinfoSubPK bean = new HtfReconcilePayinfoSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReconcilePayinfoSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_RECONCILE_PAYINFO_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_RECONCILE_PAYINFO_SUB 字段：I_SEQNO 不能为空; ");
