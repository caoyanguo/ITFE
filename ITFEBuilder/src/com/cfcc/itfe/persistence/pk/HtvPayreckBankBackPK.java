...
/**
 * <p>Title: PK of table: HTV_PAYRECK_BANK_BACK</p>
...
public class HtvPayreckBankBackPK implements IPK
{
    /**
    ...
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvPayreckBankBackPK))
            return false;

        HtvPayreckBankBackPK bean = (HtvPayreckBankBackPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvPayreckBankBackPK bean = new HtvPayreckBankBackPK();
          if(this.sbookorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvPayreckBankBackPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSbookorgcode()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_BOOKORGCODE 不能为空; ");
                
       if (this.getSbookorgcode()!=null)
          if (this.getSbookorgcode().getBytes().length > 12)
             sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_BOOKORGCODE 宽度不能超过 "+12);
                
        if (this.getDentrustdate()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：D_ENTRUSTDATE 不能为空; ");
                        
        if (this.getSpackno()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_PACKNO 不能为空; ");
                
       if (this.getSpackno()!=null)
          if (this.getSpackno().getBytes().length > 8)
             sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_PACKNO 宽度不能超过 "+8);
                
        if (this.getSagentbnkcode()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_AGENTBNKCODE 不能为空; ");
                
       if (this.getSagentbnkcode()!=null)
          if (this.getSagentbnkcode().getBytes().length > 12)
             sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_AGENTBNKCODE 宽度不能超过 "+12);
                
        if (this.getStrano()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_TRANO 不能为空; ");
                
       if (this.getStrano()!=null)
          if (this.getStrano().getBytes().length > 8)
             sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：S_TRANO 宽度不能超过 "+8);
                
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK 字段：I_VOUSRLNO 不能为空; ");
