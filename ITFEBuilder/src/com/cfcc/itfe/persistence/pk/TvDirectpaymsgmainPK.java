...
/**
 * <p>Title: PK of table: TV_DIRECTPAYMSGMAIN</p>
...
public class TvDirectpaymsgmainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvDirectpaymsgmainPK))
            return false;

        TvDirectpaymsgmainPK bean = (TvDirectpaymsgmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvDirectpaymsgmainPK bean = new TvDirectpaymsgmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvDirectpaymsgmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_DIRECTPAYMSGMAIN 字段：I_VOUSRLNO 不能为空; ");
