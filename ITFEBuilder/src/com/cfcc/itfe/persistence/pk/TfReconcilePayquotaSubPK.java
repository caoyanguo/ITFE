...
/**
 * <p>Title: PK of table: TF_RECONCILE_PAYQUOTA_SUB</p>
 * <p>Description: 清算额度对帐子表3510 PK Object  </p>
...
public class TfReconcilePayquotaSubPK implements IPK
{
    /**
    ...
    *  联合主键 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcilePayquotaSubPK))
            return false;

        TfReconcilePayquotaSubPK bean = (TfReconcilePayquotaSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReconcilePayquotaSubPK bean = new TfReconcilePayquotaSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcilePayquotaSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_RECONCILE_PAYQUOTA_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_RECONCILE_PAYQUOTA_SUB 字段：I_SEQNO 不能为空; ");
