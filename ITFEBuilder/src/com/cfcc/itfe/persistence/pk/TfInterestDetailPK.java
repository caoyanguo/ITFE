...
/**
 * <p>Title: PK of table: TF_INTEREST_DETAIL</p>
 * <p>Description: 计息明细表 PK Object  </p>
...
public class TfInterestDetailPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfInterestDetailPK))
            return false;

        TfInterestDetailPK bean = (TfInterestDetailPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfInterestDetailPK bean = new TfInterestDetailPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfInterestDetailPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_INTEREST_DETAIL 字段：I_VOUSRLNO 不能为空; ");
