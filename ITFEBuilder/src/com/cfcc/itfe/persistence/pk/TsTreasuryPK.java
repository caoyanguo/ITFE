...
/**
 * <p>Title: PK of table: TS_TREASURY</p>
...
public class TsTreasuryPK implements IPK
{
    /**
    ...
    *   S_TRECODE CHARACTER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsTreasuryPK))
            return false;

        TsTreasuryPK bean = (TsTreasuryPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TsTreasuryPK bean = new TsTreasuryPK();
          if(this.sorgcode!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_TREASURY 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_TREASURY 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getStrecode()==null)
              sb.append("数据库表：TS_TREASURY 字段：S_TRECODE 不能为空; ");
                
       if (this.getStrecode()!=null)
          if (this.getStrecode().getBytes().length > 10)
             sb.append("数据库表：TS_TREASURY 字段：S_TRECODE 宽度不能超过 "+10);
