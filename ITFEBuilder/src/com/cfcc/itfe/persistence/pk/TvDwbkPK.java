...
public class TvDwbkPK implements IPK
{
    /**
    ...
    *   S_BOOKORGCODE CHARACTER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvDwbkPK))
            return false;

        TvDwbkPK bean = (TvDwbkPK) obj;
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_DWBK 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getSbookorgcode()==null)
              sb.append("数据库表：TV_DWBK 字段：S_BOOKORGCODE 不能为空; ");
                
       if (this.getSbookorgcode()!=null)
          if (this.getSbookorgcode().getBytes().length > 12)
             sb.append("数据库表：TV_DWBK 字段：S_BOOKORGCODE 宽度不能超过 "+12);
