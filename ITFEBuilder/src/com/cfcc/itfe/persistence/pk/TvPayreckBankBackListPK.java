...
/**
 * <p>Title: PK of table: TV_PAYRECK_BANK_BACK_LIST</p>
...
public class TvPayreckBankBackListPK implements IPK
{
    /**
    ...
    *   I_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayreckBankBackListPK))
            return false;

        TvPayreckBankBackListPK bean = (TvPayreckBankBackListPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayreckBankBackListPK bean = new TvPayreckBankBackListPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayreckBankBackListPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PAYRECK_BANK_BACK_LIST 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TV_PAYRECK_BANK_BACK_LIST 字段：I_SEQNO 不能为空; ");
