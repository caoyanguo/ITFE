...
/**
 * <p>Title: PK of table: TV_VOUCHERINFO_ALLOCATE_INCOME</p>
...
public class TvVoucherinfoAllocateIncomePK implements IPK
{
    /**
    *   S_DEALNO VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvVoucherinfoAllocateIncomePK))
            return false;

        TvVoucherinfoAllocateIncomePK bean = (TvVoucherinfoAllocateIncomePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvVoucherinfoAllocateIncomePK bean = new TvVoucherinfoAllocateIncomePK();
          if(this.sdealno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvVoucherinfoAllocateIncomePK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSdealno()==null)
              sb.append("数据库表：TV_VOUCHERINFO_ALLOCATE_INCOME 字段：S_DEALNO 不能为空; ");
                
       if (this.getSdealno()!=null)
          if (this.getSdealno().getBytes().length > 18)
             sb.append("数据库表：TV_VOUCHERINFO_ALLOCATE_INCOME 字段：S_DEALNO 宽度不能超过 "+18);
