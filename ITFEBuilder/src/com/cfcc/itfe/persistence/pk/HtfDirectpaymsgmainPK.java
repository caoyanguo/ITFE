...
/**
 * <p>Title: PK of table: HTF_DIRECTPAYMSGMAIN</p>
...
public class HtfDirectpaymsgmainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfDirectpaymsgmainPK))
            return false;

        HtfDirectpaymsgmainPK bean = (HtfDirectpaymsgmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfDirectpaymsgmainPK bean = new HtfDirectpaymsgmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfDirectpaymsgmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_DIRECTPAYMSGMAIN 字段：I_VOUSRLNO 不能为空; ");
