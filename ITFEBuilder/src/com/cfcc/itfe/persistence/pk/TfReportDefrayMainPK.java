...
/**
 * <p>Title: PK of table: TF_REPORT_DEFRAY_MAIN</p>
 * <p>Description: 支出报表对帐主表3512 PK Object  </p>
...
public class TfReportDefrayMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReportDefrayMainPK))
            return false;

        TfReportDefrayMainPK bean = (TfReportDefrayMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReportDefrayMainPK bean = new TfReportDefrayMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReportDefrayMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_REPORT_DEFRAY_MAIN 字段：I_VOUSRLNO 不能为空; ");
