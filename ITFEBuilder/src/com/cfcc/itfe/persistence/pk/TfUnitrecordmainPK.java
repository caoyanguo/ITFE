...
/**
 * <p>Title: PK of table: TF_UNITRECORDMAIN</p>
 * <p>Description: 单位清册5951主表 PK Object  </p>
...
public class TfUnitrecordmainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfUnitrecordmainPK))
            return false;

        TfUnitrecordmainPK bean = (TfUnitrecordmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfUnitrecordmainPK bean = new TfUnitrecordmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfUnitrecordmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_UNITRECORDMAIN 字段：I_VOUSRLNO 不能为空; ");
