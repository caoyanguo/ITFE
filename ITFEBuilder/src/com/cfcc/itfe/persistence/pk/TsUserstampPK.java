...
/**
 * <p>Title: PK of table: TS_USERSTAMP</p>
...
public class TsUserstampPK implements IPK
{
    /**
    ...
    *   S_STAMPTYPECODE VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsUserstampPK))
            return false;

        TsUserstampPK bean = (TsUserstampPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TsUserstampPK bean = new TsUserstampPK();
          if(this.sorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsUserstampPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_USERSTAMP 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_USERSTAMP 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getSusercode()==null)
              sb.append("数据库表：TS_USERSTAMP 字段：S_USERCODE 不能为空; ");
                
       if (this.getSusercode()!=null)
          if (this.getSusercode().getBytes().length > 30)
             sb.append("数据库表：TS_USERSTAMP 字段：S_USERCODE 宽度不能超过 "+30);
                
        if (this.getSstamptypecode()==null)
              sb.append("数据库表：TS_USERSTAMP 字段：S_STAMPTYPECODE 不能为空; ");
                
       if (this.getSstamptypecode()!=null)
          if (this.getSstamptypecode().getBytes().length > 10)
             sb.append("数据库表：TS_USERSTAMP 字段：S_STAMPTYPECODE 宽度不能超过 "+10);
