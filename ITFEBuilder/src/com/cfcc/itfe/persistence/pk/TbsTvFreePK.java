...
/**
 * <p>Title: PK of table: TBS_TV_FREE</p>
...
public class TbsTvFreePK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TbsTvFreePK))
            return false;

        TbsTvFreePK bean = (TbsTvFreePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TbsTvFreePK bean = new TbsTvFreePK();
          if(this.ivousrlno!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TBS_TV_FREE 字段：I_VOUSRLNO 不能为空; ");
