...
/**
 * <p>Title: PK of table: HTF_RECONCILE_REALDIAL_SUB</p>
...
public class HtfReconcileRealdialSubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReconcileRealdialSubPK))
            return false;

        HtfReconcileRealdialSubPK bean = (HtfReconcileRealdialSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReconcileRealdialSubPK bean = new HtfReconcileRealdialSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReconcileRealdialSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_RECONCILE_REALDIAL_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_RECONCILE_REALDIAL_SUB 字段：I_SEQNO 不能为空; ");
