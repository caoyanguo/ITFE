...
/**
 * <p>Title: PK of table: HTF_REPORT_DEPOSIT_MAIN</p>
 * <p>Description: 库款账户对帐主表历史表3513 PK Object  </p>
...
public class HtfReportDepositMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReportDepositMainPK))
            return false;

        HtfReportDepositMainPK bean = (HtfReportDepositMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReportDepositMainPK bean = new HtfReportDepositMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReportDepositMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_REPORT_DEPOSIT_MAIN 字段：I_VOUSRLNO 不能为空; ");
