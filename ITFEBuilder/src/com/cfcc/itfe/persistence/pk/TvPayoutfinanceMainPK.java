...
/**
 * <p>Title: PK of table: TV_PAYOUTFINANCE_MAIN</p>
...
public class TvPayoutfinanceMainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayoutfinanceMainPK))
            return false;

        TvPayoutfinanceMainPK bean = (TvPayoutfinanceMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayoutfinanceMainPK bean = new TvPayoutfinanceMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayoutfinanceMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PAYOUTFINANCE_MAIN 字段：I_VOUSRLNO 不能为空; ");
