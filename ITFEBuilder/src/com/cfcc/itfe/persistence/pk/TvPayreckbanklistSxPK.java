...
/**
 * <p>Title: PK of table: TV_PAYRECKBANKLIST_SX</p>
...
public class TvPayreckbanklistSxPK implements IPK
{
    /**
    ...
    *   I_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayreckbanklistSxPK))
            return false;

        TvPayreckbanklistSxPK bean = (TvPayreckbanklistSxPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayreckbanklistSxPK bean = new TvPayreckbanklistSxPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayreckbanklistSxPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PAYRECKBANKLIST_SX 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TV_PAYRECKBANKLIST_SX 字段：I_SEQNO 不能为空; ");
