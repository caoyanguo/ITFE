...
/**
 * <p>Title: PK of table: TV_GRANTPAYMSGSUB_SX</p>
...
public class TvGrantpaymsgsubSxPK implements IPK
{
    /**
    ...
    *   S_PACKAGETICKETNO VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvGrantpaymsgsubSxPK))
            return false;

        TvGrantpaymsgsubSxPK bean = (TvGrantpaymsgsubSxPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvGrantpaymsgsubSxPK bean = new TvGrantpaymsgsubSxPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvGrantpaymsgsubSxPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_GRANTPAYMSGSUB_SX 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIdetailseqno()==null)
              sb.append("数据库表：TV_GRANTPAYMSGSUB_SX 字段：I_DETAILSEQNO 不能为空; ");
                        
        if (this.getSpackageticketno()==null)
              sb.append("数据库表：TV_GRANTPAYMSGSUB_SX 字段：S_PACKAGETICKETNO 不能为空; ");
                
       if (this.getSpackageticketno()!=null)
          if (this.getSpackageticketno().getBytes().length > 30)
             sb.append("数据库表：TV_GRANTPAYMSGSUB_SX 字段：S_PACKAGETICKETNO 宽度不能超过 "+30);
