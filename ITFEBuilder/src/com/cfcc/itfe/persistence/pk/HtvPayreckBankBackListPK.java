...
/**
 * <p>Title: PK of table: HTV_PAYRECK_BANK_BACK_LIST</p>
...
public class HtvPayreckBankBackListPK implements IPK
{
    /**
    ...
    *   I_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvPayreckBankBackListPK))
            return false;

        HtvPayreckBankBackListPK bean = (HtvPayreckBankBackListPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvPayreckBankBackListPK bean = new HtvPayreckBankBackListPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvPayreckBankBackListPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK_LIST 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTV_PAYRECK_BANK_BACK_LIST 字段：I_SEQNO 不能为空; ");
