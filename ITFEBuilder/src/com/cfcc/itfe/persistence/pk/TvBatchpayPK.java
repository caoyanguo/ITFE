...
/**
 * <p>Title: PK of table: TV_BATCHPAY</p>
...
public class TvBatchpayPK implements IPK
{
    /**
    *   I_NO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvBatchpayPK))
            return false;

        TvBatchpayPK bean = (TvBatchpayPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvBatchpayPK bean = new TvBatchpayPK();
          if(this.ino!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIno()==null)
              sb.append("数据库表：TV_BATCHPAY 字段：I_NO 不能为空; ");
