...
/**
 * <p>Title: PK of table: TBS_TV_IN_CORRHANDBOOK</p>
...
public class TbsTvInCorrhandbookPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TbsTvInCorrhandbookPK))
            return false;

        TbsTvInCorrhandbookPK bean = (TbsTvInCorrhandbookPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TbsTvInCorrhandbookPK bean = new TbsTvInCorrhandbookPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TbsTvInCorrhandbookPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TBS_TV_IN_CORRHANDBOOK 字段：I_VOUSRLNO 不能为空; ");
