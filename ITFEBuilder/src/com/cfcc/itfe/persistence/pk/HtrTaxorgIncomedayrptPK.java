...
/**
 * <p>Title: PK of table: HTR_TAXORG_INCOMEDAYRPT</p>
...
public class HtrTaxorgIncomedayrptPK implements IPK
{
    /**
    ...
    *   S_BILLKIND CHARACTER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtrTaxorgIncomedayrptPK))
            return false;

        HtrTaxorgIncomedayrptPK bean = (HtrTaxorgIncomedayrptPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtrTaxorgIncomedayrptPK bean = new HtrTaxorgIncomedayrptPK();
          if(this.staxorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtrTaxorgIncomedayrptPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getStaxorgcode()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_TAXORGCODE 不能为空; ");
                
       if (this.getStaxorgcode()!=null)
          if (this.getStaxorgcode().getBytes().length > 30)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_TAXORGCODE 宽度不能超过 "+30);
                
        if (this.getStrecode()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_TRECODE 不能为空; ");
                
       if (this.getStrecode()!=null)
          if (this.getStrecode().getBytes().length > 10)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_TRECODE 宽度不能超过 "+10);
                
        if (this.getSrptdate()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_RPTDATE 不能为空; ");
                
       if (this.getSrptdate()!=null)
          if (this.getSrptdate().getBytes().length > 8)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_RPTDATE 宽度不能超过 "+8);
                
        if (this.getSbudgettype()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BUDGETTYPE 不能为空; ");
                
       if (this.getSbudgettype()!=null)
          if (this.getSbudgettype().getBytes().length > 1)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BUDGETTYPE 宽度不能超过 "+1);
                
        if (this.getSbudgetlevelcode()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BUDGETLEVELCODE 不能为空; ");
                
       if (this.getSbudgetlevelcode()!=null)
          if (this.getSbudgetlevelcode().getBytes().length > 1)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BUDGETLEVELCODE 宽度不能超过 "+1);
                
        if (this.getSbudgetsubcode()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BUDGETSUBCODE 不能为空; ");
                
       if (this.getSbudgetsubcode()!=null)
          if (this.getSbudgetsubcode().getBytes().length > 30)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BUDGETSUBCODE 宽度不能超过 "+30);
                
        if (this.getSdividegroup()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_DIVIDEGROUP 不能为空; ");
                
       if (this.getSdividegroup()!=null)
          if (this.getSdividegroup().getBytes().length > 5)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_DIVIDEGROUP 宽度不能超过 "+5);
                
        if (this.getSbillkind()==null)
              sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BILLKIND 不能为空; ");
                
       if (this.getSbillkind()!=null)
          if (this.getSbillkind().getBytes().length > 1)
             sb.append("数据库表：HTR_TAXORG_INCOMEDAYRPT 字段：S_BILLKIND 宽度不能超过 "+1);
