...
/**
 * <p>Title: PK of table: HTV_DIRECTPAYMSGSUB</p>
...
public class HtvDirectpaymsgsubPK implements IPK
{
    /**
    ...
    *   I_DETAILSEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvDirectpaymsgsubPK))
            return false;

        HtvDirectpaymsgsubPK bean = (HtvDirectpaymsgsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvDirectpaymsgsubPK bean = new HtvDirectpaymsgsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvDirectpaymsgsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_DIRECTPAYMSGSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIdetailseqno()==null)
              sb.append("数据库表：HTV_DIRECTPAYMSGSUB 字段：I_DETAILSEQNO 不能为空; ");
