...
/**
 * <p>Title: PK of table: TV_PBCPAY_SUB</p>
...
public class TvPbcpaySubPK implements IPK
{
    /**
    ...
    *   I_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPbcpaySubPK))
            return false;

        TvPbcpaySubPK bean = (TvPbcpaySubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPbcpaySubPK bean = new TvPbcpaySubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPbcpaySubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PBCPAY_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TV_PBCPAY_SUB 字段：I_SEQNO 不能为空; ");
