...
/**
 * <p>Title: PK of table: HTF_DIRECTPAY_ADJUSTMAIN</p>
 * <p>Description: 财政直接支付调整凭证5253主表 PK Object  </p>
...
public class HtfDirectpayAdjustmainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfDirectpayAdjustmainPK))
            return false;

        HtfDirectpayAdjustmainPK bean = (HtfDirectpayAdjustmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfDirectpayAdjustmainPK bean = new HtfDirectpayAdjustmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfDirectpayAdjustmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_DIRECTPAY_ADJUSTMAIN 字段：I_VOUSRLNO 不能为空; ");
