...
/**
 * <p>Title: PK of table: TV_PAYRECK_BANK_LIST</p>
...
public class TvPayreckBankListPK implements IPK
{
    /**
    ...
    *   I_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayreckBankListPK))
            return false;

        TvPayreckBankListPK bean = (TvPayreckBankListPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayreckBankListPK bean = new TvPayreckBankListPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayreckBankListPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PAYRECK_BANK_LIST 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TV_PAYRECK_BANK_LIST 字段：I_SEQNO 不能为空; ");
