...
/**
 * <p>Title: PK of table: TS_CHECKFAILREASON</p>
...
public class TsCheckfailreasonPK implements IPK
{
    /**
    ...
    *   S_CHECKFAILCODE VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsCheckfailreasonPK))
            return false;

        TsCheckfailreasonPK bean = (TsCheckfailreasonPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
	public int hashCode()
	{
        ...
        if(this.scheckfailcode!=null)
          __hash__ = __hash__ * 31+ this.scheckfailcode.hashCode() ;
    ...
    public Object clone()
    {
        TsCheckfailreasonPK bean = new TsCheckfailreasonPK();
          if(this.sorgcode!=null){
                  bean.sorgcode = new String(this.sorgcode);
            }
             if(this.scheckfailcode!=null){
                  bean.scheckfailcode = new String(this.scheckfailcode);
            }
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsCheckfailreasonPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_CHECKFAILREASON 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_CHECKFAILREASON 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getScheckfailcode()==null)
              sb.append("数据库表：TS_CHECKFAILREASON 字段：S_CHECKFAILCODE 不能为空; ");
                
       if (this.getScheckfailcode()!=null)
          if (this.getScheckfailcode().getBytes().length > 10)
             sb.append("数据库表：TS_CHECKFAILREASON 字段：S_CHECKFAILCODE 宽度不能超过 "+10);
