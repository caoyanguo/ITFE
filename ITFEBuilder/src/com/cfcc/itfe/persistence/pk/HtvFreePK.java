...
/**
 * <p>Title: PK of table: HTV_FREE</p>
...
public class HtvFreePK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvFreePK))
            return false;

        HtvFreePK bean = (HtvFreePK) obj;
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_FREE 字段：I_VOUSRLNO 不能为空; ");
