...
/**
 * <p>Title: PK of table: HTF_RECONCILE_PAYQUOTA_SUB</p>
 * <p>Description: 清算额度对帐子表历史表3510 PK Object  </p>
...
public class HtfReconcilePayquotaSubPK implements IPK
{
    /**
    ...
    *  联合主键 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReconcilePayquotaSubPK))
            return false;

        HtfReconcilePayquotaSubPK bean = (HtfReconcilePayquotaSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReconcilePayquotaSubPK bean = new HtfReconcilePayquotaSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReconcilePayquotaSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_RECONCILE_PAYQUOTA_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_RECONCILE_PAYQUOTA_SUB 字段：I_SEQNO 不能为空; ");
