...
/**
 * <p>Title: PK of table: HTF_PAYBANK_REFUNDSUB</p>
...
public class HtfPaybankRefundsubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfPaybankRefundsubPK))
            return false;

        HtfPaybankRefundsubPK bean = (HtfPaybankRefundsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfPaybankRefundsubPK bean = new HtfPaybankRefundsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfPaybankRefundsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_PAYBANK_REFUNDSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_PAYBANK_REFUNDSUB 字段：I_SEQNO 不能为空; ");
