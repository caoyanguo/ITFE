...
/**
 * <p>Title: PK of table: TF_GRANTPAYMSGMAIN</p>
 * <p>Description: 财政授权支付凭证（8202）主单 PK Object  </p>
...
public class TfGrantpaymsgmainPK implements IPK
{
    /**
    *  主键流水号 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfGrantpaymsgmainPK))
            return false;

        TfGrantpaymsgmainPK bean = (TfGrantpaymsgmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfGrantpaymsgmainPK bean = new TfGrantpaymsgmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfGrantpaymsgmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_GRANTPAYMSGMAIN 字段：I_VOUSRLNO 不能为空; ");
