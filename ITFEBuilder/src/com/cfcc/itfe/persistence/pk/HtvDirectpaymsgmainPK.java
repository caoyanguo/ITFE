...
/**
 * <p>Title: PK of table: HTV_DIRECTPAYMSGMAIN</p>
...
public class HtvDirectpaymsgmainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvDirectpaymsgmainPK))
            return false;

        HtvDirectpaymsgmainPK bean = (HtvDirectpaymsgmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvDirectpaymsgmainPK bean = new HtvDirectpaymsgmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvDirectpaymsgmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_DIRECTPAYMSGMAIN 字段：I_VOUSRLNO 不能为空; ");
