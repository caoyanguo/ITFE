...
public class TvTaxPK implements IPK
{
    /**
    *   S_SEQ VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvTaxPK))
            return false;

        TvTaxPK bean = (TvTaxPK) obj;
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSseq()==null)
              sb.append("数据库表：TV_TAX 字段：S_SEQ 不能为空; ");
                
       if (this.getSseq()!=null)
          if (this.getSseq().getBytes().length > 20)
             sb.append("数据库表：TV_TAX 字段：S_SEQ 宽度不能超过 "+20);
