...
/**
 * <p>Title: PK of table: TV_PAYOUTFINANCE</p>
...
public class TvPayoutfinancePK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayoutfinancePK))
            return false;

        TvPayoutfinancePK bean = (TvPayoutfinancePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayoutfinancePK bean = new TvPayoutfinancePK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayoutfinancePK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PAYOUTFINANCE 字段：I_VOUSRLNO 不能为空; ");
