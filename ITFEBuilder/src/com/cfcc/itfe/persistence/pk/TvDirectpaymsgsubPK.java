...
/**
 * <p>Title: PK of table: TV_DIRECTPAYMSGSUB</p>
...
public class TvDirectpaymsgsubPK implements IPK
{
    /**
    ...
    *   I_DETAILSEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvDirectpaymsgsubPK))
            return false;

        TvDirectpaymsgsubPK bean = (TvDirectpaymsgsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvDirectpaymsgsubPK bean = new TvDirectpaymsgsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvDirectpaymsgsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_DIRECTPAYMSGSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIdetailseqno()==null)
              sb.append("数据库表：TV_DIRECTPAYMSGSUB 字段：I_DETAILSEQNO 不能为空; ");
