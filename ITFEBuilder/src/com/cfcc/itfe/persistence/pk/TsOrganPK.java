...
/**
 * <p>Title: PK of table: TS_ORGAN</p>
...
public class TsOrganPK implements IPK
{
    /**
    *   S_ORGCODE VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsOrganPK))
            return false;

        TsOrganPK bean = (TsOrganPK) obj;
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_ORGAN 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_ORGAN 字段：S_ORGCODE 宽度不能超过 "+12);
