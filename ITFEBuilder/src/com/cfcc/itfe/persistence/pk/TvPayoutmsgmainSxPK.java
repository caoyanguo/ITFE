...
/**
 * <p>Title: PK of table: TV_PAYOUTMSGMAIN_SX</p>
...
public class TvPayoutmsgmainSxPK implements IPK
{
    /**
    *   S_BIZNO VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayoutmsgmainSxPK))
            return false;

        TvPayoutmsgmainSxPK bean = (TvPayoutmsgmainSxPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayoutmsgmainSxPK bean = new TvPayoutmsgmainSxPK();
          if(this.sbizno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayoutmsgmainSxPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSbizno()==null)
              sb.append("数据库表：TV_PAYOUTMSGMAIN_SX 字段：S_BIZNO 不能为空; ");
                
       if (this.getSbizno()!=null)
          if (this.getSbizno().getBytes().length > 20)
             sb.append("数据库表：TV_PAYOUTMSGMAIN_SX 字段：S_BIZNO 宽度不能超过 "+20);
