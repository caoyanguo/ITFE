...
/**
 * <p>Title: PK of table: HTV_PAYOUTFINANCE_MAIN</p>
...
public class HtvPayoutfinanceMainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvPayoutfinanceMainPK))
            return false;

        HtvPayoutfinanceMainPK bean = (HtvPayoutfinanceMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvPayoutfinanceMainPK bean = new HtvPayoutfinanceMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvPayoutfinanceMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_PAYOUTFINANCE_MAIN 字段：I_VOUSRLNO 不能为空; ");
