...
/**
 * <p>Title: PK of table: HTF_GRANTPAYMSGMAIN</p>
 * <p>Description: 财政授权支付凭证（8202）主单(历史表) PK Object  </p>
...
public class HtfGrantpaymsgmainPK implements IPK
{
    /**
    *  主键流水号 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfGrantpaymsgmainPK))
            return false;

        HtfGrantpaymsgmainPK bean = (HtfGrantpaymsgmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfGrantpaymsgmainPK bean = new HtfGrantpaymsgmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfGrantpaymsgmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_GRANTPAYMSGMAIN 字段：I_VOUSRLNO 不能为空; ");
