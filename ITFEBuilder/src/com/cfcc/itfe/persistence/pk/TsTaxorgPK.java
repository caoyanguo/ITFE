...
/**
 * <p>Title: PK of table: TS_TAXORG</p>
...
public class TsTaxorgPK implements IPK
{
    /**
    ...
    *   S_TAXORGCODE VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsTaxorgPK))
            return false;

        TsTaxorgPK bean = (TsTaxorgPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TsTaxorgPK bean = new TsTaxorgPK();
          if(this.sorgcode!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_TAXORG 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_TAXORG 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getStrecode()==null)
              sb.append("数据库表：TS_TAXORG 字段：S_TRECODE 不能为空; ");
                
       if (this.getStrecode()!=null)
          if (this.getStrecode().getBytes().length > 10)
             sb.append("数据库表：TS_TAXORG 字段：S_TRECODE 宽度不能超过 "+10);
                
        if (this.getStaxorgcode()==null)
              sb.append("数据库表：TS_TAXORG 字段：S_TAXORGCODE 不能为空; ");
                
       if (this.getStaxorgcode()!=null)
          if (this.getStaxorgcode().getBytes().length > 30)
             sb.append("数据库表：TS_TAXORG 字段：S_TAXORGCODE 宽度不能超过 "+30);
