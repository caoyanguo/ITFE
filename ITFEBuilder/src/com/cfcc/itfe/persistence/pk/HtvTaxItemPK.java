...
/**
 * <p>Title: PK of table: HTV_TAX_ITEM</p>
...
public class HtvTaxItemPK implements IPK
{
    /**
    ...
    *   I_DETAILNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvTaxItemPK))
            return false;

        HtvTaxItemPK bean = (HtvTaxItemPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvTaxItemPK bean = new HtvTaxItemPK();
          if(this.sseq!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSseq()==null)
              sb.append("数据库表：HTV_TAX_ITEM 字段：S_SEQ 不能为空; ");
                
       if (this.getSseq()!=null)
          if (this.getSseq().getBytes().length > 20)
             sb.append("数据库表：HTV_TAX_ITEM 字段：S_SEQ 宽度不能超过 "+20);
                
        if (this.getIprojectid()==null)
              sb.append("数据库表：HTV_TAX_ITEM 字段：I_PROJECTID 不能为空; ");
                        
        if (this.getIdetailno()==null)
              sb.append("数据库表：HTV_TAX_ITEM 字段：I_DETAILNO 不能为空; ");
