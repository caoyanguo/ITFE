...
/**
 * <p>Title: PK of table: TF_RECONCILE_REFUND_SUB</p>
 * <p>Description: 收入退付对帐子表3509 PK Object  </p>
...
public class TfReconcileRefundSubPK implements IPK
{
    /**
    ...
    *  联合主键 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcileRefundSubPK))
            return false;

        TfReconcileRefundSubPK bean = (TfReconcileRefundSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReconcileRefundSubPK bean = new TfReconcileRefundSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcileRefundSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_RECONCILE_REFUND_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_RECONCILE_REFUND_SUB 字段：I_SEQNO 不能为空; ");
