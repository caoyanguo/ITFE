...
/**
 * <p>Title: PK of table: TS_CONVERTTAXORG</p>
...
public class TsConverttaxorgPK implements IPK
{
    /**
    ...
    *   S_TRECODE CHARACTER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsConverttaxorgPK))
            return false;

        TsConverttaxorgPK bean = (TsConverttaxorgPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
	public int hashCode()
	{
        ...
        if(this.stbstaxorgcode!=null)
          __hash__ = __hash__ * 31+ this.stbstaxorgcode.hashCode() ;
    ...
    public Object clone()
    {
        TsConverttaxorgPK bean = new TsConverttaxorgPK();
          if(this.sorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsConverttaxorgPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_CONVERTTAXORG 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_CONVERTTAXORG 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getStbstaxorgcode()==null)
              sb.append("数据库表：TS_CONVERTTAXORG 字段：S_TBSTAXORGCODE 不能为空; ");
                
       if (this.getStbstaxorgcode()!=null)
          if (this.getStbstaxorgcode().getBytes().length > 20)
             sb.append("数据库表：TS_CONVERTTAXORG 字段：S_TBSTAXORGCODE 宽度不能超过 "+20);
                
        if (this.getStrecode()==null)
              sb.append("数据库表：TS_CONVERTTAXORG 字段：S_TRECODE 不能为空; ");
                
       if (this.getStrecode()!=null)
          if (this.getStrecode().getBytes().length > 10)
             sb.append("数据库表：TS_CONVERTTAXORG 字段：S_TRECODE 宽度不能超过 "+10);
