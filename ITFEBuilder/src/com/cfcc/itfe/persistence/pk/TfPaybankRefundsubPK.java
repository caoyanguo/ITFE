...
/**
 * <p>Title: PK of table: TF_PAYBANK_REFUNDSUB</p>
 * <p>Description: 收款银行退款通知2252子表 PK Object  </p>
...
public class TfPaybankRefundsubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfPaybankRefundsubPK))
            return false;

        TfPaybankRefundsubPK bean = (TfPaybankRefundsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfPaybankRefundsubPK bean = new TfPaybankRefundsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfPaybankRefundsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_PAYBANK_REFUNDSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_PAYBANK_REFUNDSUB 字段：I_SEQNO 不能为空; ");
