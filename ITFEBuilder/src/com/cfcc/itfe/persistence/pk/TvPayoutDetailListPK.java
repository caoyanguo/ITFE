...
/**
 * <p>Title: PK of table: TV_PAYOUT_DETAIL_LIST</p>
...
public class TvPayoutDetailListPK implements IPK
{
    /**
    *  拨款清单明细编号 S_ID VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayoutDetailListPK))
            return false;

        TvPayoutDetailListPK bean = (TvPayoutDetailListPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayoutDetailListPK bean = new TvPayoutDetailListPK();
          if(this.sid!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayoutDetailListPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSid()==null)
              sb.append("数据库表：TV_PAYOUT_DETAIL_LIST 字段：S_ID 不能为空; ");
                
       if (this.getSid()!=null)
          if (this.getSid().getBytes().length > 38)
             sb.append("数据库表：TV_PAYOUT_DETAIL_LIST 字段：S_ID 宽度不能超过 "+38);
