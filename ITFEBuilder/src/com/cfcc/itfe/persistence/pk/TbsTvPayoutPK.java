...
/**
 * <p>Title: PK of table: TBS_TV_PAYOUT</p>
...
public class TbsTvPayoutPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TbsTvPayoutPK))
            return false;

        TbsTvPayoutPK bean = (TbsTvPayoutPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TbsTvPayoutPK bean = new TbsTvPayoutPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TbsTvPayoutPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TBS_TV_PAYOUT 字段：I_VOUSRLNO 不能为空; ");
