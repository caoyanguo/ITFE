...
/**
 * <p>Title: PK of table: TV_GRANTPAYFILESUB</p>
...
public class TvGrantpayfilesubPK implements IPK
{
    /**
    ...
    *   S_FUNSUBJECTCODE VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvGrantpayfilesubPK))
            return false;

        TvGrantpayfilesubPK bean = (TvGrantpayfilesubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvGrantpayfilesubPK bean = new TvGrantpayfilesubPK();
          if(this.sorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvGrantpayfilesubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TV_GRANTPAYFILESUB 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TV_GRANTPAYFILESUB 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getInobeforepackage()==null)
              sb.append("数据库表：TV_GRANTPAYFILESUB 字段：I_NOBEFOREPACKAGE 不能为空; ");
                        
        if (this.getSfunsubjectcode()==null)
              sb.append("数据库表：TV_GRANTPAYFILESUB 字段：S_FUNSUBJECTCODE 不能为空; ");
                
       if (this.getSfunsubjectcode()!=null)
          if (this.getSfunsubjectcode().getBytes().length > 30)
             sb.append("数据库表：TV_GRANTPAYFILESUB 字段：S_FUNSUBJECTCODE 宽度不能超过 "+30);
