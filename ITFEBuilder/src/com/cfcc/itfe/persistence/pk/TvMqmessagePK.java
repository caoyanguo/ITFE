...
/**
 * <p>Title: PK of table: TV_MQMESSAGE</p>
...
public class TvMqmessagePK implements IPK
{
    /**
    *   I_SEQNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvMqmessagePK))
            return false;

        TvMqmessagePK bean = (TvMqmessagePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvMqmessagePK bean = new TvMqmessagePK();
          if(this.iseqno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvMqmessagePK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIseqno()==null)
              sb.append("数据库表：TV_MQMESSAGE 字段：I_SEQNO 不能为空; ");
