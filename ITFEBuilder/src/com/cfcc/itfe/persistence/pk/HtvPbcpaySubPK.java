...
/**
 * <p>Title: PK of table: HTV_PBCPAY_SUB</p>
...
public class HtvPbcpaySubPK implements IPK
{
    /**
    ...
    *   I_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvPbcpaySubPK))
            return false;

        HtvPbcpaySubPK bean = (HtvPbcpaySubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvPbcpaySubPK bean = new HtvPbcpaySubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvPbcpaySubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_PBCPAY_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTV_PBCPAY_SUB 字段：I_SEQNO 不能为空; ");
