...
/**
 * <p>Title: PK of table: TF_GRANTPAY_ADJUSTMAIN</p>
 * <p>Description: 财政授权支付调整凭证5351主表 PK Object  </p>
...
public class TfGrantpayAdjustmainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfGrantpayAdjustmainPK))
            return false;

        TfGrantpayAdjustmainPK bean = (TfGrantpayAdjustmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfGrantpayAdjustmainPK bean = new TfGrantpayAdjustmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfGrantpayAdjustmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_GRANTPAY_ADJUSTMAIN 字段：I_VOUSRLNO 不能为空; ");
