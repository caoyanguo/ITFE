...
/**
 * <p>Title: PK of table: HTF_GRANTPAYMSGSUB</p>
 * <p>Description: 财政授权支付凭证明细信息（8202）明细(历史表) PK Object  </p>
...
public class HtfGrantpaymsgsubPK implements IPK
{
    /**
    ...
    *  主键流水号 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfGrantpaymsgsubPK))
            return false;

        HtfGrantpaymsgsubPK bean = (HtfGrantpaymsgsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfGrantpaymsgsubPK bean = new HtfGrantpaymsgsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfGrantpaymsgsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_GRANTPAYMSGSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_GRANTPAYMSGSUB 字段：I_SEQNO 不能为空; ");
