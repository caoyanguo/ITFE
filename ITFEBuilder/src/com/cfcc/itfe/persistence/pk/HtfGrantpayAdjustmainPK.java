...
/**
 * <p>Title: PK of table: HTF_GRANTPAY_ADJUSTMAIN</p>
...
public class HtfGrantpayAdjustmainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfGrantpayAdjustmainPK))
            return false;

        HtfGrantpayAdjustmainPK bean = (HtfGrantpayAdjustmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfGrantpayAdjustmainPK bean = new HtfGrantpayAdjustmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfGrantpayAdjustmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_GRANTPAY_ADJUSTMAIN 字段：I_VOUSRLNO 不能为空; ");
