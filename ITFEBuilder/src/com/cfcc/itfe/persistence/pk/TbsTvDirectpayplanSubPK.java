...
/**
 * <p>Title: PK of table: TBS_TV_DIRECTPAYPLAN_SUB</p>
...
public class TbsTvDirectpayplanSubPK implements IPK
{
    /**
    ...
    *   I_DETAILSEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TbsTvDirectpayplanSubPK))
            return false;

        TbsTvDirectpayplanSubPK bean = (TbsTvDirectpayplanSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TbsTvDirectpayplanSubPK bean = new TbsTvDirectpayplanSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TbsTvDirectpayplanSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TBS_TV_DIRECTPAYPLAN_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIdetailseqno()==null)
              sb.append("数据库表：TBS_TV_DIRECTPAYPLAN_SUB 字段：I_DETAILSEQNO 不能为空; ");
