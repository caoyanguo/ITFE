...
/**
 * <p>Title: PK of table: HTV_IN_CORRHANDBOOK</p>
...
public class HtvInCorrhandbookPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvInCorrhandbookPK))
            return false;

        HtvInCorrhandbookPK bean = (HtvInCorrhandbookPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvInCorrhandbookPK bean = new HtvInCorrhandbookPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvInCorrhandbookPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_IN_CORRHANDBOOK 字段：I_VOUSRLNO 不能为空; ");
