...
/**
 * <p>Title: PK of table: TF_INTERESTRATE_MSG</p>
 * <p>Description: 计息统计信息表 PK Object  </p>
...
public class TfInterestrateMsgPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfInterestrateMsgPK))
            return false;

        TfInterestrateMsgPK bean = (TfInterestrateMsgPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfInterestrateMsgPK bean = new TfInterestrateMsgPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfInterestrateMsgPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_INTERESTRATE_MSG 字段：I_VOUSRLNO 不能为空; ");
