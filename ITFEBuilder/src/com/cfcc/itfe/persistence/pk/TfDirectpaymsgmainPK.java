...
/**
 * <p>Title: PK of table: TF_DIRECTPAYMSGMAIN</p>
 * <p>Description: 财政直接支付凭证5201主表 PK Object  </p>
...
public class TfDirectpaymsgmainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfDirectpaymsgmainPK))
            return false;

        TfDirectpaymsgmainPK bean = (TfDirectpaymsgmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfDirectpaymsgmainPK bean = new TfDirectpaymsgmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfDirectpaymsgmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_DIRECTPAYMSGMAIN 字段：I_VOUSRLNO 不能为空; ");
