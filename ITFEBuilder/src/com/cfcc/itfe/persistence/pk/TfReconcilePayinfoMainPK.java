...
/**
 * <p>Title: PK of table: TF_RECONCILE_PAYINFO_MAIN</p>
 * <p>Description: 清算信息对帐主表3507 PK Object  </p>
...
public class TfReconcilePayinfoMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcilePayinfoMainPK))
            return false;

        TfReconcilePayinfoMainPK bean = (TfReconcilePayinfoMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReconcilePayinfoMainPK bean = new TfReconcilePayinfoMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcilePayinfoMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_RECONCILE_PAYINFO_MAIN 字段：I_VOUSRLNO 不能为空; ");
