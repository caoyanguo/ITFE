...
/**
 * <p>Title: PK of table: TF_RECONCILE_REALDIAL_SUB</p>
 * <p>Description: 实拨信息对帐子表3508 PK Object  </p>
...
public class TfReconcileRealdialSubPK implements IPK
{
    /**
    ...
    *  联合主键 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcileRealdialSubPK))
            return false;

        TfReconcileRealdialSubPK bean = (TfReconcileRealdialSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReconcileRealdialSubPK bean = new TfReconcileRealdialSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcileRealdialSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_RECONCILE_REALDIAL_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_RECONCILE_REALDIAL_SUB 字段：I_SEQNO 不能为空; ");
