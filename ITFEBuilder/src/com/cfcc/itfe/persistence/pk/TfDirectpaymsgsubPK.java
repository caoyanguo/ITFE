...
/**
 * <p>Title: PK of table: TF_DIRECTPAYMSGSUB</p>
 * <p>Description: 财政直接支付凭证5201子表 PK Object  </p>
...
public class TfDirectpaymsgsubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfDirectpaymsgsubPK))
            return false;

        TfDirectpaymsgsubPK bean = (TfDirectpaymsgsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfDirectpaymsgsubPK bean = new TfDirectpaymsgsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfDirectpaymsgsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_DIRECTPAYMSGSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_DIRECTPAYMSGSUB 字段：I_SEQNO 不能为空; ");
