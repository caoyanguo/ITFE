...
/**
 * <p>Title: PK of table: HTF_PAYMENT_DETAILSSUB</p>
...
public class HtfPaymentDetailssubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfPaymentDetailssubPK))
            return false;

        HtfPaymentDetailssubPK bean = (HtfPaymentDetailssubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfPaymentDetailssubPK bean = new HtfPaymentDetailssubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfPaymentDetailssubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_PAYMENT_DETAILSSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_PAYMENT_DETAILSSUB 字段：I_SEQNO 不能为空; ");
