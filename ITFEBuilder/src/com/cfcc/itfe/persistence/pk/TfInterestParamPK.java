...
/**
 * <p>Title: PK of table: TF_INTEREST_PARAM</p>
...
public class TfInterestParamPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfInterestParamPK))
            return false;

        TfInterestParamPK bean = (TfInterestParamPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfInterestParamPK bean = new TfInterestParamPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfInterestParamPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_INTEREST_PARAM 字段：I_VOUSRLNO 不能为空; ");
