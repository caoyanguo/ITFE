...
/**
 * <p>Title: PK of table: TF_REPORT_INCOME_MAIN</p>
 * <p>Description: 收入报表对帐主表3511 PK Object  </p>
...
public class TfReportIncomeMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReportIncomeMainPK))
            return false;

        TfReportIncomeMainPK bean = (TfReportIncomeMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReportIncomeMainPK bean = new TfReportIncomeMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReportIncomeMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_REPORT_INCOME_MAIN 字段：I_VOUSRLNO 不能为空; ");
