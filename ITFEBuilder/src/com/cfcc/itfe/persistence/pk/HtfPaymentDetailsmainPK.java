...
/**
 * <p>Title: PK of table: HTF_PAYMENT_DETAILSMAIN</p>
...
public class HtfPaymentDetailsmainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfPaymentDetailsmainPK))
            return false;

        HtfPaymentDetailsmainPK bean = (HtfPaymentDetailsmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfPaymentDetailsmainPK bean = new HtfPaymentDetailsmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfPaymentDetailsmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_PAYMENT_DETAILSMAIN 字段：I_VOUSRLNO 不能为空; ");
