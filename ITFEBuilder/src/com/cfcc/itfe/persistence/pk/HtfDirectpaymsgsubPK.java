...
/**
 * <p>Title: PK of table: HTF_DIRECTPAYMSGSUB</p>
...
public class HtfDirectpaymsgsubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfDirectpaymsgsubPK))
            return false;

        HtfDirectpaymsgsubPK bean = (HtfDirectpaymsgsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfDirectpaymsgsubPK bean = new HtfDirectpaymsgsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfDirectpaymsgsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_DIRECTPAYMSGSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_DIRECTPAYMSGSUB 字段：I_SEQNO 不能为空; ");
