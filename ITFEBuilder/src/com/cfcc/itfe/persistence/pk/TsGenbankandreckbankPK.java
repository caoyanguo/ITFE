...
/**
 * <p>Title: PK of table: TS_GENBANKANDRECKBANK</p>
...
public class TsGenbankandreckbankPK implements IPK
{
    /**
    *   I_SEQNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsGenbankandreckbankPK))
            return false;

        TsGenbankandreckbankPK bean = (TsGenbankandreckbankPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TsGenbankandreckbankPK bean = new TsGenbankandreckbankPK();
          if(this.iseqno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsGenbankandreckbankPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIseqno()==null)
              sb.append("数据库表：TS_GENBANKANDRECKBANK 字段：I_SEQNO 不能为空; ");
