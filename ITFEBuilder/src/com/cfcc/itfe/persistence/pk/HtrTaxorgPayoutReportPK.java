...
/**
 * <p>Title: PK of table: HTR_TAXORG_PAYOUT_REPORT</p>
...
public class HtrTaxorgPayoutReportPK implements IPK
{
    /**
    ...
    *   S_FINORGCODE VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtrTaxorgPayoutReportPK))
            return false;

        HtrTaxorgPayoutReportPK bean = (HtrTaxorgPayoutReportPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtrTaxorgPayoutReportPK bean = new HtrTaxorgPayoutReportPK();
          if(this.staxorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtrTaxorgPayoutReportPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getStaxorgcode()==null)
              sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_TAXORGCODE 不能为空; ");
                
       if (this.getStaxorgcode()!=null)
          if (this.getStaxorgcode().getBytes().length > 12)
             sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_TAXORGCODE 宽度不能超过 "+12);
                
        if (this.getStrecode()==null)
              sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_TRECODE 不能为空; ");
                
       if (this.getStrecode()!=null)
          if (this.getStrecode().getBytes().length > 10)
             sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_TRECODE 宽度不能超过 "+10);
                
        if (this.getSrptdate()==null)
              sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_RPTDATE 不能为空; ");
                
       if (this.getSrptdate()!=null)
          if (this.getSrptdate().getBytes().length > 8)
             sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_RPTDATE 宽度不能超过 "+8);
                
        if (this.getSbudgettype()==null)
              sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_BUDGETTYPE 不能为空; ");
                
       if (this.getSbudgettype()!=null)
          if (this.getSbudgettype().getBytes().length > 1)
             sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_BUDGETTYPE 宽度不能超过 "+1);
                
        if (this.getSbudgetlevelcode()==null)
              sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_BUDGETLEVELCODE 不能为空; ");
                
       if (this.getSbudgetlevelcode()!=null)
          if (this.getSbudgetlevelcode().getBytes().length > 1)
             sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_BUDGETLEVELCODE 宽度不能超过 "+1);
                
        if (this.getSbudgetsubcode()==null)
              sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_BUDGETSUBCODE 不能为空; ");
                
       if (this.getSbudgetsubcode()!=null)
          if (this.getSbudgetsubcode().getBytes().length > 30)
             sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_BUDGETSUBCODE 宽度不能超过 "+30);
                
        if (this.getSfinorgcode()==null)
              sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_FINORGCODE 不能为空; ");
                
       if (this.getSfinorgcode()!=null)
          if (this.getSfinorgcode().getBytes().length > 30)
             sb.append("数据库表：HTR_TAXORG_PAYOUT_REPORT 字段：S_FINORGCODE 宽度不能超过 "+30);
