...
/**
 * <p>Title: PK of table: TS_BANKORGCODE</p>
...
public class TsBankorgcodePK implements IPK
{
    /**
    ...
    *   S_BANKNO CHARACTER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsBankorgcodePK))
            return false;

        TsBankorgcodePK bean = (TsBankorgcodePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TsBankorgcodePK bean = new TsBankorgcodePK();
          if(this.sorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsBankorgcodePK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_BANKORGCODE 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_BANKORGCODE 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getSbankno()==null)
              sb.append("数据库表：TS_BANKORGCODE 字段：S_BANKNO 不能为空; ");
                
       if (this.getSbankno()!=null)
          if (this.getSbankno().getBytes().length > 12)
             sb.append("数据库表：TS_BANKORGCODE 字段：S_BANKNO 宽度不能超过 "+12);
