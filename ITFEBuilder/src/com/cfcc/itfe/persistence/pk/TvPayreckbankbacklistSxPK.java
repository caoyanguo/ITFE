...
/**
 * <p>Title: PK of table: TV_PAYRECKBANKBACKLIST_SX</p>
...
public class TvPayreckbankbacklistSxPK implements IPK
{
    /**
    ...
    *   I_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayreckbankbacklistSxPK))
            return false;

        TvPayreckbankbacklistSxPK bean = (TvPayreckbankbacklistSxPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayreckbankbacklistSxPK bean = new TvPayreckbankbacklistSxPK();
          if(this.ivousrlno!=null){
                  bean.ivousrlno = new Long(this.ivousrlno.toString());
            }
             if(this.iseqno!=null){
                  bean.iseqno = new Integer(this.iseqno.toString());
            }
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayreckbankbacklistSxPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PAYRECKBANKBACKLIST_SX 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TV_PAYRECKBANKBACKLIST_SX 字段：I_SEQNO 不能为空; ");
