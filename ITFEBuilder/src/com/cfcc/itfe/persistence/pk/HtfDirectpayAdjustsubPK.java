...
/**
 * <p>Title: PK of table: HTF_DIRECTPAY_ADJUSTSUB</p>
 * <p>Description: 财政直接支付调整凭证5253子表 PK Object  </p>
...
public class HtfDirectpayAdjustsubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfDirectpayAdjustsubPK))
            return false;

        HtfDirectpayAdjustsubPK bean = (HtfDirectpayAdjustsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfDirectpayAdjustsubPK bean = new HtfDirectpayAdjustsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfDirectpayAdjustsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_DIRECTPAY_ADJUSTSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_DIRECTPAY_ADJUSTSUB 字段：I_SEQNO 不能为空; ");
