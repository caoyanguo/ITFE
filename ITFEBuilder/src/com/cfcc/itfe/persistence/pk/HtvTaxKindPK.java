...
/**
 * <p>Title: PK of table: HTV_TAX_KIND</p>
...
public class HtvTaxKindPK implements IPK
{
    /**
    ...
    *   I_PROJECTID INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvTaxKindPK))
            return false;

        HtvTaxKindPK bean = (HtvTaxKindPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvTaxKindPK bean = new HtvTaxKindPK();
          if(this.sseq!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSseq()==null)
              sb.append("数据库表：HTV_TAX_KIND 字段：S_SEQ 不能为空; ");
                
       if (this.getSseq()!=null)
          if (this.getSseq().getBytes().length > 20)
             sb.append("数据库表：HTV_TAX_KIND 字段：S_SEQ 宽度不能超过 "+20);
                
        if (this.getIprojectid()==null)
              sb.append("数据库表：HTV_TAX_KIND 字段：I_PROJECTID 不能为空; ");
