...
/**
 * <p>Title: PK of table: TV_INFILE</p>
...
public class TvInfilePK implements IPK
{
    /**
    ...
    *   S_DEALNO VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvInfilePK))
            return false;

        TvInfilePK bean = (TvInfilePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvInfilePK bean = new TvInfilePK();
          if(this.sorgcode!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TV_INFILE 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TV_INFILE 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getScommitdate()==null)
              sb.append("数据库表：TV_INFILE 字段：S_COMMITDATE 不能为空; ");
                
       if (this.getScommitdate()!=null)
          if (this.getScommitdate().getBytes().length > 8)
             sb.append("数据库表：TV_INFILE 字段：S_COMMITDATE 宽度不能超过 "+8);
                
        if (this.getSdealno()==null)
              sb.append("数据库表：TV_INFILE 字段：S_DEALNO 不能为空; ");
                
       if (this.getSdealno()!=null)
          if (this.getSdealno().getBytes().length > 8)
             sb.append("数据库表：TV_INFILE 字段：S_DEALNO 宽度不能超过 "+8);
