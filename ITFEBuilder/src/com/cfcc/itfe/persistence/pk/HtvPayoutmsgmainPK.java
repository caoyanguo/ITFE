...
/**
 * <p>Title: PK of table: HTV_PAYOUTMSGMAIN</p>
...
public class HtvPayoutmsgmainPK implements IPK
{
    /**
    *   S_BIZNO VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvPayoutmsgmainPK))
            return false;

        HtvPayoutmsgmainPK bean = (HtvPayoutmsgmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvPayoutmsgmainPK bean = new HtvPayoutmsgmainPK();
          if(this.sbizno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvPayoutmsgmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSbizno()==null)
              sb.append("数据库表：HTV_PAYOUTMSGMAIN 字段：S_BIZNO 不能为空; ");
                
       if (this.getSbizno()!=null)
          if (this.getSbizno().getBytes().length > 20)
             sb.append("数据库表：HTV_PAYOUTMSGMAIN 字段：S_BIZNO 宽度不能超过 "+20);
