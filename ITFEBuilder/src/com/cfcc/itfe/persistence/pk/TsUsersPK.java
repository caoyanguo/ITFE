...
/**
 * <p>Title: PK of table: TS_USERS</p>
...
public class TsUsersPK implements IPK
{
    /**
    ...
    *   S_USERCODE VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsUsersPK))
            return false;

        TsUsersPK bean = (TsUsersPK) obj;
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_USERS 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_USERS 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getSusercode()==null)
              sb.append("数据库表：TS_USERS 字段：S_USERCODE 不能为空; ");
                
       if (this.getSusercode()!=null)
          if (this.getSusercode().getBytes().length > 30)
             sb.append("数据库表：TS_USERS 字段：S_USERCODE 宽度不能超过 "+30);
