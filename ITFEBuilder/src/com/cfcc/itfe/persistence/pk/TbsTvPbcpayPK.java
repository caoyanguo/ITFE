...
/**
 * <p>Title: PK of table: TBS_TV_PBCPAY</p>
...
public class TbsTvPbcpayPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TbsTvPbcpayPK))
            return false;

        TbsTvPbcpayPK bean = (TbsTvPbcpayPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TbsTvPbcpayPK bean = new TbsTvPbcpayPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TbsTvPbcpayPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TBS_TV_PBCPAY 字段：I_VOUSRLNO 不能为空; ");
