...
/**
 * <p>Title: PK of table: TV_PAYOUTBACKMSG_SUB</p>
...
public class TvPayoutbackmsgSubPK implements IPK
{
    /**
    ...
    *   S_SEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPayoutbackmsgSubPK))
            return false;

        TvPayoutbackmsgSubPK bean = (TvPayoutbackmsgSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPayoutbackmsgSubPK bean = new TvPayoutbackmsgSubPK();
          if(this.sbizno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPayoutbackmsgSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSbizno()==null)
              sb.append("数据库表：TV_PAYOUTBACKMSG_SUB 字段：S_BIZNO 不能为空; ");
                
       if (this.getSbizno()!=null)
          if (this.getSbizno().getBytes().length > 20)
             sb.append("数据库表：TV_PAYOUTBACKMSG_SUB 字段：S_BIZNO 宽度不能超过 "+20);
                
        if (this.getSseqno()==null)
              sb.append("数据库表：TV_PAYOUTBACKMSG_SUB 字段：S_SEQNO 不能为空; ");
