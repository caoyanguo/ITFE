...
/**
 * <p>Title: PK of table: HTF_UNITRECORDMAIN</p>
...
public class HtfUnitrecordmainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfUnitrecordmainPK))
            return false;

        HtfUnitrecordmainPK bean = (HtfUnitrecordmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfUnitrecordmainPK bean = new HtfUnitrecordmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfUnitrecordmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_UNITRECORDMAIN 字段：I_VOUSRLNO 不能为空; ");
