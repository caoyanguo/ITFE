...
/**
 * <p>Title: PK of table: TV_DIRECTPAYMSGMAIN_SX</p>
...
public class TvDirectpaymsgmainSxPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvDirectpaymsgmainSxPK))
            return false;

        TvDirectpaymsgmainSxPK bean = (TvDirectpaymsgmainSxPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvDirectpaymsgmainSxPK bean = new TvDirectpaymsgmainSxPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvDirectpaymsgmainSxPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_DIRECTPAYMSGMAIN_SX 字段：I_VOUSRLNO 不能为空; ");
