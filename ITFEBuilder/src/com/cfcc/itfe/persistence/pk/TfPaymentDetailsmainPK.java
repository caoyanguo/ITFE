...
/**
 * <p>Title: PK of table: TF_PAYMENT_DETAILSMAIN</p>
 * <p>Description: 财政批量业务支付明细8207主表 PK Object  </p>
...
public class TfPaymentDetailsmainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfPaymentDetailsmainPK))
            return false;

        TfPaymentDetailsmainPK bean = (TfPaymentDetailsmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfPaymentDetailsmainPK bean = new TfPaymentDetailsmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfPaymentDetailsmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_PAYMENT_DETAILSMAIN 字段：I_VOUSRLNO 不能为空; ");
