...
/**
 * <p>Title: PK of table: TF_RECONCILE_REALDIAL_MAIN</p>
 * <p>Description: 实拨信息对帐主表3508-5508 PK Object  </p>
...
public class TfReconcileRealdialMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcileRealdialMainPK))
            return false;

        TfReconcileRealdialMainPK bean = (TfReconcileRealdialMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReconcileRealdialMainPK bean = new TfReconcileRealdialMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcileRealdialMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_RECONCILE_REALDIAL_MAIN 字段：I_VOUSRLNO 不能为空; ");
