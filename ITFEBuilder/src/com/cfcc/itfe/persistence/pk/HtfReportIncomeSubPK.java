...
/**
 * <p>Title: PK of table: HTF_REPORT_INCOME_SUB</p>
 * <p>Description: 收入报表对帐子表历史表3511 PK Object  </p>
...
public class HtfReportIncomeSubPK implements IPK
{
    /**
    ...
    *  联合主键 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReportIncomeSubPK))
            return false;

        HtfReportIncomeSubPK bean = (HtfReportIncomeSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReportIncomeSubPK bean = new HtfReportIncomeSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReportIncomeSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_REPORT_INCOME_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_REPORT_INCOME_SUB 字段：I_SEQNO 不能为空; ");
