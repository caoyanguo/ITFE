...
/**
 * <p>Title: PK of table: HTV_PBCPAY_MAIN</p>
...
public class HtvPbcpayMainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvPbcpayMainPK))
            return false;

        HtvPbcpayMainPK bean = (HtvPbcpayMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtvPbcpayMainPK bean = new HtvPbcpayMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtvPbcpayMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_PBCPAY_MAIN 字段：I_VOUSRLNO 不能为空; ");
