...
/**
 * <p>Title: PK of table: TF_UNITRECORDSUB</p>
 * <p>Description: 单位清册5951子表 PK Object  </p>
...
public class TfUnitrecordsubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfUnitrecordsubPK))
            return false;

        TfUnitrecordsubPK bean = (TfUnitrecordsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfUnitrecordsubPK bean = new TfUnitrecordsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfUnitrecordsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_UNITRECORDSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_UNITRECORDSUB 字段：I_SEQNO 不能为空; ");
