...
/**
 * <p>Title: PK of table: TBS_TV_DIRECTPAYPLAN_MAIN</p>
...
public class TbsTvDirectpayplanMainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TbsTvDirectpayplanMainPK))
            return false;

        TbsTvDirectpayplanMainPK bean = (TbsTvDirectpayplanMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TbsTvDirectpayplanMainPK bean = new TbsTvDirectpayplanMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TbsTvDirectpayplanMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TBS_TV_DIRECTPAYPLAN_MAIN 字段：I_VOUSRLNO 不能为空; ");
