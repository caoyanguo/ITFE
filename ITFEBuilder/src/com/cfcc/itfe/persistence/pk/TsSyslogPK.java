...
/**
 * <p>Title: PK of table: TS_SYSLOG</p>
...
public class TsSyslogPK implements IPK
{
    /**
    *   I_NO INTEGER  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsSyslogPK))
            return false;

        TsSyslogPK bean = (TsSyslogPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TsSyslogPK bean = new TsSyslogPK();
          if(this.ino!=null){
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIno()==null)
              sb.append("数据库表：TS_SYSLOG 字段：I_NO 不能为空; ");
