...
/**
 * <p>Title: PK of table: TS_CONVERTBANKTYPE</p>
...
public class TsConvertbanktypePK implements IPK
{
    /**
    ...
    *   S_BANKCODE CHARACTER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsConvertbanktypePK))
            return false;

        TsConvertbanktypePK bean = (TsConvertbanktypePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TsConvertbanktypePK bean = new TsConvertbanktypePK();
          if(this.sorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsConvertbanktypePK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_CONVERTBANKTYPE 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_CONVERTBANKTYPE 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getStrecode()==null)
              sb.append("数据库表：TS_CONVERTBANKTYPE 字段：S_TRECODE 不能为空; ");
                
       if (this.getStrecode()!=null)
          if (this.getStrecode().getBytes().length > 12)
             sb.append("数据库表：TS_CONVERTBANKTYPE 字段：S_TRECODE 宽度不能超过 "+12);
                
        if (this.getSbankcode()==null)
              sb.append("数据库表：TS_CONVERTBANKTYPE 字段：S_BANKCODE 不能为空; ");
                
       if (this.getSbankcode()!=null)
          if (this.getSbankcode().getBytes().length > 12)
             sb.append("数据库表：TS_CONVERTBANKTYPE 字段：S_BANKCODE 宽度不能超过 "+12);
