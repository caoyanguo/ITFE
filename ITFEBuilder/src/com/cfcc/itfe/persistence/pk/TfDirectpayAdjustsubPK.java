...
/**
 * <p>Title: PK of table: TF_DIRECTPAY_ADJUSTSUB</p>
...
public class TfDirectpayAdjustsubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfDirectpayAdjustsubPK))
            return false;

        TfDirectpayAdjustsubPK bean = (TfDirectpayAdjustsubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfDirectpayAdjustsubPK bean = new TfDirectpayAdjustsubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfDirectpayAdjustsubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_DIRECTPAY_ADJUSTSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_DIRECTPAY_ADJUSTSUB 字段：I_SEQNO 不能为空; ");
