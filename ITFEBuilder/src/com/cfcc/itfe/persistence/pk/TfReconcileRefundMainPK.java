...
/**
 * <p>Title: PK of table: TF_RECONCILE_REFUND_MAIN</p>
 * <p>Description: 收入退付对帐主表3509 PK Object  </p>
...
public class TfReconcileRefundMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcileRefundMainPK))
            return false;

        TfReconcileRefundMainPK bean = (TfReconcileRefundMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReconcileRefundMainPK bean = new TfReconcileRefundMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcileRefundMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_RECONCILE_REFUND_MAIN 字段：I_VOUSRLNO 不能为空; ");
