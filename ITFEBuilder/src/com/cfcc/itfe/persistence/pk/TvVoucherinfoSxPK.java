...
/**
 * <p>Title: PK of table: TV_VOUCHERINFO_SX</p>
...
public class TvVoucherinfoSxPK implements IPK
{
    /**
    *   S_DEALNO VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvVoucherinfoSxPK))
            return false;

        TvVoucherinfoSxPK bean = (TvVoucherinfoSxPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvVoucherinfoSxPK bean = new TvVoucherinfoSxPK();
          if(this.sdealno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvVoucherinfoSxPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSdealno()==null)
              sb.append("数据库表：TV_VOUCHERINFO_SX 字段：S_DEALNO 不能为空; ");
                
       if (this.getSdealno()!=null)
          if (this.getSdealno().getBytes().length > 16)
             sb.append("数据库表：TV_VOUCHERINFO_SX 字段：S_DEALNO 宽度不能超过 "+16);
