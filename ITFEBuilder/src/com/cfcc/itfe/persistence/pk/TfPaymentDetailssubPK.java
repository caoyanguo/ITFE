...
/**
 * <p>Title: PK of table: TF_PAYMENT_DETAILSSUB</p>
 * <p>Description: 财政批量业务支付明细8207子表 PK Object  </p>
...
public class TfPaymentDetailssubPK implements IPK
{
    /**
    ...
    *   I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfPaymentDetailssubPK))
            return false;

        TfPaymentDetailssubPK bean = (TfPaymentDetailssubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfPaymentDetailssubPK bean = new TfPaymentDetailssubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfPaymentDetailssubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_PAYMENT_DETAILSSUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_PAYMENT_DETAILSSUB 字段：I_SEQNO 不能为空; ");
