...
/**
 * <p>Title: PK of table: TF_DIRECTPAY_ADJUSTMAIN</p>
...
public class TfDirectpayAdjustmainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfDirectpayAdjustmainPK))
            return false;

        TfDirectpayAdjustmainPK bean = (TfDirectpayAdjustmainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfDirectpayAdjustmainPK bean = new TfDirectpayAdjustmainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfDirectpayAdjustmainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_DIRECTPAY_ADJUSTMAIN 字段：I_VOUSRLNO 不能为空; ");
