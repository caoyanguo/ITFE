...
/**
 * <p>Title: PK of table: TF_REPORT_DEPOSIT_MAIN</p>
 * <p>Description: 库款账户对帐主表3513 PK Object  </p>
...
public class TfReportDepositMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReportDepositMainPK))
            return false;

        TfReportDepositMainPK bean = (TfReportDepositMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReportDepositMainPK bean = new TfReportDepositMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReportDepositMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_REPORT_DEPOSIT_MAIN 字段：I_VOUSRLNO 不能为空; ");
