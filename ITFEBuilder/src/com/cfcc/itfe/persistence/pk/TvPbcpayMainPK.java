...
/**
 * <p>Title: PK of table: TV_PBCPAY_MAIN</p>
...
public class TvPbcpayMainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL   , Identity  , Generated     */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvPbcpayMainPK))
            return false;

        TvPbcpayMainPK bean = (TvPbcpayMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvPbcpayMainPK bean = new TvPbcpayMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvPbcpayMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_PBCPAY_MAIN 字段：I_VOUSRLNO 不能为空; ");
