...
/**
 * <p>Title: PK of table: HTF_REPORT_DEPOSIT_SUB</p>
 * <p>Description: 库款账户对帐子表历史表3513 PK Object  </p>
...
public class HtfReportDepositSubPK implements IPK
{
    /**
    ...
    *  联合主键 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReportDepositSubPK))
            return false;

        HtfReportDepositSubPK bean = (HtfReportDepositSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReportDepositSubPK bean = new HtfReportDepositSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReportDepositSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_REPORT_DEPOSIT_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：HTF_REPORT_DEPOSIT_SUB 字段：I_SEQNO 不能为空; ");
