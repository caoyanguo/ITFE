...
/**
 * <p>Title: PK of table: HTF_RECONCILE_REALDIAL_MAIN</p>
...
public class HtfReconcileRealdialMainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReconcileRealdialMainPK))
            return false;

        HtfReconcileRealdialMainPK bean = (HtfReconcileRealdialMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReconcileRealdialMainPK bean = new HtfReconcileRealdialMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReconcileRealdialMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_RECONCILE_REALDIAL_MAIN 字段：I_VOUSRLNO 不能为空; ");
