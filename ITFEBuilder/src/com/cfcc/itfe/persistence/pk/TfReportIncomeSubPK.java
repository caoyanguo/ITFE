...
/**
 * <p>Title: PK of table: TF_REPORT_INCOME_SUB</p>
 * <p>Description: 收入报表对帐子表3511 PK Object  </p>
...
public class TfReportIncomeSubPK implements IPK
{
    /**
    ...
    *  联合主键 I_SEQNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReportIncomeSubPK))
            return false;

        TfReportIncomeSubPK bean = (TfReportIncomeSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReportIncomeSubPK bean = new TfReportIncomeSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReportIncomeSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_REPORT_INCOME_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIseqno()==null)
              sb.append("数据库表：TF_REPORT_INCOME_SUB 字段：I_SEQNO 不能为空; ");
