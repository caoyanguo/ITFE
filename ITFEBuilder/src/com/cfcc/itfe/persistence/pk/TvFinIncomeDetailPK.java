...
/**
 * <p>Title: PK of table: TV_FIN_INCOME_DETAIL</p>
...
public class TvFinIncomeDetailPK implements IPK
{
    /**
    *   S_SEQ VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvFinIncomeDetailPK))
            return false;

        TvFinIncomeDetailPK bean = (TvFinIncomeDetailPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvFinIncomeDetailPK bean = new TvFinIncomeDetailPK();
          if(this.sseq!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvFinIncomeDetailPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSseq()==null)
              sb.append("数据库表：TV_FIN_INCOME_DETAIL 字段：S_SEQ 不能为空; ");
                
       if (this.getSseq()!=null)
          if (this.getSseq().getBytes().length > 20)
             sb.append("数据库表：TV_FIN_INCOME_DETAIL 字段：S_SEQ 宽度不能超过 "+20);
