...
/**
 * <p>Title: PK of table: HTF_RECONCILE_PAYQUOTA_MAIN</p>
...
public class HtfReconcilePayquotaMainPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReconcilePayquotaMainPK))
            return false;

        HtfReconcilePayquotaMainPK bean = (HtfReconcilePayquotaMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReconcilePayquotaMainPK bean = new HtfReconcilePayquotaMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReconcilePayquotaMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_RECONCILE_PAYQUOTA_MAIN 字段：I_VOUSRLNO 不能为空; ");
