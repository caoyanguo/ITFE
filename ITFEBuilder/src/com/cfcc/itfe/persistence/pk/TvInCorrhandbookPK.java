...
/**
 * <p>Title: PK of table: TV_IN_CORRHANDBOOK</p>
...
public class TvInCorrhandbookPK implements IPK
{
    /**
    *   I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TvInCorrhandbookPK))
            return false;

        TvInCorrhandbookPK bean = (TvInCorrhandbookPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TvInCorrhandbookPK bean = new TvInCorrhandbookPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TvInCorrhandbookPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TV_IN_CORRHANDBOOK 字段：I_VOUSRLNO 不能为空; ");
