...
/**
 * <p>Title: PK of table: HTV_DWBK</p>
...
public class HtvDwbkPK implements IPK
{
    /**
    ...
    *   S_BOOKORGCODE CHARACTER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtvDwbkPK))
            return false;

        HtvDwbkPK bean = (HtvDwbkPK) obj;
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTV_DWBK 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getSbookorgcode()==null)
              sb.append("数据库表：HTV_DWBK 字段：S_BOOKORGCODE 不能为空; ");
                
       if (this.getSbookorgcode()!=null)
          if (this.getSbookorgcode().getBytes().length > 12)
             sb.append("数据库表：HTV_DWBK 字段：S_BOOKORGCODE 宽度不能超过 "+12);
