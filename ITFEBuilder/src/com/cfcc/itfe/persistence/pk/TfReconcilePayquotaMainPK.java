...
/**
 * <p>Title: PK of table: TF_RECONCILE_PAYQUOTA_MAIN</p>
 * <p>Description: 清算额度对帐主表3510 PK Object  </p>
...
public class TfReconcilePayquotaMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcilePayquotaMainPK))
            return false;

        TfReconcilePayquotaMainPK bean = (TfReconcilePayquotaMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TfReconcilePayquotaMainPK bean = new TfReconcilePayquotaMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcilePayquotaMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TF_RECONCILE_PAYQUOTA_MAIN 字段：I_VOUSRLNO 不能为空; ");
