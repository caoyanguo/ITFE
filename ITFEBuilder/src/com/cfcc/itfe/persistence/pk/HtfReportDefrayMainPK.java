...
/**
 * <p>Title: PK of table: HTF_REPORT_DEFRAY_MAIN</p>
 * <p>Description: 支出报表对帐主表历史表3512 PK Object  </p>
...
public class HtfReportDefrayMainPK implements IPK
{
    /**
    *  主键 I_VOUSRLNO BIGINT  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReportDefrayMainPK))
            return false;

        HtfReportDefrayMainPK bean = (HtfReportDefrayMainPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        HtfReportDefrayMainPK bean = new HtfReportDefrayMainPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReportDefrayMainPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：HTF_REPORT_DEFRAY_MAIN 字段：I_VOUSRLNO 不能为空; ");
