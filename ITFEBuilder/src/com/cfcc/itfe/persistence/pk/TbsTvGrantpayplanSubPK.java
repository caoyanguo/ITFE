...
/**
 * <p>Title: PK of table: TBS_TV_GRANTPAYPLAN_SUB</p>
...
public class TbsTvGrantpayplanSubPK implements IPK
{
    /**
    ...
    *   I_DETAILSEQNO INTEGER  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TbsTvGrantpayplanSubPK))
            return false;

        TbsTvGrantpayplanSubPK bean = (TbsTvGrantpayplanSubPK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
    ...
    public Object clone()
    {
        TbsTvGrantpayplanSubPK bean = new TbsTvGrantpayplanSubPK();
          if(this.ivousrlno!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TbsTvGrantpayplanSubPK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getIvousrlno()==null)
              sb.append("数据库表：TBS_TV_GRANTPAYPLAN_SUB 字段：I_VOUSRLNO 不能为空; ");
                        
        if (this.getIdetailseqno()==null)
              sb.append("数据库表：TBS_TV_GRANTPAYPLAN_SUB 字段：I_DETAILSEQNO 不能为空; ");
