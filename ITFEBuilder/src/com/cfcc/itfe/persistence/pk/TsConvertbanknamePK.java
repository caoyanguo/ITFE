...
/**
 * <p>Title: PK of table: TS_CONVERTBANKNAME</p>
...
public class TsConvertbanknamePK implements IPK
{
    /**
    ...
    *   S_BANKNAME VARCHAR  , PK   , NOT NULL        */
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsConvertbanknamePK))
            return false;

        TsConvertbanknamePK bean = (TsConvertbanknamePK) obj;
   ...
   /* return hashCode ,if A.equals(B) that A.hashCode()==B.hashCode() */
	public int hashCode()
	{
        ...
        if(this.sbankname!=null)
          __hash__ = __hash__ * 31+ this.sbankname.hashCode() ;
    ...
    public Object clone()
    {
        TsConvertbanknamePK bean = new TsConvertbanknamePK();
          if(this.sorgcode!=null){
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsConvertbanknamePK").append(":");
   ...
   public String  checkValid()
  {
  	StringBuffer sb = new StringBuffer() ;
        ...
        if (this.getSorgcode()==null)
              sb.append("数据库表：TS_CONVERTBANKNAME 字段：S_ORGCODE 不能为空; ");
                
       if (this.getSorgcode()!=null)
          if (this.getSorgcode().getBytes().length > 12)
             sb.append("数据库表：TS_CONVERTBANKNAME 字段：S_ORGCODE 宽度不能超过 "+12);
                
        if (this.getSbankname()==null)
              sb.append("数据库表：TS_CONVERTBANKNAME 字段：S_BANKNAME 不能为空; ");
                
       if (this.getSbankname()!=null)
          if (this.getSbankname().getBytes().length > 100)
             sb.append("数据库表：TS_CONVERTBANKNAME 字段：S_BANKNAME 宽度不能超过 "+100);
