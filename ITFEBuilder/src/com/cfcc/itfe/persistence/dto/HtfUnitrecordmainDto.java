...
import com.cfcc.itfe.persistence.pk.HtfUnitrecordmainPK;
/**
 * <p>Title: DTO of table: HTF_UNITRECORDMAIN</p>
...
public class HtfUnitrecordmainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfUnitrecordmainDto))
            return false;

        HtfUnitrecordmainDto bean = (HtfUnitrecordmainDto) obj;
    ...
    public Object clone()
    {
        HtfUnitrecordmainDto bean = new HtfUnitrecordmainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfUnitrecordmainDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_ALLFLAG
      if (this.getSallflag()==null)
             sb.append("S_ALLFLAG不能为空; ");
      if (this.getSallflag()!=null)
             if (this.getSallflag().getBytes().length > 5)
                sb.append("S_ALLFLAG宽度不能超过 "+5+"个字符; ");
    ...
    //check field S_ALLFLAG
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ALLFLAG")) {
               if (this.getSallflag()==null)
                    sb.append("S_ALLFLAG 不能为空; ");
               if (this.getSallflag()!=null)
                    if (this.getSallflag().getBytes().length > 5)
                        sb.append("S_ALLFLAG 宽度不能超过 "+5+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfUnitrecordmainPK pk = new HtfUnitrecordmainPK();
