...
/**
 * <p>Title: DTO of table: TF_DIRECTPAYMSGMAIN</p>
 * <p>Description: 财政直接支付凭证5201主表 Data Transfer Object </p>
...
public class TfDirectpaymsgmainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 凭证类型编号 S_VTCODE VARCHAR   , NOT NULL       */
    ...
    /**
    * 凭证日期 IS S_VOUDATE VARCHAR   , NOT NULL       */
    protected String svoudate;
    /**
    * 凭证号 IS S_VOUCHERNO VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    public String getSvoudate()
    {
     ...
     /**
     *  凭证日期 IS Setter S_VOUDATE , NOT NULL        * */
    ...
    public String getSvoucherno()
    {
     ...
     /**
     *  凭证号 IS Setter S_VOUCHERNO , NOT NULL        * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfDirectpaymsgmainDto))
            return false;

        TfDirectpaymsgmainDto bean = (TfDirectpaymsgmainDto) obj;
    ...
    public Object clone()
    {
        TfDirectpaymsgmainDto bean = new TfDirectpaymsgmainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfDirectpaymsgmainDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_ID
      if (this.getSid()==null)
             sb.append("S_ID凭证ID不能为空; ");
      if (this.getSid()!=null)
             if (this.getSid().getBytes().length > 38)
                sb.append("S_ID凭证ID宽度不能超过 "+38+"个字符; ");
    ...
    //check field S_VOUDATE
      if (this.getSvoudate()==null)
             sb.append("S_VOUDATE凭证日期 IS不能为空; ");
      if (this.getSvoudate()!=null)
             if (this.getSvoudate().getBytes().length > 8)
                sb.append("S_VOUDATE凭证日期 IS宽度不能超过 "+8+"个字符; ");
    
    //check field S_VOUCHERNO
      if (this.getSvoucherno()==null)
             sb.append("S_VOUCHERNO凭证号 IS不能为空; ");
      if (this.getSvoucherno()!=null)
             if (this.getSvoucherno().getBytes().length > 42)
                sb.append("S_VOUCHERNO凭证号 IS宽度不能超过 "+42+"个字符; ");
    ...
    //check field S_ID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ID")) {
               if (this.getSid()==null)
                    sb.append("S_ID 凭证ID不能为空; ");
               if (this.getSid()!=null)
                    if (this.getSid().getBytes().length > 38)
                        sb.append("S_ID 凭证ID宽度不能超过 "+38+"个字符");
             break;
         }
  }
    ...
    //check field S_VOUDATE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VOUDATE")) {
               if (this.getSvoudate()==null)
                    sb.append("S_VOUDATE 凭证日期 IS不能为空; ");
               if (this.getSvoudate()!=null)
                    if (this.getSvoudate().getBytes().length > 8)
                        sb.append("S_VOUDATE 凭证日期 IS宽度不能超过 "+8+"个字符");
             break;
         }
  }
    ...
    //check field S_VOUCHERNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VOUCHERNO")) {
               if (this.getSvoucherno()==null)
                    sb.append("S_VOUCHERNO 凭证号 IS不能为空; ");
               if (this.getSvoucherno()!=null)
                    if (this.getSvoucherno().getBytes().length > 42)
                        sb.append("S_VOUCHERNO 凭证号 IS宽度不能超过 "+42+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfDirectpaymsgmainPK pk = new TfDirectpaymsgmainPK();
