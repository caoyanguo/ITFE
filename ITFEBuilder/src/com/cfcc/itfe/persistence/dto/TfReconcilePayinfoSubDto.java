...
/**
 * <p>Title: DTO of table: TF_RECONCILE_PAYINFO_SUB</p>
 * <p>Description: 清算信息对帐子表3507 Data Transfer Object </p>
...
public class TfReconcilePayinfoSubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 序号 S_ID VARCHAR   , NOT NULL       */
    ...
    /**
    * 清算单号 S_PAYAGENTBILLNO VARCHAR         */
    protected String spayagentbillno;
    /**
    * 清算明细ID S_PAYDETAILID VARCHAR         */
...
*******************************************************/
    ...
    */
    public static String tableName(){
        return "TF_RECONCILE_PAYINFO_SUB";
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcilePayinfoSubDto))
            return false;

        TfReconcilePayinfoSubDto bean = (TfReconcilePayinfoSubDto) obj;
    ...
    public Object clone()
    {
        TfReconcilePayinfoSubDto bean = new TfReconcilePayinfoSubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcilePayinfoSubDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field I_VOUSRLNO
      if (this.getIvousrlno()==null)
             sb.append("I_VOUSRLNO外键不能为空; ");
      
    //check field I_SEQNO
      if (this.getIseqno()==null)
             sb.append("I_SEQNO主键不能为空; ");
    ...
    //check field S_PAYAGENTBILLNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYAGENTBILLNO")) {
                 if (this.getSpayagentbillno()!=null)
                    if (this.getSpayagentbillno().getBytes().length > 42)
                        sb.append("S_PAYAGENTBILLNO 清算单号宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_PAYDETAILID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYDETAILID")) {
                 if (this.getSpaydetailid()!=null)
                    if (this.getSpaydetailid().getBytes().length > 38)
                        sb.append("S_PAYDETAILID 清算明细ID宽度不能超过 "+38+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfReconcilePayinfoSubPK pk = new TfReconcilePayinfoSubPK();
