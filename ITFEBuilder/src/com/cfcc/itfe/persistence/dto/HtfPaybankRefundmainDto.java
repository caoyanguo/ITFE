...
/**
 * <p>Title: DTO of table: HTF_PAYBANK_REFUNDMAIN</p>
...
public class HtfPaybankRefundmainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
...
*******************************************************/
    ...
    public String getSoriginalvoucherno()
    {
     ...
     /**
     *   Setter S_ORIGINALVOUCHERNO , NOT NULL        * */
    ...
    public String getSpaydictateno()
    {
     ...
     /**
     *   Setter S_PAYDICTATENO , NOT NULL        * */
    ...
    public String getSpayentrustdate()
    {
     ...
     /**
     *   Setter S_PAYENTRUSTDATE , NOT NULL        * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfPaybankRefundmainDto))
            return false;

        HtfPaybankRefundmainDto bean = (HtfPaybankRefundmainDto) obj;
    ...
    public Object clone()
    {
        HtfPaybankRefundmainDto bean = new HtfPaybankRefundmainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfPaybankRefundmainDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_ORIBILLNO
      if (this.getSoribillno()==null)
             sb.append("S_ORIBILLNO不能为空; ");
      if (this.getSoribillno()!=null)
             if (this.getSoribillno().getBytes().length > 42)
                sb.append("S_ORIBILLNO宽度不能超过 "+42+"个字符; ");
    ...
    //check field S_ORIGINALVOUCHERNO
      if (this.getSoriginalvoucherno()==null)
             sb.append("S_ORIGINALVOUCHERNO不能为空; ");
      if (this.getSoriginalvoucherno()!=null)
    ...
    //check field S_PAYENTRUSTDATE
      if (this.getSpayentrustdate()==null)
             sb.append("S_PAYENTRUSTDATE不能为空; ");
      if (this.getSpayentrustdate()!=null)
    ...
    //check field S_PAYDATE
      if (this.getSpaydate()==null)
             sb.append("S_PAYDATE不能为空; ");
      if (this.getSpaydate()!=null)
             if (this.getSpaydate().getBytes().length > 20)
                sb.append("S_PAYDATE宽度不能超过 "+20+"个字符; ");
    ...
    //check field S_ORIBILLNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ORIBILLNO")) {
               if (this.getSoribillno()==null)
                    sb.append("S_ORIBILLNO 不能为空; ");
               if (this.getSoribillno()!=null)
                    if (this.getSoribillno().getBytes().length > 42)
                        sb.append("S_ORIBILLNO 宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_ORIGINALVOUCHERNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ORIGINALVOUCHERNO")) {
               if (this.getSoriginalvoucherno()==null)
                    sb.append("S_ORIGINALVOUCHERNO 不能为空; ");
               if (this.getSoriginalvoucherno()!=null)
                    if (this.getSoriginalvoucherno().getBytes().length > 42)
    ...
    //check field S_PAYENTRUSTDATE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYENTRUSTDATE")) {
               if (this.getSpayentrustdate()==null)
                    sb.append("S_PAYENTRUSTDATE 不能为空; ");
               if (this.getSpayentrustdate()!=null)
                    if (this.getSpayentrustdate().getBytes().length > 8)
    ...
    //check field S_PAYDATE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYDATE")) {
               if (this.getSpaydate()==null)
                    sb.append("S_PAYDATE 不能为空; ");
               if (this.getSpaydate()!=null)
                    if (this.getSpaydate().getBytes().length > 20)
                        sb.append("S_PAYDATE 宽度不能超过 "+20+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfPaybankRefundmainPK pk = new HtfPaybankRefundmainPK();
