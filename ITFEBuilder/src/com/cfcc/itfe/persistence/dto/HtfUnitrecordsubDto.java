...
/**
 * <p>Title: DTO of table: HTF_UNITRECORDSUB</p>
...
public class HtfUnitrecordsubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    *  S_FUNDTYPENAME VARCHAR   , NOT NULL       */
    ...
    /**
    *  S_AGENCYACCONO VARCHAR   , NOT NULL       */
    protected String sagencyaccono;
    /**
    *  S_AGENCYACCONAME VARCHAR   , NOT NULL       */
    protected String sagencyacconame;
    /**
    *  S_AGENCYBANKNAME VARCHAR   , NOT NULL       */
    protected String sagencybankname;
    /**
    *  S_ACCSTATUS VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    public String getSagencyaccono()
    {
     ...
     /**
     *   Setter S_AGENCYACCONO , NOT NULL        * */
    ...
    public String getSagencyacconame()
    {
     ...
     /**
     *   Setter S_AGENCYACCONAME , NOT NULL        * */
    ...
    public String getSagencybankname()
    {
     ...
     /**
     *   Setter S_AGENCYBANKNAME , NOT NULL        * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfUnitrecordsubDto))
            return false;

        HtfUnitrecordsubDto bean = (HtfUnitrecordsubDto) obj;
    ...
    public Object clone()
    {
        HtfUnitrecordsubDto bean = new HtfUnitrecordsubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfUnitrecordsubDto").append(sep);
    ...
    //check field S_AGENCYACCONO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_AGENCYACCONO")) {
               if (this.getSagencyaccono()==null)
                    sb.append("S_AGENCYACCONO 不能为空; ");
               if (this.getSagencyaccono()!=null)
                    if (this.getSagencyaccono().getBytes().length > 60)
                        sb.append("S_AGENCYACCONO 宽度不能超过 "+60+"个字符");
             break;
         }
  }
    ...
    //check field S_AGENCYACCONAME
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_AGENCYACCONAME")) {
               if (this.getSagencyacconame()==null)
                    sb.append("S_AGENCYACCONAME 不能为空; ");
               if (this.getSagencyacconame()!=null)
                    if (this.getSagencyacconame().getBytes().length > 200)
                        sb.append("S_AGENCYACCONAME 宽度不能超过 "+200+"个字符");
             break;
         }
  }
    ...
    //check field S_AGENCYBANKNAME
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_AGENCYBANKNAME")) {
               if (this.getSagencybankname()==null)
                    sb.append("S_AGENCYBANKNAME 不能为空; ");
               if (this.getSagencybankname()!=null)
                    if (this.getSagencybankname().getBytes().length > 200)
                        sb.append("S_AGENCYBANKNAME 宽度不能超过 "+200+"个字符");
             break;
         }
  }
    ...
    //check field S_ACCSTATUS
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ACCSTATUS")) {
               if (this.getSaccstatus()==null)
                    sb.append("S_ACCSTATUS 不能为空; ");
               if (this.getSaccstatus()!=null)
                    if (this.getSaccstatus().getBytes().length > 5)
                        sb.append("S_ACCSTATUS 宽度不能超过 "+5+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfUnitrecordsubPK pk = new HtfUnitrecordsubPK();
