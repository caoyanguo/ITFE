...
import com.cfcc.itfe.persistence.pk.TfDirectpayAdjustsubPK;
/**
 * <p>Title: DTO of table: TF_DIRECTPAY_ADJUSTSUB</p>
 * <p>Description: 财政直接支付调整凭证5253子表 Data Transfer Object </p>
...
public class TfDirectpayAdjustsubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 支付明细ID S_ID VARCHAR   , NOT NULL       */
    ...
    /**
    * 财政直接支付凭证I S_VOUCHERBILLID VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    public String getSvoucherbillid()
    {
     ...
     /**
     *  财政直接支付凭证I Setter S_VOUCHERBILLID , NOT NULL        * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfDirectpayAdjustsubDto))
            return false;

        TfDirectpayAdjustsubDto bean = (TfDirectpayAdjustsubDto) obj;
    ...
    public Object clone()
    {
        TfDirectpayAdjustsubDto bean = new TfDirectpayAdjustsubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfDirectpayAdjustsubDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_VOUCHERBILLID
      if (this.getSvoucherbillid()==null)
             sb.append("S_VOUCHERBILLID财政直接支付凭证I不能为空; ");
      if (this.getSvoucherbillid()!=null)
             if (this.getSvoucherbillid().getBytes().length > 38)
                sb.append("S_VOUCHERBILLID财政直接支付凭证I宽度不能超过 "+38+"个字符; ");
    ...
    //check field S_VOUCHERBILLID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VOUCHERBILLID")) {
               if (this.getSvoucherbillid()==null)
                    sb.append("S_VOUCHERBILLID 财政直接支付凭证I不能为空; ");
               if (this.getSvoucherbillid()!=null)
                    if (this.getSvoucherbillid().getBytes().length > 38)
                        sb.append("S_VOUCHERBILLID 财政直接支付凭证I宽度不能超过 "+38+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfDirectpayAdjustsubPK pk = new TfDirectpayAdjustsubPK();
