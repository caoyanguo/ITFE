...
/**
 * <p>Title: DTO of table: HTF_GRANTPAY_ADJUSTSUB</p>
...
public class HtfGrantpayAdjustsubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    *  S_PAYSUMMARYNAME VARCHAR         */
    ...
    /**
    *  S_XDEALRESULT VARCHAR   , NOT NULL       */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfGrantpayAdjustsubDto))
            return false;

        HtfGrantpayAdjustsubDto bean = (HtfGrantpayAdjustsubDto) obj;
    ...
    public Object clone()
    {
        HtfGrantpayAdjustsubDto bean = new HtfGrantpayAdjustsubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfGrantpayAdjustsubDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_XDEALRESULT
      if (this.getSxdealresult()==null)
             sb.append("S_XDEALRESULT不能为空; ");
      if (this.getSxdealresult()!=null)
             if (this.getSxdealresult().getBytes().length > 10)
                sb.append("S_XDEALRESULT宽度不能超过 "+10+"个字符; ");
    ...
    //check field S_XDEALRESULT
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_XDEALRESULT")) {
               if (this.getSxdealresult()==null)
                    sb.append("S_XDEALRESULT 不能为空; ");
               if (this.getSxdealresult()!=null)
                    if (this.getSxdealresult().getBytes().length > 10)
                        sb.append("S_XDEALRESULT 宽度不能超过 "+10+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfGrantpayAdjustsubPK pk = new HtfGrantpayAdjustsubPK();
