...
import com.cfcc.itfe.persistence.pk.TfReconcileRealdialSubPK;
/**
 * <p>Title: DTO of table: TF_RECONCILE_REALDIAL_SUB</p>
 * <p>Description: 实拨信息对帐子表3508 Data Transfer Object </p>
...
public class TfReconcileRealdialSubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 资金性质名称 S_FUNDTYPENAME VARCHAR         */
    ...
    /**
    * 支付方式编码 S_PAYTYPECODE VARCHAR         */
    protected String spaytypecode;
    /**
    * 支付方式名称 S_PAYTYPENAME VARCHAR         */
    ...
    * 收款人银行 S_PAYEEACCTBANKNAME VARCHAR         */
    ...
    /**
    * 付款账户账号 S_PAYACCTNO VARCHAR         */
    protected String spayacctno;
    /**
    * 付款账户名称 S_PAYACCTNAME VARCHAR         */
    protected String spayacctname;
    /**
    * 付款账户银行 S_PAYACCTBANKNAME VARCHAR         */
    protected String spayacctbankname;
    /**
    * 预算单位编码 S_AGENCYCODE VARCHAR         */
    protected String sagencycode;
    /**
    * 预算单位名称 S_AGENCYNAME VARCHAR         */
    ...
    * 经济分类科目名称 S_EXPECONAME VARCHAR         */
    ...
    /**
    * 拨款金额 N_PAYAMT DECIMAL   , NOT NULL       */
...
*******************************************************/
    ...
    public String getSpayacctbankname()
    {
     ...
     /**
     *  付款账户银行 Setter S_PAYACCTBANKNAME        * */
...
*******************************************************/
    ...
    */
    public static String tableName(){
        return "TF_RECONCILE_REALDIAL_SUB";
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcileRealdialSubDto))
            return false;

        TfReconcileRealdialSubDto bean = (TfReconcileRealdialSubDto) obj;
    ...
    public Object clone()
    {
        TfReconcileRealdialSubDto bean = new TfReconcileRealdialSubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcileRealdialSubDto").append(sep);
    ...
    //check field S_PAYDETAILID
      if (this.getSpaydetailid()!=null)
             if (this.getSpaydetailid().getBytes().length > 38)
                sb.append("S_PAYDETAILID拨款明细ID宽度不能超过 "+38+"个字符; ");
    ...
    //check field S_PAYDETAILID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYDETAILID")) {
                 if (this.getSpaydetailid()!=null)
                    if (this.getSpaydetailid().getBytes().length > 38)
                        sb.append("S_PAYDETAILID 拨款明细ID宽度不能超过 "+38+"个字符");
             break;
         }
  }
    ...
    //check field S_PAYACCTNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYACCTNO")) {
                 if (this.getSpayacctno()!=null)
                    if (this.getSpayacctno().getBytes().length > 60)
                        sb.append("S_PAYACCTNO 付款账户账号宽度不能超过 "+60+"个字符");
             break;
         }
  }
    ...
    //check field S_PAYACCTNAME
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYACCTNAME")) {
                 if (this.getSpayacctname()!=null)
                    if (this.getSpayacctname().getBytes().length > 120)
                        sb.append("S_PAYACCTNAME 付款账户名称宽度不能超过 "+120+"个字符");
             break;
         }
  }
    ...
    //check field S_PAYACCTBANKNAME
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYACCTBANKNAME")) {
                 if (this.getSpayacctbankname()!=null)
                    if (this.getSpayacctbankname().getBytes().length > 60)
                        sb.append("S_PAYACCTBANKNAME 付款账户银行宽度不能超过 "+60+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfReconcileRealdialSubPK pk = new TfReconcileRealdialSubPK();
