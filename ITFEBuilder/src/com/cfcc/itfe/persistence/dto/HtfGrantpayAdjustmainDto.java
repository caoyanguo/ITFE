...
/**
 * <p>Title: DTO of table: HTF_GRANTPAY_ADJUSTMAIN</p>
...
public class HtfGrantpayAdjustmainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    *  N_PAYAMT DECIMAL   , NOT NULL       */
    ...
    /**
    *  S_PAYBANKCODE VARCHAR   , NOT NULL       */
    protected String spaybankcode;
    /**
    *  S_PAYBANKNAME VARCHAR   , NOT NULL       */
    protected String spaybankname;
    /**
    *  S_REMARK VARCHAR         */
    protected String sremark;
    /**
    *  S_XACCDATE VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    */
    public static String tableName(){
        return "HTF_GRANTPAY_ADJUSTMAIN";
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfGrantpayAdjustmainDto))
            return false;

        HtfGrantpayAdjustmainDto bean = (HtfGrantpayAdjustmainDto) obj;
    ...
    public Object clone()
    {
        HtfGrantpayAdjustmainDto bean = new HtfGrantpayAdjustmainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfGrantpayAdjustmainDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_XACCDATE
      if (this.getSxaccdate()==null)
             sb.append("S_XACCDATE不能为空; ");
      if (this.getSxaccdate()!=null)
             if (this.getSxaccdate().getBytes().length > 8)
                sb.append("S_XACCDATE宽度不能超过 "+8+"个字符; ");
    ...
    //check field S_XACCDATE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_XACCDATE")) {
               if (this.getSxaccdate()==null)
                    sb.append("S_XACCDATE 不能为空; ");
               if (this.getSxaccdate()!=null)
                    if (this.getSxaccdate().getBytes().length > 8)
                        sb.append("S_XACCDATE 宽度不能超过 "+8+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfGrantpayAdjustmainPK pk = new HtfGrantpayAdjustmainPK();
