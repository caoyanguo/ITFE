...
import com.cfcc.itfe.persistence.pk.TfReconcilePayquotaMainPK;
/**
 * <p>Title: DTO of table: TF_RECONCILE_PAYQUOTA_MAIN</p>
 * <p>Description: 清算额度对帐主表3510 Data Transfer Object </p>
...
public class TfReconcilePayquotaMainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 包流水号 S_PACKAGENO VARCHAR         */
    ...
    /**
    * 行政区划代码 S_ADMDIVCODE VARCHAR         */
    protected String sadmdivcode;
    /**
    * 业务年度 S_STYEAR VARCHAR         */
    protected String sstyear;
    /**
    * 凭证类型编号 S_VTCODE VARCHAR         */
    protected String svtcode;
    /**
    * 凭证日期 S_VOUDATE VARCHAR         */
    protected String svoudate;
    /**
    * 凭证号 S_VOUCHERNO VARCHAR         */
    protected String svoucherno;
    /**
    * 对账请求单号 S_VOUCHERCHECKNO VARCHAR         */
    protected String svouchercheckno;
    /**
    * 子包总数 S_CHILDPACKNUM VARCHAR         */
    protected String schildpacknum;
    /**
    * 本包序号 S_CURPACKNO VARCHAR         */
    ...
    * 清算账户名称 S_CLEARACCNANME VARCHAR         */
    ...
    /**
    * 对账起始日期 S_BEGINDATE VARCHAR         */
    protected String sbegindate;
    /**
    * 对账终止日期 S_ENDDATE VARCHAR         */
...
*******************************************************/
    ...
    public String getSvouchercheckno()
    {
     ...
     /**
     *  对账请求单号 Setter S_VOUCHERCHECKNO        * */
...
*******************************************************/
    ...
    *  凭证号 Getter S_VOUCHERNO       * */
    ...
    /**
    *  对账请求单号 Getter S_VOUCHERCHECKNO       * */
    ...
    */
    public static String tableName(){
        return "TF_RECONCILE_PAYQUOTA_MAIN";
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcilePayquotaMainDto))
            return false;

        TfReconcilePayquotaMainDto bean = (TfReconcilePayquotaMainDto) obj;
    ...
    public Object clone()
    {
        TfReconcilePayquotaMainDto bean = new TfReconcilePayquotaMainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcilePayquotaMainDto").append(sep);
    ...
    //check field S_VOUCHERCHECKNO
      if (this.getSvouchercheckno()!=null)
             if (this.getSvouchercheckno().getBytes().length > 42)
                sb.append("S_VOUCHERCHECKNO对账请求单号宽度不能超过 "+42+"个字符; ");
    ...
    //check field S_VOUCHERCHECKNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VOUCHERCHECKNO")) {
                 if (this.getSvouchercheckno()!=null)
                    if (this.getSvouchercheckno().getBytes().length > 42)
                        sb.append("S_VOUCHERCHECKNO 对账请求单号宽度不能超过 "+42+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfReconcilePayquotaMainPK pk = new TfReconcilePayquotaMainPK();
