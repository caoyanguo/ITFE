...
/**
 * <p>Title: DTO of table: TF_RECONCILE_REALDIAL_MAIN</p>
 * <p>Description: 实拨信息对帐主表3508-5508 Data Transfer Object </p>
...
public class TfReconcileRealdialMainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 人民银行名称 S_CLEARBANKNAME VARCHAR         */
    ...
    /**
    * 拨款账号 S_CLEARACCNO VARCHAR         */
    protected String sclearaccno;
    /**
    * 拨款账户名称 S_CLEARACCNANME VARCHAR         */
...
*******************************************************/
    ...
    */
    public static String tableName(){
        return "TF_RECONCILE_REALDIAL_MAIN";
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcileRealdialMainDto))
            return false;

        TfReconcileRealdialMainDto bean = (TfReconcileRealdialMainDto) obj;
    ...
    public Object clone()
    {
        TfReconcileRealdialMainDto bean = new TfReconcileRealdialMainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcileRealdialMainDto").append(sep);
    ...
    //check field S_HOLD1
      if (this.getShold1()!=null)
             if (this.getShold1().getBytes().length > 50)
                sb.append("S_HOLD1预留字段1宽度不能超过 "+50+"个字符; ");
    
    //check field S_HOLD2
      if (this.getShold2()!=null)
             if (this.getShold2().getBytes().length > 50)
                sb.append("S_HOLD2预留字段2宽度不能超过 "+50+"个字符; ");
    ...
    //check field S_CLEARACCNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_CLEARACCNO")) {
                 if (this.getSclearaccno()!=null)
                    if (this.getSclearaccno().getBytes().length > 42)
                        sb.append("S_CLEARACCNO 拨款账号宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_CLEARACCNANME
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_CLEARACCNANME")) {
                 if (this.getSclearaccnanme()!=null)
                    if (this.getSclearaccnanme().getBytes().length > 120)
                        sb.append("S_CLEARACCNANME 拨款账户名称宽度不能超过 "+120+"个字符");
             break;
         }
  }
    ...
    //check field S_HOLD1
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_HOLD1")) {
                 if (this.getShold1()!=null)
                    if (this.getShold1().getBytes().length > 50)
                        sb.append("S_HOLD1 预留字段1宽度不能超过 "+50+"个字符");
             break;
         }
  }
    ...
    //check field S_HOLD2
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_HOLD2")) {
                 if (this.getShold2()!=null)
                    if (this.getShold2().getBytes().length > 50)
                        sb.append("S_HOLD2 预留字段2宽度不能超过 "+50+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfReconcileRealdialMainPK pk = new TfReconcileRealdialMainPK();
