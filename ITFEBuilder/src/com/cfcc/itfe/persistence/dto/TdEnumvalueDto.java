...
/**
 * <p>Title: DTO of table: TD_ENUMVALUE</p>
 ...
 ********************************************************/
    ...
    *  S_VALUE VARCHAR , PK   , NOT NULL       */
    ...
    /**
    *  S_VALUECMT VARCHAR   , NOT NULL       */
    protected String svaluecmt;
    /**
...
*******************************************************/
    ...
    public String getSvaluecmt()
    {
        return svaluecmt;
    }
     /**
     *   Setter S_VALUECMT , NOT NULL        * */
    public void setSvaluecmt(String _svaluecmt) {
        this.svaluecmt = _svaluecmt;
    }
...
*******************************************************/
    ...
    *   Getter S_VALUE, PK , NOT NULL       * */
    ...
    /**
    *   Getter S_VALUECMT , NOT NULL       * */
    public static String  columnSvaluecmt()
    {
        return "S_VALUECMT";
    }
    ...
    */
    public static String[] columnNames(){
        ...
        columnNames[1]="S_VALUE";
        columnNames[2]="S_VALUECMT";
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TdEnumvalueDto))
            return false;

        TdEnumvalueDto bean = (TdEnumvalueDto) obj;
      ...
      //compare field svaluecmt
      if((this.svaluecmt==null && bean.svaluecmt!=null) || (this.svaluecmt!=null && bean.svaluecmt==null))
          return false;
        else if(this.svaluecmt==null && bean.svaluecmt==null){
        }
        else{
          if(!bean.svaluecmt.equals(this.svaluecmt))
               return false;
     }
	...
	public int hashCode()
	{
        ...
        if(this.svaluecmt!=null)
          _hash_ = _hash_ * 31+ this.svaluecmt.hashCode() ;
    ...
    public Object clone()
    {
        TdEnumvalueDto bean = new TdEnumvalueDto();

          bean.stypecode = this.stypecode;

          bean.svalue = this.svalue;

          if (this.svaluecmt != null)
            bean.svaluecmt = new String(this.svaluecmt);
          if (this.sifavailable != null)
    ...
    //check field S_VALUE
      ...
      if (this.getSvalue()!=null)
             if (this.getSvalue().getBytes().length > 30)
                sb.append("S_VALUE宽度不能超过 "+30+"个字符; ");
    
    //check field S_VALUECMT
      if (this.getSvaluecmt()==null)
             sb.append("S_VALUECMT不能为空; ");
      if (this.getSvaluecmt()!=null)
             if (this.getSvaluecmt().getBytes().length > 100)
                sb.append("S_VALUECMT宽度不能超过 "+100+"个字符; ");
   ...
   public String  checkValid(String[] _columnNames)
  {
    ...
    //check field S_VALUE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VALUE")) {
               ...
               if (this.getSvalue()!=null)
                    if (this.getSvalue().getBytes().length > 30)
                        sb.append("S_VALUE 宽度不能超过 "+30+"个字符");
             break;
         }
  }
    ...
    //check field S_VALUECMT
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VALUECMT")) {
               if (this.getSvaluecmt()==null)
                    sb.append("S_VALUECMT 不能为空; ");
               if (this.getSvaluecmt()!=null)
                    if (this.getSvaluecmt().getBytes().length > 100)
                        sb.append("S_VALUECMT 宽度不能超过 "+100+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TdEnumvaluePK pk = new TdEnumvaluePK();
      pk.setStypecode(getStypecode());
      pk.setSvalue(getSvalue());
      return pk;
    };
}
