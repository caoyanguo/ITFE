...
/**
 * <p>Title: DTO of table: TF_RECONCILE_REFUND_SUB</p>
 * <p>Description: 收入退付对帐子表3509 Data Transfer Object </p>
...
public class TfReconcileRefundSubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 预算单位名称 S_AGENCYNAME VARCHAR         */
    ...
    /**
    * 收入分类科目编码 S_INCOMESORTCODE VARCHAR         */
    protected String sincomesortcode;
    /**
    * 收入分类科目名称 S_INCOMESORTNAME VARCHAR         */
    protected String sincomesortname;
    /**
    * 退付金额 N_PAYAMT DECIMAL         */
...
*******************************************************/
    ...
    public String getSincomesortcode()
    {
     ...
     /**
     *  收入分类科目编码 Setter S_INCOMESORTCODE        * */
    ...
    public String getSincomesortname()
    {
     ...
     /**
     *  收入分类科目名称 Setter S_INCOMESORTNAME        * */
...
*******************************************************/
    ...
    *  预算单位名称 Getter S_AGENCYNAME       * */
    ...
    /**
    *  收入分类科目编码 Getter S_INCOMESORTCODE       * */
    ...
    /**
    *  收入分类科目名称 Getter S_INCOMESORTNAME       * */
    ...
    */
    public static String tableName(){
        return "TF_RECONCILE_REFUND_SUB";
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfReconcileRefundSubDto))
            return false;

        TfReconcileRefundSubDto bean = (TfReconcileRefundSubDto) obj;
    ...
    public Object clone()
    {
        TfReconcileRefundSubDto bean = new TfReconcileRefundSubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfReconcileRefundSubDto").append(sep);
    ...
    //check field S_PAYDETAILID
      if (this.getSpaydetailid()!=null)
             if (this.getSpaydetailid().getBytes().length > 38)
                sb.append("S_PAYDETAILID退付明细ID宽度不能超过 "+38+"个字符; ");
    ...
    //check field S_PAYDETAILID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_PAYDETAILID")) {
                 if (this.getSpaydetailid()!=null)
                    if (this.getSpaydetailid().getBytes().length > 38)
                        sb.append("S_PAYDETAILID 退付明细ID宽度不能超过 "+38+"个字符");
             break;
         }
  }
    ...
    //check field S_INCOMESORTCODE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_INCOMESORTCODE")) {
                 if (this.getSincomesortcode()!=null)
                    if (this.getSincomesortcode().getBytes().length > 42)
                        sb.append("S_INCOMESORTCODE 收入分类科目编码宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_INCOMESORTNAME
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_INCOMESORTNAME")) {
                 if (this.getSincomesortname()!=null)
                    if (this.getSincomesortname().getBytes().length > 60)
                        sb.append("S_INCOMESORTNAME 收入分类科目名称宽度不能超过 "+60+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfReconcileRefundSubPK pk = new TfReconcileRefundSubPK();
