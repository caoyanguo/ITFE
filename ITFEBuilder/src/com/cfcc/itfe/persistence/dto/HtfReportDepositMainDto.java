...
/**
 * <p>Title: DTO of table: HTF_REPORT_DEPOSIT_MAIN</p>
 * <p>Description: 库款账户对帐主表历史表3513 Data Transfer Object </p>
...
public class HtfReportDepositMainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 国库主体名称 S_TRENAME VARCHAR   , NOT NULL       */
    ...
    /**
    * 库款账号 S_ACCTNO VARCHAR   , NOT NULL       */
    protected String sacctno;
    /**
    * 库款账户名称 S_ACCTNAME VARCHAR   , NOT NULL       */
    protected String sacctname;
    /**
    ...
    * 总笔数 S_ALLNUM VARCHAR   , NOT NULL       */
    ...
    /**
    * 账面余额 N_ACCTAMT DECIMAL   , NOT NULL       */
    protected BigDecimal nacctamt;
    /**
...
*******************************************************/
    ...
    public String getSacctno()
    {
     ...
     /**
     *  库款账号 Setter S_ACCTNO , NOT NULL        * */
    public void setSacctno(String _sacctno) {
        this.sacctno = _sacctno;
    }


    public String getSacctname()
    {
        return sacctname;
    }
     /**
     *  库款账户名称 Setter S_ACCTNAME , NOT NULL        * */
    public void setSacctname(String _sacctname) {
        this.sacctname = _sacctname;
    }
    ...
    public BigDecimal getNacctamt()
    {
        return nacctamt;
    }
     /**
     *  账面余额 Setter N_ACCTAMT , NOT NULL        * */
    public void setNacctamt(BigDecimal _nacctamt) {
        this.nacctamt = _nacctamt;
    }
...
*******************************************************/
    ...
    */
    public static String tableName(){
        return "HTF_REPORT_DEPOSIT_MAIN";
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReportDepositMainDto))
            return false;

        HtfReportDepositMainDto bean = (HtfReportDepositMainDto) obj;
      ...
      //compare field sacctno
      if((this.sacctno==null && bean.sacctno!=null) || (this.sacctno!=null && bean.sacctno==null))
          return false;
        else if(this.sacctno==null && bean.sacctno==null){
        }
        else{
          if(!bean.sacctno.equals(this.sacctno))
               return false;
     }
      //compare field sacctname
      if((this.sacctname==null && bean.sacctname!=null) || (this.sacctname!=null && bean.sacctname==null))
          return false;
        else if(this.sacctname==null && bean.sacctname==null){
        }
        else{
          if(!bean.sacctname.equals(this.sacctname))
               return false;
     }
      ...
      //compare field nacctamt
      if((this.nacctamt==null && bean.nacctamt!=null) || (this.nacctamt!=null && bean.nacctamt==null))
          return false;
        else if(this.nacctamt==null && bean.nacctamt==null){
        }
        else{
          if(!bean.nacctamt.equals(this.nacctamt))
               return false;
     }
	...
	public int hashCode()
	{
        ...
        if(this.sacctno!=null)
          _hash_ = _hash_ * 31+ this.sacctno.hashCode() ;
        if(this.sacctname!=null)
          _hash_ = _hash_ * 31+ this.sacctname.hashCode() ;
        ...
        if(this.nacctamt!=null)
          _hash_ = _hash_ * 31+ this.nacctamt.hashCode() ;
    ...
    public Object clone()
    {
        HtfReportDepositMainDto bean = new HtfReportDepositMainDto();
          ...
          if (this.sacctno != null)
            bean.sacctno = new String(this.sacctno);
          if (this.sacctname != null)
            bean.sacctname = new String(this.sacctname);
          if (this.sbegindate != null)
          ...
          if (this.nacctamt != null)
            bean.nacctamt = new BigDecimal(this.nacctamt.toString());
          if (this.sxcheckresult != null)
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReportDepositMainDto").append(sep);
        ...
        sb.append("[sacctno]").append(" = ").append(sacctno).append(sep);
        sb.append("[sacctname]").append(" = ").append(sacctname).append(sep);
        ...
        sb.append("[nacctamt]").append(" = ").append(nacctamt).append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_ACCTNO
      if (this.getSacctno()==null)
             sb.append("S_ACCTNO库款账号不能为空; ");
      if (this.getSacctno()!=null)
             if (this.getSacctno().getBytes().length > 42)
                sb.append("S_ACCTNO库款账号宽度不能超过 "+42+"个字符; ");
    
    //check field S_ACCTNAME
      if (this.getSacctname()==null)
             sb.append("S_ACCTNAME库款账户名称不能为空; ");
      if (this.getSacctname()!=null)
             if (this.getSacctname().getBytes().length > 60)
                sb.append("S_ACCTNAME库款账户名称宽度不能超过 "+60+"个字符; ");
    ...
    //check field N_ACCTAMT
      if (this.getNacctamt()==null)
             sb.append("N_ACCTAMT账面余额不能为空; ");
   ...
   public String  checkValid(String[] _columnNames)
  {
    ...
    //check field S_ACCTNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ACCTNO")) {
               if (this.getSacctno()==null)
                    sb.append("S_ACCTNO 库款账号不能为空; ");
               if (this.getSacctno()!=null)
                    if (this.getSacctno().getBytes().length > 42)
                        sb.append("S_ACCTNO 库款账号宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_ACCTNAME
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ACCTNAME")) {
               if (this.getSacctname()==null)
                    sb.append("S_ACCTNAME 库款账户名称不能为空; ");
               if (this.getSacctname()!=null)
                    if (this.getSacctname().getBytes().length > 60)
                        sb.append("S_ACCTNAME 库款账户名称宽度不能超过 "+60+"个字符");
             break;
         }
  }
    ...
    //check field N_ACCTAMT
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("N_ACCTAMT")) {
               if (this.getNacctamt()==null)
                    sb.append("N_ACCTAMT 账面余额不能为空; ");
               break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfReportDepositMainPK pk = new HtfReportDepositMainPK();
