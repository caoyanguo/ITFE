...
import com.cfcc.itfe.persistence.pk.TfDirectpaymsgsubPK;
/**
 * <p>Title: DTO of table: TF_DIRECTPAYMSGSUB</p>
 * <p>Description: 财政直接支付凭证5201子表 Data Transfer Object </p>
...
public class TfDirectpaymsgsubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 支付明细ID S_ID VARCHAR   , NOT NULL       */
    ...
    /**
    * 财政直接支付凭证ID S_VOUCHERBILLID VARCHAR   , NOT NULL       */
    protected String svoucherbillid;
    /**
    * 财政直接支付凭证单号 S_VOUCHERBILLNO VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    public String getSvoucherbillid()
    {
     ...
     /**
     *  财政直接支付凭证ID Setter S_VOUCHERBILLID , NOT NULL        * */
    ...
    public String getSvoucherbillno()
    {
     ...
     /**
     *  财政直接支付凭证单号 Setter S_VOUCHERBILLNO , NOT NULL        * */
...
*******************************************************/
    ...
    *  支付明细ID Getter S_ID , NOT NULL       * */
    ...
    /**
    *  财政直接支付凭证ID Getter S_VOUCHERBILLID , NOT NULL       * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfDirectpaymsgsubDto))
            return false;

        TfDirectpaymsgsubDto bean = (TfDirectpaymsgsubDto) obj;
    ...
    public Object clone()
    {
        TfDirectpaymsgsubDto bean = new TfDirectpaymsgsubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfDirectpaymsgsubDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_VOUCHERBILLID
      if (this.getSvoucherbillid()==null)
             sb.append("S_VOUCHERBILLID财政直接支付凭证ID不能为空; ");
      if (this.getSvoucherbillid()!=null)
             if (this.getSvoucherbillid().getBytes().length > 38)
                sb.append("S_VOUCHERBILLID财政直接支付凭证ID宽度不能超过 "+38+"个字符; ");
    
    //check field S_VOUCHERBILLNO
      if (this.getSvoucherbillno()==null)
             sb.append("S_VOUCHERBILLNO财政直接支付凭证单号不能为空; ");
      if (this.getSvoucherbillno()!=null)
             if (this.getSvoucherbillno().getBytes().length > 42)
                sb.append("S_VOUCHERBILLNO财政直接支付凭证单号宽度不能超过 "+42+"个字符; ");
    ...
    //check field S_XADDWORD
      if (this.getSxaddword()!=null)
             if (this.getSxaddword().getBytes().length > 42)
                sb.append("S_XADDWORD附言宽度不能超过 "+42+"个字符; ");
    ...
    //check field S_VOUCHERBILLID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VOUCHERBILLID")) {
               if (this.getSvoucherbillid()==null)
                    sb.append("S_VOUCHERBILLID 财政直接支付凭证ID不能为空; ");
               if (this.getSvoucherbillid()!=null)
                    if (this.getSvoucherbillid().getBytes().length > 38)
                        sb.append("S_VOUCHERBILLID 财政直接支付凭证ID宽度不能超过 "+38+"个字符");
             break;
         }
  }
    ...
    //check field S_VOUCHERBILLNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_VOUCHERBILLNO")) {
               if (this.getSvoucherbillno()==null)
                    sb.append("S_VOUCHERBILLNO 财政直接支付凭证单号不能为空; ");
               if (this.getSvoucherbillno()!=null)
                    if (this.getSvoucherbillno().getBytes().length > 42)
                        sb.append("S_VOUCHERBILLNO 财政直接支付凭证单号宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_XADDWORD
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_XADDWORD")) {
                 if (this.getSxaddword()!=null)
                    if (this.getSxaddword().getBytes().length > 42)
                        sb.append("S_XADDWORD 附言宽度不能超过 "+42+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfDirectpaymsgsubPK pk = new TfDirectpaymsgsubPK();
