...
/**
 * <p>Title: DTO of table: HTF_PAYMENT_DETAILSSUB</p>
...
public class HtfPaymentDetailssubDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    *  S_REMARK VARCHAR         */
    ...
    /**
    *  S_XPAYDATE VARCHAR   , NOT NULL       */
    protected String sxpaydate;
    /**
    *  S_XAGENTBUSINESSNO VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    public String getSxagentbusinessno()
    {
     ...
     /**
     *   Setter S_XAGENTBUSINESSNO , NOT NULL        * */
...
*******************************************************/
    ...
    *   Getter S_XPAYDATE , NOT NULL       * */
    ...
    /**
    *   Getter S_XAGENTBUSINESSNO , NOT NULL       * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfPaymentDetailssubDto))
            return false;

        HtfPaymentDetailssubDto bean = (HtfPaymentDetailssubDto) obj;
    ...
    public Object clone()
    {
        HtfPaymentDetailssubDto bean = new HtfPaymentDetailssubDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfPaymentDetailssubDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_ORIVOUCHERNO
      if (this.getSorivoucherno()!=null)
             if (this.getSorivoucherno().getBytes().length > 42)
                sb.append("S_ORIVOUCHERNO宽度不能超过 "+42+"个字符; ");
    ...
    //check field S_XAGENTBUSINESSNO
      if (this.getSxagentbusinessno()==null)
             sb.append("S_XAGENTBUSINESSNO不能为空; ");
      if (this.getSxagentbusinessno()!=null)
    ...
    //check field S_ORIVOUCHERNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ORIVOUCHERNO")) {
                 if (this.getSorivoucherno()!=null)
                    if (this.getSorivoucherno().getBytes().length > 42)
                        sb.append("S_ORIVOUCHERNO 宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_XAGENTBUSINESSNO
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_XAGENTBUSINESSNO")) {
               if (this.getSxagentbusinessno()==null)
                    sb.append("S_XAGENTBUSINESSNO 不能为空; ");
               if (this.getSxagentbusinessno()!=null)
                    if (this.getSxagentbusinessno().getBytes().length > 42)
    ...
    //check field S_XADDWORDCODE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_XADDWORDCODE")) {
                 if (this.getSxaddwordcode()!=null)
                    if (this.getSxaddwordcode().getBytes().length > 10)
                        sb.append("S_XADDWORDCODE 宽度不能超过 "+10+"个字符");
             break;
         }
  }
    ...
    //check field S_XADDWORD
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_XADDWORD")) {
                 if (this.getSxaddword()!=null)
                    if (this.getSxaddword().getBytes().length > 255)
                        sb.append("S_XADDWORD 宽度不能超过 "+255+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfPaymentDetailssubPK pk = new HtfPaymentDetailssubPK();
