...
/**
 * <p>Title: DTO of table: HTF_REPORT_INCOME_MAIN</p>
 * <p>Description: 收入报表对帐主表历史表3511 Data Transfer Object </p>
...
public class HtfReportIncomeMainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 本包序号 S_CURPACKNO VARCHAR   , NOT NULL       */
    ...
    /**
    * 资金性质 S_FUNDTYPECODE VARCHAR   , NOT NULL       */
    protected String sfundtypecode;
    /**
    * 辖属标志 S_BELONGFLAG VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    public String getSfundtypecode()
    {
     ...
     /**
     *  资金性质 Setter S_FUNDTYPECODE , NOT NULL        * */
    ...
    public String getSbelongflag()
    {
     ...
     /**
     *  辖属标志 Setter S_BELONGFLAG , NOT NULL        * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof HtfReportIncomeMainDto))
            return false;

        HtfReportIncomeMainDto bean = (HtfReportIncomeMainDto) obj;
    ...
    public Object clone()
    {
        HtfReportIncomeMainDto bean = new HtfReportIncomeMainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("HtfReportIncomeMainDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_FUNDTYPECODE
      if (this.getSfundtypecode()==null)
             sb.append("S_FUNDTYPECODE资金性质不能为空; ");
      if (this.getSfundtypecode()!=null)
             if (this.getSfundtypecode().getBytes().length > 42)
                sb.append("S_FUNDTYPECODE资金性质宽度不能超过 "+42+"个字符; ");
    
    //check field S_BELONGFLAG
      if (this.getSbelongflag()==null)
             sb.append("S_BELONGFLAG辖属标志不能为空; ");
      if (this.getSbelongflag()!=null)
             if (this.getSbelongflag().getBytes().length > 1)
                sb.append("S_BELONGFLAG辖属标志宽度不能超过 "+1+"个字符; ");
    ...
    //check field S_FUNDTYPECODE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_FUNDTYPECODE")) {
               if (this.getSfundtypecode()==null)
                    sb.append("S_FUNDTYPECODE 资金性质不能为空; ");
               if (this.getSfundtypecode()!=null)
                    if (this.getSfundtypecode().getBytes().length > 42)
                        sb.append("S_FUNDTYPECODE 资金性质宽度不能超过 "+42+"个字符");
             break;
         }
  }
    ...
    //check field S_BELONGFLAG
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_BELONGFLAG")) {
               if (this.getSbelongflag()==null)
                    sb.append("S_BELONGFLAG 辖属标志不能为空; ");
               if (this.getSbelongflag()!=null)
                    if (this.getSbelongflag().getBytes().length > 1)
                        sb.append("S_BELONGFLAG 辖属标志宽度不能超过 "+1+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      HtfReportIncomeMainPK pk = new HtfReportIncomeMainPK();
