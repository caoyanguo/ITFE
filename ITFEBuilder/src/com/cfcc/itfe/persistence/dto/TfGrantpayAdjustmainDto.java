...
/**
 * <p>Title: DTO of table: TF_GRANTPAY_ADJUSTMAIN</p>
 * <p>Description: 财政授权支付调整凭证5351主表 Data Transfer Object </p>
...
public class TfGrantpayAdjustmainDto   
                              implements IDto  {
/********************************************************
 *   fields
 ********************************************************/
    ...
    * 资金性质名称 S_FUNDTYPENAME VARCHAR   , NOT NULL       */
    ...
    /**
    * 汇总调整金额 N_PAYAMT DECIMAL   , NOT NULL       */
    ...
    * 摘要 S_REMARK VARCHAR         */
    ...
    /**
    * 处理日期 S_XACCDATE VARCHAR   , NOT NULL       */
...
*******************************************************/
    ...
    public BigDecimal getNpayamt()
    {
     ...
     /**
     *  汇总调整金额 Setter N_PAYAMT , NOT NULL        * */
    ...
    public String getSxaccdate()
    {
     ...
     /**
     *  处理日期 Setter S_XACCDATE , NOT NULL        * */
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TfGrantpayAdjustmainDto))
            return false;

        TfGrantpayAdjustmainDto bean = (TfGrantpayAdjustmainDto) obj;
    ...
    public Object clone()
    {
        TfGrantpayAdjustmainDto bean = new TfGrantpayAdjustmainDto();
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TfGrantpayAdjustmainDto").append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_ID
      if (this.getSid()==null)
             sb.append("S_ID申请单ID不能为空; ");
      if (this.getSid()!=null)
             if (this.getSid().getBytes().length > 38)
                sb.append("S_ID申请单ID宽度不能超过 "+38+"个字符; ");
    ...
    //check field S_REMARK
      if (this.getSremark()!=null)
             if (this.getSremark().getBytes().length > 200)
                sb.append("S_REMARK摘要宽度不能超过 "+200+"个字符; ");
    
    //check field S_XACCDATE
      if (this.getSxaccdate()==null)
             sb.append("S_XACCDATE处理日期不能为空; ");
      if (this.getSxaccdate()!=null)
             if (this.getSxaccdate().getBytes().length > 8)
                sb.append("S_XACCDATE处理日期宽度不能超过 "+8+"个字符; ");
    ...
    //check field S_ID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ID")) {
               if (this.getSid()==null)
                    sb.append("S_ID 申请单ID不能为空; ");
               if (this.getSid()!=null)
                    if (this.getSid().getBytes().length > 38)
                        sb.append("S_ID 申请单ID宽度不能超过 "+38+"个字符");
             break;
         }
  }
    ...
    //check field S_REMARK
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_REMARK")) {
                 if (this.getSremark()!=null)
                    if (this.getSremark().getBytes().length > 200)
                        sb.append("S_REMARK 摘要宽度不能超过 "+200+"个字符");
             break;
         }
  }
    ...
    //check field S_XACCDATE
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_XACCDATE")) {
               if (this.getSxaccdate()==null)
                    sb.append("S_XACCDATE 处理日期不能为空; ");
               if (this.getSxaccdate()!=null)
                    if (this.getSxaccdate().getBytes().length > 8)
                        sb.append("S_XACCDATE 处理日期宽度不能超过 "+8+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TfGrantpayAdjustmainPK pk = new TfGrantpayAdjustmainPK();
