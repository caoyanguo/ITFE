...
import com.cfcc.itfe.persistence.pk.TsUserstampPK;
/**
 * <p>Title: DTO of table: TS_USERSTAMP</p>
 ...
 ********************************************************/
    ...
    *  S_STAMPID VARCHAR         */
    ...
    /**
    *  S_ISVALID CHARACTER   , NOT NULL       */
    protected String sisvalid;
    /**
    *  I_MODICOUNT INTEGER         */
...
*******************************************************/
    ...
    public String getSisvalid()
    {
     ...
     /**
     *   Setter S_ISVALID , NOT NULL        * */
    public void setSisvalid(String _sisvalid) {
        this.sisvalid = _sisvalid;
    }
...
*****************************************************/
    ...
    public boolean equals(Object obj)
    {
        ...
        if (obj == null || !(obj instanceof TsUserstampDto))
            return false;

        TsUserstampDto bean = (TsUserstampDto) obj;
      ...
      //compare field sisvalid
      if((this.sisvalid==null && bean.sisvalid!=null) || (this.sisvalid!=null && bean.sisvalid==null))
          return false;
        else if(this.sisvalid==null && bean.sisvalid==null){
        }
        else{
          if(!bean.sisvalid.equals(this.sisvalid))
               return false;
     }
	...
	public int hashCode()
	{
        ...
        if(this.sisvalid!=null)
          _hash_ = _hash_ * 31+ this.sisvalid.hashCode() ;
    ...
    public Object clone()
    {
        TsUserstampDto bean = new TsUserstampDto();
          ...
          if (this.sisvalid != null)
            bean.sisvalid = new String(this.sisvalid);
          if (this.imodicount != null)
   ...
   /* Returns a string representation of the object. */
    public String toString()
    {
        ...
        sb.append("TsUserstampDto").append(sep);
        ...
        sb.append("[sisvalid]").append(" = ").append(sisvalid).append(sep);
   ...
   public String  checkValid()
  {
    ...
    //check field S_STAMPID
      if (this.getSstampid()!=null)
             if (this.getSstampid().getBytes().length > 30)
                sb.append("S_STAMPID宽度不能超过 "+30+"个字符; ");
    
    //check field S_ISVALID
      if (this.getSisvalid()==null)
             sb.append("S_ISVALID不能为空; ");
      if (this.getSisvalid()!=null)
             if (this.getSisvalid().getBytes().length > 1)
                sb.append("S_ISVALID宽度不能超过 "+1+"个字符; ");
   ...
   public String  checkValid(String[] _columnNames)
  {
    ...
    //check field S_STAMPID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_STAMPID")) {
                 if (this.getSstampid()!=null)
                    if (this.getSstampid().getBytes().length > 30)
                        sb.append("S_STAMPID 宽度不能超过 "+30+"个字符");
             break;
         }
  }
    ...
    //check field S_ISVALID
     for (int i = 0; i < _columnNames.length; i++) {
        if (((String) _columnNames[i]).equals("S_ISVALID")) {
               if (this.getSisvalid()==null)
                    sb.append("S_ISVALID 不能为空; ");
               if (this.getSisvalid()!=null)
                    if (this.getSisvalid().getBytes().length > 1)
                        sb.append("S_ISVALID 宽度不能超过 "+1+"个字符");
             break;
         }
  }
...
*****************************************************/
  ...
  /* return the IPK class  */
    public IPK      getPK(){
      TsUserstampPK pk = new TsUserstampPK();
