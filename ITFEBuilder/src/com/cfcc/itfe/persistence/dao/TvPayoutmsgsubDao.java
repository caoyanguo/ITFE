...
/**
 * <p>Title: DAO of table: TV_PAYOUTMSGSUB</p>
...
public class TvPayoutmsgsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_PAYOUTMSGSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_PAYOUTMSGSUB.S_BIZNO, TV_PAYOUTMSGSUB.S_SEQNO, TV_PAYOUTMSGSUB.S_ACCDATE, TV_PAYOUTMSGSUB.S_ECNOMICSUBJECTCODE, TV_PAYOUTMSGSUB.S_BUDGETPRJCODE, "
        + "TV_PAYOUTMSGSUB.N_MONEY, TV_PAYOUTMSGSUB.S_FUNSUBJECTCODE, TV_PAYOUTMSGSUB.TS_SYSUPDATE, TV_PAYOUTMSGSUB.S_TAXTICKETNO, TV_PAYOUTMSGSUB.S_BGTTYPECODE, "
        + "TV_PAYOUTMSGSUB.S_BGTTYPENAME, TV_PAYOUTMSGSUB.S_PROCATCODE, TV_PAYOUTMSGSUB.S_PROCATNAME, TV_PAYOUTMSGSUB.S_AGENCYCODE, TV_PAYOUTMSGSUB.S_AGENCYNAME, "
        + "TV_PAYOUTMSGSUB.S_EXPFUNCNAME, TV_PAYOUTMSGSUB.S_EXPFUNCCODE1, TV_PAYOUTMSGSUB.S_EXPFUNCNAME1, TV_PAYOUTMSGSUB.S_EXPFUNCCODE2, TV_PAYOUTMSGSUB.S_EXPFUNCNAME2, "
        + "TV_PAYOUTMSGSUB.S_EXPFUNCCODE3, TV_PAYOUTMSGSUB.S_EXPFUNCNAME3, TV_PAYOUTMSGSUB.S_EXPECOCODE, TV_PAYOUTMSGSUB.S_EXPECONAME, TV_PAYOUTMSGSUB.S_EXPECOCODE1, "
        + "TV_PAYOUTMSGSUB.S_EXPECONAME1, TV_PAYOUTMSGSUB.S_EXPECOCODE2, TV_PAYOUTMSGSUB.S_EXPECONAME2, TV_PAYOUTMSGSUB.S_HOLD1, TV_PAYOUTMSGSUB.S_HOLD2, "
        + "TV_PAYOUTMSGSUB.S_HOLD3, TV_PAYOUTMSGSUB.S_HOLD4, TV_PAYOUTMSGSUB.S_PAYEEACCTNO, TV_PAYOUTMSGSUB.S_PAYEEACCTNAME, TV_PAYOUTMSGSUB.S_PAYEEACCTBANKNAME, "
        + "TV_PAYOUTMSGSUB.S_PAYSUMMARYCODE, TV_PAYOUTMSGSUB.S_PAYSUMMARYNAME, TV_PAYOUTMSGSUB.S_XPAYAMT, TV_PAYOUTMSGSUB.S_XPAYDATE, TV_PAYOUTMSGSUB.S_XAGENTBUSINESSNO, "
        + "TV_PAYOUTMSGSUB.S_ID, TV_PAYOUTMSGSUB.S_XADDWORD "
        + "FROM TV_PAYOUTMSGSUB "
        +" WHERE " 
        + "S_BIZNO = ? AND S_SEQNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        ...
        + "S_XPAYAMT =?,S_XPAYDATE =?,S_XAGENTBUSINESSNO =?,S_ID =?,S_XADDWORD =? "
        + "WHERE "
        + "S_BIZNO = ? AND S_SEQNO = ?"
        ;
  ...
  {
     TvPayoutmsgsubDto dto = (TvPayoutmsgsubDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(40, dto.getSid());

          ps.setString(41, dto.getSxaddword());
   ...
   */
	...
	*/
    ...
    {
        TvPayoutmsgsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvPayoutmsgsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvPayoutmsgsubPK pk = (TvPayoutmsgsubPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TvPayoutmsgsubDto[] dtos = new TvPayoutmsgsubDto[0];
		    dtos = (TvPayoutmsgsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvPayoutmsgsubDto  dto = new  TvPayoutmsgsubDto ();
             //S_BIZNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                        		throw new SQLException("数据库表：TV_PAYOUTMSGSUB没有检查修改的字段");
    }
