...
import com.cfcc.itfe.persistence.dto.HtfReportDefraySubDto ;
import com.cfcc.itfe.persistence.pk.HtfReportDefraySubPK ;


/**
 * <p>Title: DAO of table: HTF_REPORT_DEFRAY_SUB</p>
 * <p>Description:支出报表对帐子表历史表3512 Data Access Object  </p>
...
public class HtfReportDefraySubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_REPORT_DEFRAY_SUB ("
          + "I_VOUSRLNO,I_SEQNO,S_ID,S_EXPFUNCCODE,S_EXPFUNCNAME"
          + ",N_CURPAYAMT,N_SUMPAYAMT,S_XCHECKRESULT,S_XCHECKREASON,S_HOLD1"
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_REPORT_DEFRAY_SUB.I_VOUSRLNO, HTF_REPORT_DEFRAY_SUB.I_SEQNO, HTF_REPORT_DEFRAY_SUB.S_ID, HTF_REPORT_DEFRAY_SUB.S_EXPFUNCCODE, HTF_REPORT_DEFRAY_SUB.S_EXPFUNCNAME, "
        + "HTF_REPORT_DEFRAY_SUB.N_CURPAYAMT, HTF_REPORT_DEFRAY_SUB.N_SUMPAYAMT, HTF_REPORT_DEFRAY_SUB.S_XCHECKRESULT, HTF_REPORT_DEFRAY_SUB.S_XCHECKREASON, HTF_REPORT_DEFRAY_SUB.S_HOLD1, "
        + "HTF_REPORT_DEFRAY_SUB.S_HOLD2, HTF_REPORT_DEFRAY_SUB.S_HOLD3, HTF_REPORT_DEFRAY_SUB.S_HOLD4, HTF_REPORT_DEFRAY_SUB.S_EXT1, HTF_REPORT_DEFRAY_SUB.S_EXT2, "
        + "HTF_REPORT_DEFRAY_SUB.S_EXT3, HTF_REPORT_DEFRAY_SUB.S_EXT4, HTF_REPORT_DEFRAY_SUB.S_EXT5 "
        + "FROM HTF_REPORT_DEFRAY_SUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTF_REPORT_DEFRAY_SUB SET "
        + "S_ID =?,S_EXPFUNCCODE =?,S_EXPFUNCNAME =?,N_CURPAYAMT =?,N_SUMPAYAMT =?, "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_REPORT_DEFRAY_SUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_SEQNO = ?"
        ;
  ...
  {
     HtfReportDefraySubDto dto = (HtfReportDefraySubDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(4, dto.getSexpfunccode());

          ps.setString(5, dto.getSexpfuncname());

          ps.setBigDecimal(6, dto.getNcurpayamt());

          ps.setBigDecimal(7, dto.getNsumpayamt());

          ps.setString(8, dto.getSxcheckresult());

          ps.setString(9, dto.getSxcheckreason());

          ps.setString(10, dto.getShold1());

          ps.setString(11, dto.getShold2());

          ps.setString(12, dto.getShold3());

          ps.setString(13, dto.getShold4());
          ...
          ps.setString(17, dto.getSext4());

          ps.setString(18, dto.getSext5());
   ...
   */
	...
	*/
    ...
    {
        HtfReportDefraySubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfReportDefraySubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfReportDefraySubPK pk = (HtfReportDefraySubPK)_pk ;
    ...
    {
        HtfReportDefraySubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfReportDefraySubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfReportDefraySubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfReportDefraySubDto[] dtos = new HtfReportDefraySubDto[0];
		    dtos = (HtfReportDefraySubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfReportDefraySubDto  dto = new  HtfReportDefraySubDto ();
             //I_VOUSRLNO
             ...
             //N_CURPAYAMT
           dto.setNcurpayamt(rs.getBigDecimal("N_CURPAYAMT"));

             //N_SUMPAYAMT
           dto.setNsumpayamt(rs.getBigDecimal("N_SUMPAYAMT"));
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            //N_CURPAYAMT
            ps.setBigDecimal(pos, dto.getNcurpayamt());
            pos++;

            //N_SUMPAYAMT
            ps.setBigDecimal(pos, dto.getNsumpayamt());
            pos++;
    ...
    */
    ...
    {
                                                		throw new SQLException("数据库表：HTF_REPORT_DEFRAY_SUB没有检查修改的字段");
    }
