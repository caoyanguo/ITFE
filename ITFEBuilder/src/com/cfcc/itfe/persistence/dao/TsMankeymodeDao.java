...
/**
 * <p>Title: DAO of table: TS_MANKEYMODE</p>
...
public class TsMankeymodeDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TS_MANKEYMODE ("
          + "S_KEYMODE"
        + ") VALUES ("
        + "?)";
  ...
  {
     TsMankeymodeDto dto = (TsMankeymodeDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ps.setString(1, dto.getSkeymode());
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TsMankeymodePK pk = (TsMankeymodePK)_pk ;

       PreparedStatement ps = null;
       ResultSet rs = null;
       try {
           ps = conn.prepareStatement(SQL_SELECT);
           ps.setString(1, pk.getSkeymode());
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TsMankeymodePK)(pks.get(i)) ; 
                   ps.setString((i-iBegin)*1+1, pk.getSkeymode());
        ...
        if (results!=null && results.size() > 0)
        {
            TsMankeymodeDto[] dtos = new TsMankeymodeDto[0];
		    dtos = (TsMankeymodeDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TsMankeymodeDto  dto = new  TsMankeymodeDto ();
             //S_KEYMODE
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
		throw new SQLException("数据库表：TS_MANKEYMODE没有检查修改的字段");
    }
