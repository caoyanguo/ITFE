...
/**
 * <p>Title: DAO of table: TV_PAYOUTMSGMAIN_SX</p>
...
public class TvPayoutmsgmainSxDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_PAYOUTMSGMAIN_SX ("
          ...
          + ",S_INPUTUSERCODE,S_CHECKSERCODE,S_INPUTRECBANKNAME,S_CHECKSTATUS"
        + ") VALUES ("
        + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,CURRENT TIMESTAMP ,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_PAYOUTMSGMAIN_SX.S_BIZNO, TV_PAYOUTMSGMAIN_SX.S_ORGCODE, TV_PAYOUTMSGMAIN_SX.S_COMMITDATE, TV_PAYOUTMSGMAIN_SX.S_ACCDATE, TV_PAYOUTMSGMAIN_SX.S_FILENAME, "
        + "TV_PAYOUTMSGMAIN_SX.S_TRECODE, TV_PAYOUTMSGMAIN_SX.S_PACKAGENO, TV_PAYOUTMSGMAIN_SX.S_PAYUNIT, TV_PAYOUTMSGMAIN_SX.S_PAYEEBANKNO, TV_PAYOUTMSGMAIN_SX.S_DEALNO, "
        + "TV_PAYOUTMSGMAIN_SX.S_TAXTICKETNO, TV_PAYOUTMSGMAIN_SX.S_GENTICKETDATE, TV_PAYOUTMSGMAIN_SX.S_PAYERACCT, TV_PAYOUTMSGMAIN_SX.S_PAYERNAME, TV_PAYOUTMSGMAIN_SX.S_PAYERADDR, "
        + "TV_PAYOUTMSGMAIN_SX.N_MONEY, TV_PAYOUTMSGMAIN_SX.S_RECBANKNO, TV_PAYOUTMSGMAIN_SX.S_RECACCT, TV_PAYOUTMSGMAIN_SX.S_RECNAME, TV_PAYOUTMSGMAIN_SX.S_TRIMFLAG, "
        + "TV_PAYOUTMSGMAIN_SX.S_BUDGETUNITCODE, TV_PAYOUTMSGMAIN_SX.S_UNITCODENAME, TV_PAYOUTMSGMAIN_SX.S_OFYEAR, TV_PAYOUTMSGMAIN_SX.S_BUDGETTYPE, TV_PAYOUTMSGMAIN_SX.S_STATUS, "
        + "TV_PAYOUTMSGMAIN_SX.S_USERCODE, TV_PAYOUTMSGMAIN_SX.S_ADDWORD, TV_PAYOUTMSGMAIN_SX.S_ORIVOUNO, TV_PAYOUTMSGMAIN_SX.S_ORIVOUDATE, TV_PAYOUTMSGMAIN_SX.S_BACKFLAG, "
        + "TV_PAYOUTMSGMAIN_SX.S_DEMO, TV_PAYOUTMSGMAIN_SX.TS_SYSUPDATE, TV_PAYOUTMSGMAIN_SX.S_ID, TV_PAYOUTMSGMAIN_SX.S_RECBANKNAME, TV_PAYOUTMSGMAIN_SX.S_PAYERBANKNAME, "
        + "TV_PAYOUTMSGMAIN_SX.S_FUNDTYPECODE, TV_PAYOUTMSGMAIN_SX.S_FUNDTYPENAME, TV_PAYOUTMSGMAIN_SX.S_PAYTYPECODE, TV_PAYOUTMSGMAIN_SX.S_PAYTYPENAME, TV_PAYOUTMSGMAIN_SX.S_CLEARBANKCODE, "
        + "TV_PAYOUTMSGMAIN_SX.S_CLEARBANKNAME, TV_PAYOUTMSGMAIN_SX.S_PAYSUMMARYCODE, TV_PAYOUTMSGMAIN_SX.S_PAYSUMMARYNAME, TV_PAYOUTMSGMAIN_SX.S_XAGENTBUSINESSNO, TV_PAYOUTMSGMAIN_SX.S_XPAYAMT, "
        + "TV_PAYOUTMSGMAIN_SX.S_XPAYDATE, TV_PAYOUTMSGMAIN_SX.S_IFMATCH, TV_PAYOUTMSGMAIN_SX.S_HOLD1, TV_PAYOUTMSGMAIN_SX.S_HOLD2, TV_PAYOUTMSGMAIN_SX.S_INPUTRECBANKNO, "
        + "TV_PAYOUTMSGMAIN_SX.S_INPUTUSERCODE, TV_PAYOUTMSGMAIN_SX.S_CHECKSERCODE, TV_PAYOUTMSGMAIN_SX.S_INPUTRECBANKNAME, TV_PAYOUTMSGMAIN_SX.S_CHECKSTATUS "
        + "FROM TV_PAYOUTMSGMAIN_SX "
        +" WHERE " 
        + "S_BIZNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_PAYOUTMSGMAIN_SX SET "
        ...
        + "S_CHECKSERCODE =?,S_INPUTRECBANKNAME =?,S_CHECKSTATUS =? "
        + "WHERE "
        + "S_BIZNO = ?"
        ;
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_PAYOUTMSGMAIN_SX " 
        + " WHERE "
        + "S_BIZNO = ?"
        ;
  ...
  {
     TvPayoutmsgmainSxDto dto = (TvPayoutmsgmainSxDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvPayoutmsgmainSxDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvPayoutmsgmainSxDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvPayoutmsgmainSxPK pk = (TvPayoutmsgmainSxPK)_pk ;
    ...
    {
        TvPayoutmsgmainSxPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvPayoutmsgmainSxPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvPayoutmsgmainSxPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TvPayoutmsgmainSxDto[] dtos = new TvPayoutmsgmainSxDto[0];
		    dtos = (TvPayoutmsgmainSxDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvPayoutmsgmainSxDto  dto = new  TvPayoutmsgmainSxDto ();
             //S_BIZNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                                               		throw new SQLException("数据库表：TV_PAYOUTMSGMAIN_SX没有检查修改的字段");
    }
