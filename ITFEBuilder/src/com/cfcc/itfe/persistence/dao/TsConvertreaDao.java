...
/**
 * <p>Title: DAO of table: TS_CONVERTREA</p>
...
public class TsConvertreaDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TS_CONVERTREA ("
          + "S_ORGCODE,S_TRECODE,S_TCBSTREA"
        + ") VALUES ("
        + "?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TS_CONVERTREA.S_ORGCODE, TS_CONVERTREA.S_TRECODE, TS_CONVERTREA.S_TCBSTREA "
        + "FROM TS_CONVERTREA "
        +" WHERE " 
  ...
  {
     TsConvertreaDto dto = (TsConvertreaDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(3, dto.getStcbstrea());
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TsConvertreaPK pk = (TsConvertreaPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TsConvertreaDto[] dtos = new TsConvertreaDto[0];
		    dtos = (TsConvertreaDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TsConvertreaDto  dto = new  TsConvertreaDto ();
             //S_ORGCODE
             ...
             //S_TCBSTREA
             str = rs.getString("S_TCBSTREA");
             if (str == null)
                dto.setStcbstrea(null);
             else
                dto.setStcbstrea(str.trim());
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            int pos = 1;
            //S_TCBSTREA
            ps.setString(pos, dto.getStcbstrea());
            pos++;
    ...
    */
    ...
    {
   		throw new SQLException("数据库表：TS_CONVERTREA没有检查修改的字段");
    }
