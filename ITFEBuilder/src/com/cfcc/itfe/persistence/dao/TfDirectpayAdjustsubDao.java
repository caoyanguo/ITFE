...
/**
 * <p>Title: DAO of table: TF_DIRECTPAY_ADJUSTSUB</p>
...
public class TfDirectpayAdjustsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TF_DIRECTPAY_ADJUSTSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TF_DIRECTPAY_ADJUSTSUB.I_VOUSRLNO, TF_DIRECTPAY_ADJUSTSUB.I_SEQNO, TF_DIRECTPAY_ADJUSTSUB.S_ID, TF_DIRECTPAY_ADJUSTSUB.S_VOUCHERBILLID, TF_DIRECTPAY_ADJUSTSUB.S_VOUCHERBILLNO, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_VOUCHERNO, TF_DIRECTPAY_ADJUSTSUB.S_FUNDTYPECODE, TF_DIRECTPAY_ADJUSTSUB.S_FUNDTYPENAME, TF_DIRECTPAY_ADJUSTSUB.S_BGTTYPECODE, TF_DIRECTPAY_ADJUSTSUB.S_BGTTYPENAME, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_PROCATCODE, TF_DIRECTPAY_ADJUSTSUB.S_PROCATNAME, TF_DIRECTPAY_ADJUSTSUB.S_PAYKINDCODE, TF_DIRECTPAY_ADJUSTSUB.S_PAYKINDNAME, TF_DIRECTPAY_ADJUSTSUB.S_MOFDEPCODE, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_MOFDEPNAME, TF_DIRECTPAY_ADJUSTSUB.S_FILENOCODE, TF_DIRECTPAY_ADJUSTSUB.S_FILENONAME, TF_DIRECTPAY_ADJUSTSUB.S_SUPDEPCODE, TF_DIRECTPAY_ADJUSTSUB.S_SUPDEPNAME, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_AGENCYCODE, TF_DIRECTPAY_ADJUSTSUB.S_AGENCYNAME, TF_DIRECTPAY_ADJUSTSUB.S_EXPFUNCCODE, TF_DIRECTPAY_ADJUSTSUB.S_EXPFUNCNAME, TF_DIRECTPAY_ADJUSTSUB.S_EXPECOCODE, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_EXPECONAME, TF_DIRECTPAY_ADJUSTSUB.S_DEPPROCODE, TF_DIRECTPAY_ADJUSTSUB.S_DEPPRONAME, TF_DIRECTPAY_ADJUSTSUB.S_PAYEEACCTNO, TF_DIRECTPAY_ADJUSTSUB.S_PAYEEACCTNAME, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_PAYEEACCTBANKNAME, TF_DIRECTPAY_ADJUSTSUB.S_PAYEEACCTBANKNO, TF_DIRECTPAY_ADJUSTSUB.N_PAYAMT, TF_DIRECTPAY_ADJUSTSUB.S_REMARK, TF_DIRECTPAY_ADJUSTSUB.S_XPAYDATE, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_XAGENTBUSINESSNO, TF_DIRECTPAY_ADJUSTSUB.S_XCHECKNO, TF_DIRECTPAY_ADJUSTSUB.N_XPAYAMT, TF_DIRECTPAY_ADJUSTSUB.S_XPAYEEACCTBANKNAME, TF_DIRECTPAY_ADJUSTSUB.S_XPAYEEACCTNO, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_XPAYEEACCTNAME, TF_DIRECTPAY_ADJUSTSUB.S_XADDWORD, TF_DIRECTPAY_ADJUSTSUB.S_HOLD1, TF_DIRECTPAY_ADJUSTSUB.S_HOLD2, TF_DIRECTPAY_ADJUSTSUB.S_HOLD3, "
        + "TF_DIRECTPAY_ADJUSTSUB.S_HOLD4, TF_DIRECTPAY_ADJUSTSUB.S_EXT1, TF_DIRECTPAY_ADJUSTSUB.S_EXT2, TF_DIRECTPAY_ADJUSTSUB.S_EXT3 "
        + "FROM TF_DIRECTPAY_ADJUSTSUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TF_DIRECTPAY_ADJUSTSUB SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TF_DIRECTPAY_ADJUSTSUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_SEQNO = ?"
        ;
  ...
  {
     TfDirectpayAdjustsubDto dto = (TfDirectpayAdjustsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TfDirectpayAdjustsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TfDirectpayAdjustsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TfDirectpayAdjustsubPK pk = (TfDirectpayAdjustsubPK)_pk ;
    ...
    {
        TfDirectpayAdjustsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TfDirectpayAdjustsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TfDirectpayAdjustsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TfDirectpayAdjustsubDto[] dtos = new TfDirectpayAdjustsubDto[0];
		    dtos = (TfDirectpayAdjustsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TfDirectpayAdjustsubDto  dto = new  TfDirectpayAdjustsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                             		throw new SQLException("数据库表：TF_DIRECTPAY_ADJUSTSUB没有检查修改的字段");
    }
