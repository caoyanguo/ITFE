...
/**
 * <p>Title: DAO of table: TV_PAYOUT_DETAIL_MAIN</p>
...
public class TvPayoutDetailMainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_PAYOUT_DETAIL_MAIN ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_PAYOUT_DETAIL_MAIN.S_ID, TV_PAYOUT_DETAIL_MAIN.S_ADMDIVCODE, TV_PAYOUT_DETAIL_MAIN.S_STYEAR, TV_PAYOUT_DETAIL_MAIN.S_VTCODE, TV_PAYOUT_DETAIL_MAIN.S_VOUDATE, "
        + "TV_PAYOUT_DETAIL_MAIN.S_VOUCHERNO, TV_PAYOUT_DETAIL_MAIN.S_TRECODE, TV_PAYOUT_DETAIL_MAIN.S_FINORGCODE, TV_PAYOUT_DETAIL_MAIN.N_PAYAMT, TV_PAYOUT_DETAIL_MAIN.S_PRINTUSER, "
        + "TV_PAYOUT_DETAIL_MAIN.S_REMARK, TV_PAYOUT_DETAIL_MAIN.S_HOLD1, TV_PAYOUT_DETAIL_MAIN.S_HOLD2 "
        + "FROM TV_PAYOUT_DETAIL_MAIN "
        +" WHERE " 
        + "S_ID = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_PAYOUT_DETAIL_MAIN SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_PAYOUT_DETAIL_MAIN " 
        + " WHERE "
        + "S_ID = ?"
        ;
  ...
  {
     TvPayoutDetailMainDto dto = (TvPayoutDetailMainDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvPayoutDetailMainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvPayoutDetailMainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvPayoutDetailMainPK pk = (TvPayoutDetailMainPK)_pk ;
    ...
    {
        TvPayoutDetailMainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvPayoutDetailMainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvPayoutDetailMainPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TvPayoutDetailMainDto[] dtos = new TvPayoutDetailMainDto[0];
		    dtos = (TvPayoutDetailMainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvPayoutDetailMainDto  dto = new  TvPayoutDetailMainDto ();
             //S_ID
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                    		throw new SQLException("数据库表：TV_PAYOUT_DETAIL_MAIN没有检查修改的字段");
    }
