...
/**
 * <p>Title: DAO of table: TV_DIRECTPAYMSGMAIN</p>
...
public class TvDirectpaymsgmainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_DIRECTPAYMSGMAIN ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_DIRECTPAYMSGMAIN.I_VOUSRLNO, TV_DIRECTPAYMSGMAIN.S_ORGCODE, TV_DIRECTPAYMSGMAIN.S_COMMITDATE, TV_DIRECTPAYMSGMAIN.S_ACCDATE, TV_DIRECTPAYMSGMAIN.S_FILENAME, "
        + "TV_DIRECTPAYMSGMAIN.S_PACKAGENO, TV_DIRECTPAYMSGMAIN.S_TRECODE, TV_DIRECTPAYMSGMAIN.S_PAYUNIT, TV_DIRECTPAYMSGMAIN.S_TRANSBANKCODE, TV_DIRECTPAYMSGMAIN.S_DEALNO, "
        + "TV_DIRECTPAYMSGMAIN.N_MONEY, TV_DIRECTPAYMSGMAIN.S_TAXTICKETNO, TV_DIRECTPAYMSGMAIN.S_PACKAGETICKETNO, TV_DIRECTPAYMSGMAIN.S_GENTICKETDATE, TV_DIRECTPAYMSGMAIN.S_BUDGETTYPE, "
        + "TV_DIRECTPAYMSGMAIN.S_OFYEAR, TV_DIRECTPAYMSGMAIN.S_TRANSACTUNIT, TV_DIRECTPAYMSGMAIN.S_AMTTYPE, TV_DIRECTPAYMSGMAIN.S_STATUS, TV_DIRECTPAYMSGMAIN.S_USERCODE, "
        + "TV_DIRECTPAYMSGMAIN.S_DEMO, TV_DIRECTPAYMSGMAIN.TS_SYSUPDATE, TV_DIRECTPAYMSGMAIN.S_ID, TV_DIRECTPAYMSGMAIN.S_FUNDTYPECODE, TV_DIRECTPAYMSGMAIN.S_FUNDTYPENAME, "
        + "TV_DIRECTPAYMSGMAIN.S_PAYEEACCTNO, TV_DIRECTPAYMSGMAIN.S_PAYEEACCTNAME, TV_DIRECTPAYMSGMAIN.S_PAYEEACCTBANKNAME, TV_DIRECTPAYMSGMAIN.S_PAYACCTNO, TV_DIRECTPAYMSGMAIN.S_PAYACCTNAME, "
        + "TV_DIRECTPAYMSGMAIN.S_PAYACCTBANKNAME, TV_DIRECTPAYMSGMAIN.S_PAYBANKCODE, TV_DIRECTPAYMSGMAIN.S_PAYBANKNAME, TV_DIRECTPAYMSGMAIN.S_PAYBANKNO, TV_DIRECTPAYMSGMAIN.S_XACCTDATE, "
        + "TV_DIRECTPAYMSGMAIN.S_HOLD1, TV_DIRECTPAYMSGMAIN.S_HOLD2, TV_DIRECTPAYMSGMAIN.S_PAYVOUCHERNO, TV_DIRECTPAYMSGMAIN.N_XALLAMT "
        + "FROM TV_DIRECTPAYMSGMAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_DIRECTPAYMSGMAIN SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_DIRECTPAYMSGMAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     TvDirectpaymsgmainDto dto = (TvDirectpaymsgmainDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvDirectpaymsgmainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvDirectpaymsgmainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvDirectpaymsgmainPK pk = (TvDirectpaymsgmainPK)_pk ;
    ...
    {
        TvDirectpaymsgmainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvDirectpaymsgmainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvDirectpaymsgmainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TvDirectpaymsgmainDto[] dtos = new TvDirectpaymsgmainDto[0];
		    dtos = (TvDirectpaymsgmainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvDirectpaymsgmainDto  dto = new  TvDirectpaymsgmainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                  		throw new SQLException("数据库表：TV_DIRECTPAYMSGMAIN没有检查修改的字段");
    }
