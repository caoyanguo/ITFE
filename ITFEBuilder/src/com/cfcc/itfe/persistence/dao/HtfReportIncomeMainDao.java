...
import com.cfcc.itfe.persistence.dto.HtfReportIncomeMainDto ;
import com.cfcc.itfe.persistence.pk.HtfReportIncomeMainPK ;


/**
 * <p>Title: DAO of table: HTF_REPORT_INCOME_MAIN</p>
 * <p>Description:收入报表对帐主表历史表3511 Data Access Object  </p>
...
public class HtfReportIncomeMainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_REPORT_INCOME_MAIN ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_REPORT_INCOME_MAIN.I_VOUSRLNO, HTF_REPORT_INCOME_MAIN.S_ORGCODE, HTF_REPORT_INCOME_MAIN.S_TRECODE, HTF_REPORT_INCOME_MAIN.S_STATUS, HTF_REPORT_INCOME_MAIN.S_DEMO, "
        + "HTF_REPORT_INCOME_MAIN.TS_SYSUPDATE, HTF_REPORT_INCOME_MAIN.S_PACKAGENO, HTF_REPORT_INCOME_MAIN.S_ADMDIVCODE, HTF_REPORT_INCOME_MAIN.S_STYEAR, HTF_REPORT_INCOME_MAIN.S_VTCODE, "
        + "HTF_REPORT_INCOME_MAIN.S_VOUDATE, HTF_REPORT_INCOME_MAIN.S_VOUCHERNO, HTF_REPORT_INCOME_MAIN.S_VOUCHERCHECKNO, HTF_REPORT_INCOME_MAIN.S_CHILDPACKNUM, HTF_REPORT_INCOME_MAIN.S_CURPACKNO, "
        + "HTF_REPORT_INCOME_MAIN.S_FUNDTYPECODE, HTF_REPORT_INCOME_MAIN.S_BELONGFLAG, HTF_REPORT_INCOME_MAIN.S_BUDGETLEVELCODE, HTF_REPORT_INCOME_MAIN.S_BILLKIND, HTF_REPORT_INCOME_MAIN.S_FINORGCODE, "
        + "HTF_REPORT_INCOME_MAIN.S_TRENAME, HTF_REPORT_INCOME_MAIN.S_BEGINDATE, HTF_REPORT_INCOME_MAIN.S_ENDDATE, HTF_REPORT_INCOME_MAIN.S_ALLNUM, HTF_REPORT_INCOME_MAIN.N_ALLAMT, "
        + "HTF_REPORT_INCOME_MAIN.S_XCHECKRESULT, HTF_REPORT_INCOME_MAIN.S_XDIFFNUM, HTF_REPORT_INCOME_MAIN.S_HOLD1, HTF_REPORT_INCOME_MAIN.S_HOLD2, HTF_REPORT_INCOME_MAIN.S_EXT1, "
        + "HTF_REPORT_INCOME_MAIN.S_EXT2, HTF_REPORT_INCOME_MAIN.S_EXT3, HTF_REPORT_INCOME_MAIN.S_EXT4, HTF_REPORT_INCOME_MAIN.S_EXT5 "
        + "FROM HTF_REPORT_INCOME_MAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTF_REPORT_INCOME_MAIN SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_REPORT_INCOME_MAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     HtfReportIncomeMainDto dto = (HtfReportIncomeMainDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtfReportIncomeMainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfReportIncomeMainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfReportIncomeMainPK pk = (HtfReportIncomeMainPK)_pk ;
    ...
    {
        HtfReportIncomeMainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfReportIncomeMainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfReportIncomeMainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfReportIncomeMainDto[] dtos = new HtfReportIncomeMainDto[0];
		    dtos = (HtfReportIncomeMainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfReportIncomeMainDto  dto = new  HtfReportIncomeMainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                   		throw new SQLException("数据库表：HTF_REPORT_INCOME_MAIN没有检查修改的字段");
    }
