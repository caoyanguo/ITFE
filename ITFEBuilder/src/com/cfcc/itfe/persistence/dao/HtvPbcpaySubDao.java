...
import com.cfcc.itfe.persistence.pk.HtvPbcpaySubPK ;


/**
 * <p>Title: DAO of table: HTV_PBCPAY_SUB</p>
...
public class HtvPbcpaySubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_PBCPAY_SUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_PBCPAY_SUB.I_VOUSRLNO, HTV_PBCPAY_SUB.I_SEQNO, HTV_PBCPAY_SUB.S_BDGORGCODE, HTV_PBCPAY_SUB.S_FUNCSBTCODE, HTV_PBCPAY_SUB.S_ECOSBTCODE, "
        + "HTV_PBCPAY_SUB.C_ACCTPROP, HTV_PBCPAY_SUB.F_AMT, HTV_PBCPAY_SUB.TS_SYSUPDATE "
        + "FROM HTV_PBCPAY_SUB "
        +" WHERE " 
  ...
  {
     HtvPbcpaySubDto dto = (HtvPbcpaySubDto)_dto ;
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvPbcpaySubPK pk = (HtvPbcpaySubPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            HtvPbcpaySubDto[] dtos = new HtvPbcpaySubDto[0];
		    dtos = (HtvPbcpaySubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvPbcpaySubDto  dto = new  HtvPbcpaySubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                  		throw new SQLException("数据库表：HTV_PBCPAY_SUB没有检查修改的字段");
    }
