...
/**
 * <p>Title: DAO of table: TV_GRANTPAYMSGSUB_SX</p>
...
public class TvGrantpaymsgsubSxDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_GRANTPAYMSGSUB_SX ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_GRANTPAYMSGSUB_SX.I_VOUSRLNO, TV_GRANTPAYMSGSUB_SX.I_DETAILSEQNO, TV_GRANTPAYMSGSUB_SX.S_ORGCODE, TV_GRANTPAYMSGSUB_SX.S_FILENAME, TV_GRANTPAYMSGSUB_SX.S_LIMITID, "
        + "TV_GRANTPAYMSGSUB_SX.S_OFYEAR, TV_GRANTPAYMSGSUB_SX.S_LINE, TV_GRANTPAYMSGSUB_SX.S_PACKAGENO, TV_GRANTPAYMSGSUB_SX.S_DEALNO, TV_GRANTPAYMSGSUB_SX.S_PACKAGETICKETNO, "
        + "TV_GRANTPAYMSGSUB_SX.S_BUDGETUNITCODE, TV_GRANTPAYMSGSUB_SX.S_BUDGETTYPE, TV_GRANTPAYMSGSUB_SX.S_FUNSUBJECTCODE, TV_GRANTPAYMSGSUB_SX.S_ECOSUBJECTCODE, TV_GRANTPAYMSGSUB_SX.N_MONEY, "
        + "TV_GRANTPAYMSGSUB_SX.S_ACCATTRIB, TV_GRANTPAYMSGSUB_SX.S_ACCDATE, TV_GRANTPAYMSGSUB_SX.S_STATUS, TV_GRANTPAYMSGSUB_SX.S_USERCODE, TV_GRANTPAYMSGSUB_SX.TS_SYSUPDATE, "
        + "TV_GRANTPAYMSGSUB_SX.S_DEMO, TV_GRANTPAYMSGSUB_SX.S_SUPDEPNAME, TV_GRANTPAYMSGSUB_SX.S_EXPFUNCNAME, TV_GRANTPAYMSGSUB_SX.S_EXPFUNCCODE1, TV_GRANTPAYMSGSUB_SX.S_EXPFUNCNAME1, "
        + "TV_GRANTPAYMSGSUB_SX.S_EXPFUNCCODE2, TV_GRANTPAYMSGSUB_SX.S_EXPFUNCNAME2, TV_GRANTPAYMSGSUB_SX.S_EXPFUNCCODE3, TV_GRANTPAYMSGSUB_SX.S_EXPFUNCNAME3, TV_GRANTPAYMSGSUB_SX.S_PROCATCODE, "
        + "TV_GRANTPAYMSGSUB_SX.S_PROCATNAME, TV_GRANTPAYMSGSUB_SX.S_HOLD1, TV_GRANTPAYMSGSUB_SX.S_HOLD2, TV_GRANTPAYMSGSUB_SX.S_HOLD3, TV_GRANTPAYMSGSUB_SX.S_HOLD4 "
        + "FROM TV_GRANTPAYMSGSUB_SX "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_GRANTPAYMSGSUB_SX SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_GRANTPAYMSGSUB_SX " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_DETAILSEQNO = ? AND S_PACKAGETICKETNO = ?"
        ;
  ...
  {
     TvGrantpaymsgsubSxDto dto = (TvGrantpaymsgsubSxDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvGrantpaymsgsubSxDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvGrantpaymsgsubSxDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvGrantpaymsgsubSxPK pk = (TvGrantpaymsgsubSxPK)_pk ;
    ...
    {
        TvGrantpaymsgsubSxPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvGrantpaymsgsubSxPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvGrantpaymsgsubSxPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TvGrantpaymsgsubSxDto[] dtos = new TvGrantpaymsgsubSxDto[0];
		    dtos = (TvGrantpaymsgsubSxDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvGrantpaymsgsubSxDto  dto = new  TvGrantpaymsgsubSxDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                		throw new SQLException("数据库表：TV_GRANTPAYMSGSUB_SX没有检查修改的字段");
    }
