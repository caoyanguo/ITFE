...
/**
 * <p>Title: DAO of table: TF_GRANTPAYMSGSUB</p>
 * <p>Description:财政授权支付凭证明细信息（8202）明细 Data Access Object  </p>
...
public class TfGrantpaymsgsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TF_GRANTPAYMSGSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TF_GRANTPAYMSGSUB.I_VOUSRLNO, TF_GRANTPAYMSGSUB.I_SEQNO, TF_GRANTPAYMSGSUB.S_ID, TF_GRANTPAYMSGSUB.S_VOUCHERBILLID, TF_GRANTPAYMSGSUB.S_VOUCHERBILLNO, "
        + "TF_GRANTPAYMSGSUB.S_VOUCHERNO, TF_GRANTPAYMSGSUB.S_FUNDTYPECODE, TF_GRANTPAYMSGSUB.S_FUNDTYPENAME, TF_GRANTPAYMSGSUB.S_BGTTYPECODE, TF_GRANTPAYMSGSUB.S_BGTTYPENAME, "
        + "TF_GRANTPAYMSGSUB.S_PROCATCODE, TF_GRANTPAYMSGSUB.S_PROCATNAME, TF_GRANTPAYMSGSUB.S_PAYKINDCODE, TF_GRANTPAYMSGSUB.S_PAYKINDNAME, TF_GRANTPAYMSGSUB.S_FILENOCODE, "
        + "TF_GRANTPAYMSGSUB.S_FILENONAME, TF_GRANTPAYMSGSUB.S_SUPDEPCODE, TF_GRANTPAYMSGSUB.S_SUPDEPNAME, TF_GRANTPAYMSGSUB.S_AGENCYCODE, TF_GRANTPAYMSGSUB.S_AGENCYNAME, "
        + "TF_GRANTPAYMSGSUB.S_EXPFUNCCODE, TF_GRANTPAYMSGSUB.S_EXPFUNCNAME, TF_GRANTPAYMSGSUB.S_EXPECOCODE, TF_GRANTPAYMSGSUB.S_EXPECONAME, TF_GRANTPAYMSGSUB.S_DEPPROCODE, "
        + "TF_GRANTPAYMSGSUB.S_DEPPRONAME, TF_GRANTPAYMSGSUB.S_PAYEEACCTNO, TF_GRANTPAYMSGSUB.S_PAYEEACCTNAME, TF_GRANTPAYMSGSUB.S_PAYEEACCTBANKNAME, TF_GRANTPAYMSGSUB.S_PAYEEACCTBANKNO, "
        + "TF_GRANTPAYMSGSUB.N_PAYAMT, TF_GRANTPAYMSGSUB.S_XPAYDATE, TF_GRANTPAYMSGSUB.S_XAGENTBUSINESSNO, TF_GRANTPAYMSGSUB.S_XCHECKNO, TF_GRANTPAYMSGSUB.N_XPAYAMT, "
        + "TF_GRANTPAYMSGSUB.S_XPAYEEACCTBANKNAME, TF_GRANTPAYMSGSUB.S_XPAYEEACCTNO, TF_GRANTPAYMSGSUB.S_XPAYEEACCTNAME, TF_GRANTPAYMSGSUB.S_REMARK, TF_GRANTPAYMSGSUB.S_HOLD1, "
        + "TF_GRANTPAYMSGSUB.S_HOLD2, TF_GRANTPAYMSGSUB.S_HOLD3, TF_GRANTPAYMSGSUB.S_HOLD4, TF_GRANTPAYMSGSUB.S_EXT1, TF_GRANTPAYMSGSUB.S_EXT2, "
        + "TF_GRANTPAYMSGSUB.S_EXT3 "
        + "FROM TF_GRANTPAYMSGSUB "
        +" WHERE " 
  ...
  {
     TfGrantpaymsgsubDto dto = (TfGrantpaymsgsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TfGrantpaymsgsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TfGrantpaymsgsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TfGrantpaymsgsubPK pk = (TfGrantpaymsgsubPK)_pk ;
    ...
    {
        TfGrantpaymsgsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TfGrantpaymsgsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TfGrantpaymsgsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TfGrantpaymsgsubDto[] dtos = new TfGrantpaymsgsubDto[0];
		    dtos = (TfGrantpaymsgsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TfGrantpaymsgsubDto  dto = new  TfGrantpaymsgsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                    		throw new SQLException("数据库表：TF_GRANTPAYMSGSUB没有检查修改的字段");
    }
