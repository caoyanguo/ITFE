...
/**
 * <p>Title: DAO of table: HTV_PAYOUTMSGMAIN</p>
...
public class HtvPayoutmsgmainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_PAYOUTMSGMAIN ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_PAYOUTMSGMAIN.S_BIZNO, HTV_PAYOUTMSGMAIN.S_ORGCODE, HTV_PAYOUTMSGMAIN.S_COMMITDATE, HTV_PAYOUTMSGMAIN.S_ACCDATE, HTV_PAYOUTMSGMAIN.S_FILENAME, "
        + "HTV_PAYOUTMSGMAIN.S_TRECODE, HTV_PAYOUTMSGMAIN.S_PACKAGENO, HTV_PAYOUTMSGMAIN.S_PAYUNIT, HTV_PAYOUTMSGMAIN.S_PAYEEBANKNO, HTV_PAYOUTMSGMAIN.S_DEALNO, "
        + "HTV_PAYOUTMSGMAIN.S_TAXTICKETNO, HTV_PAYOUTMSGMAIN.S_GENTICKETDATE, HTV_PAYOUTMSGMAIN.S_PAYERACCT, HTV_PAYOUTMSGMAIN.S_PAYERNAME, HTV_PAYOUTMSGMAIN.S_PAYERADDR, "
        + "HTV_PAYOUTMSGMAIN.N_MONEY, HTV_PAYOUTMSGMAIN.S_RECBANKNO, HTV_PAYOUTMSGMAIN.S_RECACCT, HTV_PAYOUTMSGMAIN.S_RECNAME, HTV_PAYOUTMSGMAIN.S_TRIMFLAG, "
        + "HTV_PAYOUTMSGMAIN.S_BUDGETUNITCODE, HTV_PAYOUTMSGMAIN.S_UNITCODENAME, HTV_PAYOUTMSGMAIN.S_OFYEAR, HTV_PAYOUTMSGMAIN.S_BUDGETTYPE, HTV_PAYOUTMSGMAIN.S_STATUS, "
        + "HTV_PAYOUTMSGMAIN.S_USERCODE, HTV_PAYOUTMSGMAIN.S_ADDWORD, HTV_PAYOUTMSGMAIN.S_ORIVOUNO, HTV_PAYOUTMSGMAIN.S_ORIVOUDATE, HTV_PAYOUTMSGMAIN.S_BACKFLAG, "
        + "HTV_PAYOUTMSGMAIN.S_DEMO, HTV_PAYOUTMSGMAIN.TS_SYSUPDATE, HTV_PAYOUTMSGMAIN.S_ID, HTV_PAYOUTMSGMAIN.S_RECBANKNAME, HTV_PAYOUTMSGMAIN.S_PAYERBANKNAME, "
        + "HTV_PAYOUTMSGMAIN.S_FUNDTYPECODE, HTV_PAYOUTMSGMAIN.S_FUNDTYPENAME, HTV_PAYOUTMSGMAIN.S_PAYTYPECODE, HTV_PAYOUTMSGMAIN.S_PAYTYPENAME, HTV_PAYOUTMSGMAIN.S_CLEARBANKCODE, "
        + "HTV_PAYOUTMSGMAIN.S_CLEARBANKNAME, HTV_PAYOUTMSGMAIN.S_PAYSUMMARYCODE, HTV_PAYOUTMSGMAIN.S_PAYSUMMARYNAME, HTV_PAYOUTMSGMAIN.S_XAGENTBUSINESSNO, HTV_PAYOUTMSGMAIN.S_XPAYAMT, "
        + "HTV_PAYOUTMSGMAIN.S_XPAYDATE, HTV_PAYOUTMSGMAIN.S_IFMATCH, HTV_PAYOUTMSGMAIN.S_HOLD1, HTV_PAYOUTMSGMAIN.S_HOLD2, HTV_PAYOUTMSGMAIN.S_INPUTRECBANKNO, "
        + "HTV_PAYOUTMSGMAIN.S_INPUTUSERCODE, HTV_PAYOUTMSGMAIN.S_CHECKSERCODE, HTV_PAYOUTMSGMAIN.S_INPUTRECBANKNAME, HTV_PAYOUTMSGMAIN.S_CHECKSTATUS, HTV_PAYOUTMSGMAIN.S_BUSINESSTYPECODE, "
        + "HTV_PAYOUTMSGMAIN.S_BUSINESSTYPENAME "
        + "FROM HTV_PAYOUTMSGMAIN "
        +" WHERE " 
        + "S_BIZNO = ?"
        ;
  ...
  {
     HtvPayoutmsgmainDto dto = (HtvPayoutmsgmainDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtvPayoutmsgmainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvPayoutmsgmainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvPayoutmsgmainPK pk = (HtvPayoutmsgmainPK)_pk ;
    ...
    {
        HtvPayoutmsgmainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtvPayoutmsgmainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtvPayoutmsgmainPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            HtvPayoutmsgmainDto[] dtos = new HtvPayoutmsgmainDto[0];
		    dtos = (HtvPayoutmsgmainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvPayoutmsgmainDto  dto = new  HtvPayoutmsgmainDto ();
             //S_BIZNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                                                     		throw new SQLException("数据库表：HTV_PAYOUTMSGMAIN没有检查修改的字段");
    }
