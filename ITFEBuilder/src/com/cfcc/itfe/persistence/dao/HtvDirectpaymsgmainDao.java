...
/**
 * <p>Title: DAO of table: HTV_DIRECTPAYMSGMAIN</p>
...
public class HtvDirectpaymsgmainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_DIRECTPAYMSGMAIN ("
          ...
          + ",S_HOLD1,S_HOLD2,S_PAYVOUCHERNO,N_XALLAMT"
        + ") VALUES ("
        + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,CURRENT TIMESTAMP ,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_DIRECTPAYMSGMAIN.I_VOUSRLNO, HTV_DIRECTPAYMSGMAIN.S_ORGCODE, HTV_DIRECTPAYMSGMAIN.S_COMMITDATE, HTV_DIRECTPAYMSGMAIN.S_ACCDATE, HTV_DIRECTPAYMSGMAIN.S_FILENAME, "
        + "HTV_DIRECTPAYMSGMAIN.S_PACKAGENO, HTV_DIRECTPAYMSGMAIN.S_TRECODE, HTV_DIRECTPAYMSGMAIN.S_PAYUNIT, HTV_DIRECTPAYMSGMAIN.S_TRANSBANKCODE, HTV_DIRECTPAYMSGMAIN.S_DEALNO, "
        + "HTV_DIRECTPAYMSGMAIN.N_MONEY, HTV_DIRECTPAYMSGMAIN.S_TAXTICKETNO, HTV_DIRECTPAYMSGMAIN.S_PACKAGETICKETNO, HTV_DIRECTPAYMSGMAIN.S_GENTICKETDATE, HTV_DIRECTPAYMSGMAIN.S_BUDGETTYPE, "
        + "HTV_DIRECTPAYMSGMAIN.S_OFYEAR, HTV_DIRECTPAYMSGMAIN.S_TRANSACTUNIT, HTV_DIRECTPAYMSGMAIN.S_AMTTYPE, HTV_DIRECTPAYMSGMAIN.S_STATUS, HTV_DIRECTPAYMSGMAIN.S_USERCODE, "
        + "HTV_DIRECTPAYMSGMAIN.S_DEMO, HTV_DIRECTPAYMSGMAIN.TS_SYSUPDATE, HTV_DIRECTPAYMSGMAIN.S_ID, HTV_DIRECTPAYMSGMAIN.S_FUNDTYPECODE, HTV_DIRECTPAYMSGMAIN.S_FUNDTYPENAME, "
        + "HTV_DIRECTPAYMSGMAIN.S_PAYEEACCTNO, HTV_DIRECTPAYMSGMAIN.S_PAYEEACCTNAME, HTV_DIRECTPAYMSGMAIN.S_PAYEEACCTBANKNAME, HTV_DIRECTPAYMSGMAIN.S_PAYACCTNO, HTV_DIRECTPAYMSGMAIN.S_PAYACCTNAME, "
        + "HTV_DIRECTPAYMSGMAIN.S_PAYACCTBANKNAME, HTV_DIRECTPAYMSGMAIN.S_PAYBANKCODE, HTV_DIRECTPAYMSGMAIN.S_PAYBANKNAME, HTV_DIRECTPAYMSGMAIN.S_PAYBANKNO, HTV_DIRECTPAYMSGMAIN.S_XACCTDATE, "
        + "HTV_DIRECTPAYMSGMAIN.S_HOLD1, HTV_DIRECTPAYMSGMAIN.S_HOLD2, HTV_DIRECTPAYMSGMAIN.S_PAYVOUCHERNO, HTV_DIRECTPAYMSGMAIN.N_XALLAMT "
        + "FROM HTV_DIRECTPAYMSGMAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTV_DIRECTPAYMSGMAIN SET "
        ...
        + "S_HOLD2 =?,S_PAYVOUCHERNO =?,N_XALLAMT =? "
        + "WHERE "
        + "I_VOUSRLNO = ?"
        ;
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTV_DIRECTPAYMSGMAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     HtvDirectpaymsgmainDto dto = (HtvDirectpaymsgmainDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(37, dto.getSpayvoucherno());

          ps.setBigDecimal(38, dto.getNxallamt());
   ...
   */
	...
	*/
    ...
    {
        HtvDirectpaymsgmainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvDirectpaymsgmainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvDirectpaymsgmainPK pk = (HtvDirectpaymsgmainPK)_pk ;
    ...
    {
        HtvDirectpaymsgmainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtvDirectpaymsgmainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtvDirectpaymsgmainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtvDirectpaymsgmainDto[] dtos = new HtvDirectpaymsgmainDto[0];
		    dtos = (HtvDirectpaymsgmainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvDirectpaymsgmainDto  dto = new  HtvDirectpaymsgmainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                  		throw new SQLException("数据库表：HTV_DIRECTPAYMSGMAIN没有检查修改的字段");
    }
