...
/**
 * <p>Title: DAO of table: TV_VOUCHERINFO</p>
...
public class TvVoucherinfoDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_VOUCHERINFO ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_VOUCHERINFO.S_DEALNO, TV_VOUCHERINFO.S_ORGCODE, TV_VOUCHERINFO.S_TRECODE, TV_VOUCHERINFO.S_FILENAME, TV_VOUCHERINFO.S_ADMDIVCODE, "
        + "TV_VOUCHERINFO.S_STYEAR, TV_VOUCHERINFO.S_VTCODE, TV_VOUCHERINFO.S_VOUCHERNO, TV_VOUCHERINFO.S_VOUCHERFLAG, TV_VOUCHERINFO.S_ATTACH, "
        + "TV_VOUCHERINFO.S_RETURNERRMSG, TV_VOUCHERINFO.S_CREATDATE, TV_VOUCHERINFO.N_MONEY, TV_VOUCHERINFO.S_STATUS, TV_VOUCHERINFO.S_CONFIRUSERCODE, "
        + "TV_VOUCHERINFO.S_VERIFYUSERCODE, TV_VOUCHERINFO.S_DEMO, TV_VOUCHERINFO.S_STAMPID, TV_VOUCHERINFO.S_PACKNO, TV_VOUCHERINFO.I_COUNT, "
        + "TV_VOUCHERINFO.N_CHECKMONEY, TV_VOUCHERINFO.I_CHECKCOUNT, TV_VOUCHERINFO.TS_SYSUPDATE, TV_VOUCHERINFO.S_STAMPUSER, TV_VOUCHERINFO.S_CHECKDATE, "
        + "TV_VOUCHERINFO.S_CHECKVOUCHERTYPE, TV_VOUCHERINFO.S_PAYBANKCODE, TV_VOUCHERINFO.S_RECVTIME, TV_VOUCHERINFO.S_HOLD1, TV_VOUCHERINFO.S_HOLD2, "
        + "TV_VOUCHERINFO.S_HOLD3, TV_VOUCHERINFO.S_HOLD4, TV_VOUCHERINFO.S_EXT1, TV_VOUCHERINFO.S_EXT2, TV_VOUCHERINFO.S_EXT3, "
        + "TV_VOUCHERINFO.S_EXT4, TV_VOUCHERINFO.S_EXT5 "
        + "FROM TV_VOUCHERINFO "
        +" WHERE " 
        + "S_DEALNO = ?"
        ;
  ...
  {
     TvVoucherinfoDto dto = (TvVoucherinfoDto)_dto ;
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvVoucherinfoPK pk = (TvVoucherinfoPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TvVoucherinfoDto[] dtos = new TvVoucherinfoDto[0];
		    dtos = (TvVoucherinfoDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                            		throw new SQLException("数据库表：TV_VOUCHERINFO没有检查修改的字段");
    }
