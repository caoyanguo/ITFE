...
/**
 * <p>Title: DAO of table: TF_PAYBANK_REFUNDMAIN</p>
 * <p>Description:收款银行退款通知2252主表 Data Access Object  </p>
...
public class TfPaybankRefundmainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TF_PAYBANK_REFUNDMAIN ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TF_PAYBANK_REFUNDMAIN.I_VOUSRLNO, TF_PAYBANK_REFUNDMAIN.S_ORGCODE, TF_PAYBANK_REFUNDMAIN.S_TRECODE, TF_PAYBANK_REFUNDMAIN.S_COMMITDATE, TF_PAYBANK_REFUNDMAIN.S_DEALNO, "
        + "TF_PAYBANK_REFUNDMAIN.S_FINORGCODE, TF_PAYBANK_REFUNDMAIN.S_PACKAGENO, TF_PAYBANK_REFUNDMAIN.S_FILENAME, TF_PAYBANK_REFUNDMAIN.S_STATUS, TF_PAYBANK_REFUNDMAIN.S_DEMO, "
        + "TF_PAYBANK_REFUNDMAIN.TS_SYSUPDATE, TF_PAYBANK_REFUNDMAIN.S_ID, TF_PAYBANK_REFUNDMAIN.S_ADMDIVCODE, TF_PAYBANK_REFUNDMAIN.S_STYEAR, TF_PAYBANK_REFUNDMAIN.S_VTCODE, "
        + "TF_PAYBANK_REFUNDMAIN.S_VOUDATE, TF_PAYBANK_REFUNDMAIN.S_VOUCHERNO, TF_PAYBANK_REFUNDMAIN.S_ORIBILLNO, TF_PAYBANK_REFUNDMAIN.S_PAYTYPECODE, TF_PAYBANK_REFUNDMAIN.S_PAYTYPENAME, "
        + "TF_PAYBANK_REFUNDMAIN.S_ORIGINALVOUCHERNO, TF_PAYBANK_REFUNDMAIN.N_PAYAMT, TF_PAYBANK_REFUNDMAIN.S_PAYDICTATENO, TF_PAYBANK_REFUNDMAIN.S_PAYMSGNO, TF_PAYBANK_REFUNDMAIN.S_PAYENTRUSTDATE, "
        + "TF_PAYBANK_REFUNDMAIN.S_PAYSNDBNKNO, TF_PAYBANK_REFUNDMAIN.S_REMARK, TF_PAYBANK_REFUNDMAIN.S_PAYDATE, TF_PAYBANK_REFUNDMAIN.S_BACKFLAG, TF_PAYBANK_REFUNDMAIN.S_ISRETURN, "
        + "TF_PAYBANK_REFUNDMAIN.S_BCKREASON, TF_PAYBANK_REFUNDMAIN.S_REFUNDTYPE, TF_PAYBANK_REFUNDMAIN.N_BACKMONEY, TF_PAYBANK_REFUNDMAIN.S_HOLD1, TF_PAYBANK_REFUNDMAIN.S_HOLD2, "
        + "TF_PAYBANK_REFUNDMAIN.S_EXT1, TF_PAYBANK_REFUNDMAIN.S_EXT2, TF_PAYBANK_REFUNDMAIN.S_EXT3, TF_PAYBANK_REFUNDMAIN.S_EXT4, TF_PAYBANK_REFUNDMAIN.S_EXT5 "
        + "FROM TF_PAYBANK_REFUNDMAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TF_PAYBANK_REFUNDMAIN SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TF_PAYBANK_REFUNDMAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     TfPaybankRefundmainDto dto = (TfPaybankRefundmainDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TfPaybankRefundmainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TfPaybankRefundmainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TfPaybankRefundmainPK pk = (TfPaybankRefundmainPK)_pk ;
    ...
    {
        TfPaybankRefundmainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TfPaybankRefundmainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TfPaybankRefundmainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TfPaybankRefundmainDto[] dtos = new TfPaybankRefundmainDto[0];
		    dtos = (TfPaybankRefundmainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TfPaybankRefundmainDto  dto = new  TfPaybankRefundmainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                     		throw new SQLException("数据库表：TF_PAYBANK_REFUNDMAIN没有检查修改的字段");
    }
