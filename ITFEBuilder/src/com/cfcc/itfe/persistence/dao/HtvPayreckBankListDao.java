...
/**
 * <p>Title: DAO of table: HTV_PAYRECK_BANK_LIST</p>
...
public class HtvPayreckBankListDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_PAYRECK_BANK_LIST ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_PAYRECK_BANK_LIST.I_VOUSRLNO, HTV_PAYRECK_BANK_LIST.I_SEQNO, HTV_PAYRECK_BANK_LIST.S_BDGORGCODE, HTV_PAYRECK_BANK_LIST.S_FUNCBDGSBTCODE, HTV_PAYRECK_BANK_LIST.S_ECNOMICSUBJECTCODE, "
        + "HTV_PAYRECK_BANK_LIST.F_AMT, HTV_PAYRECK_BANK_LIST.S_ACCTPROP, HTV_PAYRECK_BANK_LIST.TS_UPDATE, HTV_PAYRECK_BANK_LIST.S_SUPDEPNAME, HTV_PAYRECK_BANK_LIST.S_EXPFUNCNAME, "
        + "HTV_PAYRECK_BANK_LIST.S_PAYSUMMARYNAME, HTV_PAYRECK_BANK_LIST.S_HOLD1, HTV_PAYRECK_BANK_LIST.S_HOLD2, HTV_PAYRECK_BANK_LIST.S_HOLD3, HTV_PAYRECK_BANK_LIST.S_HOLD4, "
        + "HTV_PAYRECK_BANK_LIST.S_VOUCHERN0, HTV_PAYRECK_BANK_LIST.S_ID, HTV_PAYRECK_BANK_LIST.S_PAYDATE "
        + "FROM HTV_PAYRECK_BANK_LIST "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTV_PAYRECK_BANK_LIST SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTV_PAYRECK_BANK_LIST " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_SEQNO = ?"
        ;
  ...
  {
     HtvPayreckBankListDto dto = (HtvPayreckBankListDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtvPayreckBankListDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvPayreckBankListDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvPayreckBankListPK pk = (HtvPayreckBankListPK)_pk ;
    ...
    {
        HtvPayreckBankListPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtvPayreckBankListPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtvPayreckBankListPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtvPayreckBankListDto[] dtos = new HtvPayreckBankListDto[0];
		    dtos = (HtvPayreckBankListDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvPayreckBankListDto  dto = new  HtvPayreckBankListDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                		throw new SQLException("数据库表：HTV_PAYRECK_BANK_LIST没有检查修改的字段");
    }
