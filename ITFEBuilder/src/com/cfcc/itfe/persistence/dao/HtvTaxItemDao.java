...
/**
 * <p>Title: DAO of table: HTV_TAX_ITEM</p>
...
public class HtvTaxItemDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_TAX_ITEM ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_TAX_ITEM.S_SEQ, HTV_TAX_ITEM.I_PROJECTID, HTV_TAX_ITEM.I_DETAILNO, HTV_TAX_ITEM.S_TAXSUBJECTCODE, HTV_TAX_ITEM.S_TAXSUBJECTNAME, "
        + "HTV_TAX_ITEM.I_TAXNUMBER, HTV_TAX_ITEM.F_TAXAMT, HTV_TAX_ITEM.F_TAXRATE, HTV_TAX_ITEM.F_EXPTAXAMT, HTV_TAX_ITEM.F_DISCOUNTTAXAMT, "
        + "HTV_TAX_ITEM.F_REALAMT, HTV_TAX_ITEM.TS_UPDATE "
        + "FROM HTV_TAX_ITEM "
        +" WHERE " 
  ...
  {
     HtvTaxItemDto dto = (HtvTaxItemDto)_dto ;
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvTaxItemPK pk = (HtvTaxItemPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            HtvTaxItemDto[] dtos = new HtvTaxItemDto[0];
		    dtos = (HtvTaxItemDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvTaxItemDto  dto = new  HtvTaxItemDto ();
             //S_SEQ
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                           		throw new SQLException("数据库表：HTV_TAX_ITEM没有检查修改的字段");
    }
