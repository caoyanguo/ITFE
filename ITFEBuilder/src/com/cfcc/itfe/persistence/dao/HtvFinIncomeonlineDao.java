...
/**
 * <p>Title: DAO of table: HTV_FIN_INCOMEONLINE</p>
...
public class HtvFinIncomeonlineDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_FIN_INCOMEONLINE ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_FIN_INCOMEONLINE.S_ORGCODE, HTV_FIN_INCOMEONLINE.S_APPLYDATE, HTV_FIN_INCOMEONLINE.S_PACKNO, HTV_FIN_INCOMEONLINE.S_TRECODE, HTV_FIN_INCOMEONLINE.S_TRENAME, "
        + "HTV_FIN_INCOMEONLINE.S_TAXORGCODE, HTV_FIN_INCOMEONLINE.S_PAYBNKNO, HTV_FIN_INCOMEONLINE.S_TRANO, HTV_FIN_INCOMEONLINE.S_ORIMSGNO, HTV_FIN_INCOMEONLINE.F_TRAAMT, "
        + "HTV_FIN_INCOMEONLINE.S_PAYEROPNBNKNO, HTV_FIN_INCOMEONLINE.PAYEROPBKNAME, HTV_FIN_INCOMEONLINE.S_HANDORGNAME, HTV_FIN_INCOMEONLINE.S_PAYACCT, HTV_FIN_INCOMEONLINE.S_TAXVOUNO, "
        + "HTV_FIN_INCOMEONLINE.S_BILLDATE, HTV_FIN_INCOMEONLINE.S_TAXPAYCODE, HTV_FIN_INCOMEONLINE.S_TAXPAYNAME, HTV_FIN_INCOMEONLINE.C_BUDGETTYPE, HTV_FIN_INCOMEONLINE.C_TRIMFLAG, "
        + "HTV_FIN_INCOMEONLINE.S_ETPCODE, HTV_FIN_INCOMEONLINE.S_ETPNAME, HTV_FIN_INCOMEONLINE.S_ETPTYPE, HTV_FIN_INCOMEONLINE.S_BDGSBTCODE, HTV_FIN_INCOMEONLINE.S_BDGSBTNAME, "
        + "HTV_FIN_INCOMEONLINE.S_LIMIT, HTV_FIN_INCOMEONLINE.S_TAXTYPECODE, HTV_FIN_INCOMEONLINE.S_TAXKINDNAME, HTV_FIN_INCOMEONLINE.C_BDGLEVEL, HTV_FIN_INCOMEONLINE.C_BDGLEVELNAME, "
        + "HTV_FIN_INCOMEONLINE.S_TAXSTARTDATE, HTV_FIN_INCOMEONLINE.S_TAXENDDATE, HTV_FIN_INCOMEONLINE.S_ASTFLAG, HTV_FIN_INCOMEONLINE.C_TAXTYPE, HTV_FIN_INCOMEONLINE.S_ACCT, "
        + "HTV_FIN_INCOMEONLINE.S_TRASTATE, HTV_FIN_INCOMEONLINE.S_REMARK, HTV_FIN_INCOMEONLINE.S_REMARK1, HTV_FIN_INCOMEONLINE.S_REMARK2, HTV_FIN_INCOMEONLINE.S_INPUTERID, "
        + "HTV_FIN_INCOMEONLINE.TS_SYSUPDATE, HTV_FIN_INCOMEONLINE.S_SEQ "
        + "FROM HTV_FIN_INCOMEONLINE "
        +" WHERE " 
        + "S_SEQ = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTV_FIN_INCOMEONLINE SET "
        + "S_ORGCODE =?,S_APPLYDATE =?,S_PACKNO =?,S_TRECODE =?,S_TRENAME =?, "
        + "S_TAXORGCODE =?,S_PAYBNKNO =?,S_TRANO =?,S_ORIMSGNO =?,F_TRAAMT =?, "
        + "S_PAYEROPNBNKNO =?,PAYEROPBKNAME =?,S_HANDORGNAME =?,S_PAYACCT =?,S_TAXVOUNO =?, "
        + "S_BILLDATE =?,S_TAXPAYCODE =?,S_TAXPAYNAME =?,C_BUDGETTYPE =?,C_TRIMFLAG =?, "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTV_FIN_INCOMEONLINE " 
        + " WHERE "
        + "S_SEQ = ?"
        ;
  ...
  {
     HtvFinIncomeonlineDto dto = (HtvFinIncomeonlineDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtvFinIncomeonlineDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvFinIncomeonlineDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvFinIncomeonlinePK pk = (HtvFinIncomeonlinePK)_pk ;
    ...
    {
        HtvFinIncomeonlinePK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtvFinIncomeonlinePK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtvFinIncomeonlinePK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            HtvFinIncomeonlineDto[] dtos = new HtvFinIncomeonlineDto[0];
		    dtos = (HtvFinIncomeonlineDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvFinIncomeonlineDto  dto = new  HtvFinIncomeonlineDto ();
             //S_ORGCODE
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                           		throw new SQLException("数据库表：HTV_FIN_INCOMEONLINE没有检查修改的字段");
    }
