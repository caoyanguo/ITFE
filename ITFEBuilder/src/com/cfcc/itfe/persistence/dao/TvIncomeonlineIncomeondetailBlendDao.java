...
import com.cfcc.itfe.persistence.pk.TvIncomeonlineIncomeondetailBlendPK ;


/**
 * <p>Title: DAO of table: TV_INCOMEONLINE_INCOMEONDETAIL_BLEND</p>
...
public class TvIncomeonlineIncomeondetailBlendDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_INCOMEONLINE_INCOMEONDETAIL_BLEND ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_SEQ, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_FINORGCODE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_APPLYDATE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_INTREDATE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_BLEND, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_PACKNO, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TRECODE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TRENAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXORGCODE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_PAYBNKNO, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TRANO, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_ORIMSGNO, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.F_TRAAMT, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.F_AMT, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_PAYEROPNBNKNO, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_PAYEROPBKNAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_HANDORGNAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_PAYACCT, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXVOUNO, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_BILLDATE, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXPAYCODE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXPAYNAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_BUDGETTYPE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TRIMFLAG, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_ETPCODE, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_ETPNAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_ETPTYPE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_BDGSBTCODE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_BDGSBTNAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_LIMIT, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXTYPECODE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXKINDNAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_BDGLEVEL, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_BDGLEVELNAME, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXSTARTDATE, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXENDDATE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_ASTFLAG, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TAXTYPE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_ACCT, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_TRASTATE, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_INPUTERID, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.TS_SYSUPDATE, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_VOUCHANNEL, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_STATUS, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_REMARK, "
        + "TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_REMARK1, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_REMARK2, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_REMARK3, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_REMARK4, TV_INCOMEONLINE_INCOMEONDETAIL_BLEND.S_REMARK5 "
        + "FROM TV_INCOMEONLINE_INCOMEONDETAIL_BLEND "
        +" WHERE " 
        + "S_SEQ = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_INCOMEONLINE_INCOMEONDETAIL_BLEND SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_INCOMEONLINE_INCOMEONDETAIL_BLEND " 
        + " WHERE "
        + "S_SEQ = ?"
        ;
  ...
  {
     TvIncomeonlineIncomeondetailBlendDto dto = (TvIncomeonlineIncomeondetailBlendDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvIncomeonlineIncomeondetailBlendDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvIncomeonlineIncomeondetailBlendDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvIncomeonlineIncomeondetailBlendPK pk = (TvIncomeonlineIncomeondetailBlendPK)_pk ;
    ...
    {
        TvIncomeonlineIncomeondetailBlendPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvIncomeonlineIncomeondetailBlendPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvIncomeonlineIncomeondetailBlendPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TvIncomeonlineIncomeondetailBlendDto[] dtos = new TvIncomeonlineIncomeondetailBlendDto[0];
		    dtos = (TvIncomeonlineIncomeondetailBlendDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvIncomeonlineIncomeondetailBlendDto  dto = new  TvIncomeonlineIncomeondetailBlendDto ();
             //S_SEQ
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                                   		throw new SQLException("数据库表：TV_INCOMEONLINE_INCOMEONDETAIL_BLEND没有检查修改的字段");
    }
