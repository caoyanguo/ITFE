...
/**
 * <p>Title: DAO of table: HTV_GRANTPAYMSGSUB</p>
...
public class HtvGrantpaymsgsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_GRANTPAYMSGSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_GRANTPAYMSGSUB.I_VOUSRLNO, HTV_GRANTPAYMSGSUB.I_DETAILSEQNO, HTV_GRANTPAYMSGSUB.S_ORGCODE, HTV_GRANTPAYMSGSUB.S_FILENAME, HTV_GRANTPAYMSGSUB.S_LIMITID, "
        + "HTV_GRANTPAYMSGSUB.S_OFYEAR, HTV_GRANTPAYMSGSUB.S_LINE, HTV_GRANTPAYMSGSUB.S_PACKAGENO, HTV_GRANTPAYMSGSUB.S_DEALNO, HTV_GRANTPAYMSGSUB.S_PACKAGETICKETNO, "
        + "HTV_GRANTPAYMSGSUB.S_BUDGETUNITCODE, HTV_GRANTPAYMSGSUB.S_BUDGETTYPE, HTV_GRANTPAYMSGSUB.S_FUNSUBJECTCODE, HTV_GRANTPAYMSGSUB.S_ECOSUBJECTCODE, HTV_GRANTPAYMSGSUB.N_MONEY, "
        + "HTV_GRANTPAYMSGSUB.S_ACCATTRIB, HTV_GRANTPAYMSGSUB.S_ACCDATE, HTV_GRANTPAYMSGSUB.S_STATUS, HTV_GRANTPAYMSGSUB.S_USERCODE, HTV_GRANTPAYMSGSUB.TS_SYSUPDATE, "
        + "HTV_GRANTPAYMSGSUB.S_DEMO, HTV_GRANTPAYMSGSUB.S_SUPDEPNAME, HTV_GRANTPAYMSGSUB.S_EXPFUNCNAME, HTV_GRANTPAYMSGSUB.S_EXPFUNCCODE1, HTV_GRANTPAYMSGSUB.S_EXPFUNCNAME1, "
        + "HTV_GRANTPAYMSGSUB.S_EXPFUNCCODE2, HTV_GRANTPAYMSGSUB.S_EXPFUNCNAME2, HTV_GRANTPAYMSGSUB.S_EXPFUNCCODE3, HTV_GRANTPAYMSGSUB.S_EXPFUNCNAME3, HTV_GRANTPAYMSGSUB.S_PROCATCODE, "
        + "HTV_GRANTPAYMSGSUB.S_PROCATNAME, HTV_GRANTPAYMSGSUB.S_HOLD1, HTV_GRANTPAYMSGSUB.S_HOLD2, HTV_GRANTPAYMSGSUB.S_HOLD3, HTV_GRANTPAYMSGSUB.S_HOLD4, "
        + "HTV_GRANTPAYMSGSUB.S_ID "
        + "FROM HTV_GRANTPAYMSGSUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTV_GRANTPAYMSGSUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_DETAILSEQNO = ? AND S_PACKAGETICKETNO = ?"
        ;
  ...
  {
     HtvGrantpaymsgsubDto dto = (HtvGrantpaymsgsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtvGrantpaymsgsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvGrantpaymsgsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvGrantpaymsgsubPK pk = (HtvGrantpaymsgsubPK)_pk ;
    ...
    {
        HtvGrantpaymsgsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtvGrantpaymsgsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtvGrantpaymsgsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtvGrantpaymsgsubDto[] dtos = new HtvGrantpaymsgsubDto[0];
		    dtos = (HtvGrantpaymsgsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvGrantpaymsgsubDto  dto = new  HtvGrantpaymsgsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                   		throw new SQLException("数据库表：HTV_GRANTPAYMSGSUB没有检查修改的字段");
    }
