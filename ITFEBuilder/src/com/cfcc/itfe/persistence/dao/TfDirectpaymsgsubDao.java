...
/**
 * <p>Title: DAO of table: TF_DIRECTPAYMSGSUB</p>
 * <p>Description:财政直接支付凭证5201子表 Data Access Object  </p>
...
public class TfDirectpaymsgsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TF_DIRECTPAYMSGSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TF_DIRECTPAYMSGSUB.I_VOUSRLNO, TF_DIRECTPAYMSGSUB.I_SEQNO, TF_DIRECTPAYMSGSUB.S_ID, TF_DIRECTPAYMSGSUB.S_VOUCHERBILLID, TF_DIRECTPAYMSGSUB.S_VOUCHERBILLNO, "
        + "TF_DIRECTPAYMSGSUB.S_VOUCHERNO, TF_DIRECTPAYMSGSUB.S_FUNDTYPECODE, TF_DIRECTPAYMSGSUB.S_FUNDTYPENAME, TF_DIRECTPAYMSGSUB.S_BGTTYPECODE, TF_DIRECTPAYMSGSUB.S_BGTTYPENAME, "
        + "TF_DIRECTPAYMSGSUB.S_PROCATCODE, TF_DIRECTPAYMSGSUB.S_PROCATNAME, TF_DIRECTPAYMSGSUB.S_PAYKINDCODE, TF_DIRECTPAYMSGSUB.S_PAYKINDNAME, TF_DIRECTPAYMSGSUB.S_MOFDEPCODE, "
        + "TF_DIRECTPAYMSGSUB.S_MOFDEPNAME, TF_DIRECTPAYMSGSUB.S_FILENOCODE, TF_DIRECTPAYMSGSUB.S_FILENONAME, TF_DIRECTPAYMSGSUB.S_SUPDEPCODE, TF_DIRECTPAYMSGSUB.S_SUPDEPNAME, "
        + "TF_DIRECTPAYMSGSUB.S_AGENCYCODE, TF_DIRECTPAYMSGSUB.S_AGENCYNAME, TF_DIRECTPAYMSGSUB.S_EXPFUNCCODE, TF_DIRECTPAYMSGSUB.S_EXPFUNCNAME, TF_DIRECTPAYMSGSUB.S_EXPECOCODE, "
        + "TF_DIRECTPAYMSGSUB.S_EXPECONAME, TF_DIRECTPAYMSGSUB.S_DEPPROCODE, TF_DIRECTPAYMSGSUB.S_DEPPRONAME, TF_DIRECTPAYMSGSUB.S_PAYEEACCTNO, TF_DIRECTPAYMSGSUB.S_PAYEEACCTNAME, "
        + "TF_DIRECTPAYMSGSUB.S_PAYEEACCTBANKNAME, TF_DIRECTPAYMSGSUB.S_PAYEEACCTBANKNO, TF_DIRECTPAYMSGSUB.N_PAYAMT, TF_DIRECTPAYMSGSUB.S_REMARK, TF_DIRECTPAYMSGSUB.S_XPAYDATE, "
        + "TF_DIRECTPAYMSGSUB.S_XAGENTBUSINESSNO, TF_DIRECTPAYMSGSUB.S_XCHECKNO, TF_DIRECTPAYMSGSUB.N_XPAYAMT, TF_DIRECTPAYMSGSUB.S_XPAYEEACCTBANKNAME, TF_DIRECTPAYMSGSUB.S_XPAYEEACCTNO, "
        + "TF_DIRECTPAYMSGSUB.S_XPAYEEACCTNAME, TF_DIRECTPAYMSGSUB.S_XADDWORD, TF_DIRECTPAYMSGSUB.S_HOLD1, TF_DIRECTPAYMSGSUB.S_HOLD2, TF_DIRECTPAYMSGSUB.S_HOLD3, "
        + "TF_DIRECTPAYMSGSUB.S_HOLD4, TF_DIRECTPAYMSGSUB.S_EXT1, TF_DIRECTPAYMSGSUB.S_EXT2, TF_DIRECTPAYMSGSUB.S_EXT3 "
        + "FROM TF_DIRECTPAYMSGSUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TF_DIRECTPAYMSGSUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_SEQNO = ?"
        ;
  ...
  {
     TfDirectpaymsgsubDto dto = (TfDirectpaymsgsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TfDirectpaymsgsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TfDirectpaymsgsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TfDirectpaymsgsubPK pk = (TfDirectpaymsgsubPK)_pk ;
    ...
    {
        TfDirectpaymsgsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TfDirectpaymsgsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TfDirectpaymsgsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TfDirectpaymsgsubDto[] dtos = new TfDirectpaymsgsubDto[0];
		    dtos = (TfDirectpaymsgsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TfDirectpaymsgsubDto  dto = new  TfDirectpaymsgsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                             		throw new SQLException("数据库表：TF_DIRECTPAYMSGSUB没有检查修改的字段");
    }
