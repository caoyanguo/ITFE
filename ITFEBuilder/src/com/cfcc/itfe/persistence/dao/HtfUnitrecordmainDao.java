...
import com.cfcc.itfe.persistence.dto.HtfUnitrecordmainDto ;
import com.cfcc.itfe.persistence.pk.HtfUnitrecordmainPK ;


/**
 * <p>Title: DAO of table: HTF_UNITRECORDMAIN</p>
...
public class HtfUnitrecordmainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_UNITRECORDMAIN ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_UNITRECORDMAIN.I_VOUSRLNO, HTF_UNITRECORDMAIN.S_ORGCODE, HTF_UNITRECORDMAIN.S_STATUS, HTF_UNITRECORDMAIN.S_DEMO, HTF_UNITRECORDMAIN.TS_SYSUPDATE, "
        + "HTF_UNITRECORDMAIN.S_ADMDIVCODE, HTF_UNITRECORDMAIN.S_STYEAR, HTF_UNITRECORDMAIN.S_VTCODE, HTF_UNITRECORDMAIN.S_VOUDATE, HTF_UNITRECORDMAIN.S_VOUCHERNO, "
        + "HTF_UNITRECORDMAIN.S_TRECODE, HTF_UNITRECORDMAIN.S_FINORGCODE, HTF_UNITRECORDMAIN.S_PAYBANKCODE, HTF_UNITRECORDMAIN.S_PAYBANKNAME, HTF_UNITRECORDMAIN.S_ALLFLAG, "
        + "HTF_UNITRECORDMAIN.S_HOLD1, HTF_UNITRECORDMAIN.S_HOLD2, HTF_UNITRECORDMAIN.S_EXT1, HTF_UNITRECORDMAIN.S_EXT2, HTF_UNITRECORDMAIN.S_EXT3 "
        + "FROM HTF_UNITRECORDMAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_UNITRECORDMAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     HtfUnitrecordmainDto dto = (HtfUnitrecordmainDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtfUnitrecordmainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfUnitrecordmainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfUnitrecordmainPK pk = (HtfUnitrecordmainPK)_pk ;
    ...
    {
        HtfUnitrecordmainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfUnitrecordmainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfUnitrecordmainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfUnitrecordmainDto[] dtos = new HtfUnitrecordmainDto[0];
		    dtos = (HtfUnitrecordmainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfUnitrecordmainDto  dto = new  HtfUnitrecordmainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                         		throw new SQLException("数据库表：HTF_UNITRECORDMAIN没有检查修改的字段");
    }
