...
/**
 * <p>Title: DAO of table: HTV_DIRECTPAYMSGSUB</p>
...
public class HtvDirectpaymsgsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_DIRECTPAYMSGSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_DIRECTPAYMSGSUB.I_VOUSRLNO, HTV_DIRECTPAYMSGSUB.I_DETAILSEQNO, HTV_DIRECTPAYMSGSUB.S_ORGCODE, HTV_DIRECTPAYMSGSUB.S_PACKAGENO, HTV_DIRECTPAYMSGSUB.S_BUDGETUNITCODE, "
        + "HTV_DIRECTPAYMSGSUB.S_TAXTICKETNO, HTV_DIRECTPAYMSGSUB.S_LINE, HTV_DIRECTPAYMSGSUB.S_OFYEAR, HTV_DIRECTPAYMSGSUB.I_NOAFTERPACKAGE, HTV_DIRECTPAYMSGSUB.S_FUNSUBJECTCODE, "
        + "HTV_DIRECTPAYMSGSUB.S_ECOSUBJECTCODE, HTV_DIRECTPAYMSGSUB.N_MONEY, HTV_DIRECTPAYMSGSUB.S_ACCDATE, HTV_DIRECTPAYMSGSUB.S_USERCODE, HTV_DIRECTPAYMSGSUB.S_DEMO, "
        + "HTV_DIRECTPAYMSGSUB.TS_SYSUPDATE, HTV_DIRECTPAYMSGSUB.S_AGENCYCODE, HTV_DIRECTPAYMSGSUB.S_AGENCYNAME, HTV_DIRECTPAYMSGSUB.S_EXPFUNCNAME, HTV_DIRECTPAYMSGSUB.S_EXPFUNCCODE1, "
        + "HTV_DIRECTPAYMSGSUB.S_EXPFUNCNAME1, HTV_DIRECTPAYMSGSUB.S_EXPFUNCCODE2, HTV_DIRECTPAYMSGSUB.S_EXPFUNCNAME2, HTV_DIRECTPAYMSGSUB.S_EXPFUNCCODE3, HTV_DIRECTPAYMSGSUB.S_EXPFUNCNAME3, "
        + "HTV_DIRECTPAYMSGSUB.S_PROCATCODE, HTV_DIRECTPAYMSGSUB.S_PROCATNAME, HTV_DIRECTPAYMSGSUB.S_HOLD1, HTV_DIRECTPAYMSGSUB.S_HOLD2, HTV_DIRECTPAYMSGSUB.S_HOLD3, "
        + "HTV_DIRECTPAYMSGSUB.S_HOLD4, HTV_DIRECTPAYMSGSUB.S_ID "
        + "FROM HTV_DIRECTPAYMSGSUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTV_DIRECTPAYMSGSUB SET "
        ...
        + "S_HOLD1 =?,S_HOLD2 =?,S_HOLD3 =?,S_HOLD4 =?,S_ID =? "
        + "WHERE "
        + "I_VOUSRLNO = ? AND I_DETAILSEQNO = ?"
        ;
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTV_DIRECTPAYMSGSUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_DETAILSEQNO = ?"
        ;
  ...
  {
     HtvDirectpaymsgsubDto dto = (HtvDirectpaymsgsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtvDirectpaymsgsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvDirectpaymsgsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvDirectpaymsgsubPK pk = (HtvDirectpaymsgsubPK)_pk ;
    ...
    {
        HtvDirectpaymsgsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtvDirectpaymsgsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtvDirectpaymsgsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtvDirectpaymsgsubDto[] dtos = new HtvDirectpaymsgsubDto[0];
		    dtos = (HtvDirectpaymsgsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvDirectpaymsgsubDto  dto = new  HtvDirectpaymsgsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                          		throw new SQLException("数据库表：HTV_DIRECTPAYMSGSUB没有检查修改的字段");
    }
