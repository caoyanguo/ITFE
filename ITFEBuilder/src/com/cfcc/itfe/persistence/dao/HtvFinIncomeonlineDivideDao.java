...
import com.cfcc.itfe.persistence.dto.HtvFinIncomeonlineDivideDto ;
import com.cfcc.itfe.persistence.pk.HtvFinIncomeonlineDividePK ;


/**
 * <p>Title: DAO of table: HTV_FIN_INCOMEONLINE_DIVIDE</p>
...
public class HtvFinIncomeonlineDivideDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_FIN_INCOMEONLINE_DIVIDE ("
          + "S_ORGCODE,S_APPLYDATE,S_PACKNO,S_TRECODE,S_TRENAME"
          + ",S_TAXORGCODE,S_PAYBNKNO,S_TRANO,S_ORIMSGNO,F_TRAAMT"
          + ",S_PAYEROPNBNKNO,PAYEROPBKNAME,S_HANDORGNAME,S_PAYERACCT,S_TAXVOUNO"
          + ",S_BILLDATE,S_TAXPAYCODE,S_TAXPAYNAME,C_BDGKIND,C_TRIMFLAG"
          ...
          + ",TS_SYSUPDATE,S_AFTTRECODE,S_AFTTAXORGCODE,C_AFTBDGLEVEL,S_AFTBDGSBTCODE"
          + ",C_AFTBDGTYPE,S_AFTASTFLAG,F_JOINDIVIDERATE,F_TRAAMT_DIVIDE,S_AMTCHECKFLAG"
          + ",C_GOVERNRALATION,F_TRAAMT_DIVIDE2,F_TRAAMT_DIVIDE3,S_SEQ"
        + ") VALUES ("
        + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,CURRENT TIMESTAMP ,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_ORGCODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_APPLYDATE, HTV_FIN_INCOMEONLINE_DIVIDE.S_PACKNO, HTV_FIN_INCOMEONLINE_DIVIDE.S_TRECODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_TRENAME, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXORGCODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_PAYBNKNO, HTV_FIN_INCOMEONLINE_DIVIDE.S_TRANO, HTV_FIN_INCOMEONLINE_DIVIDE.S_ORIMSGNO, HTV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_PAYEROPNBNKNO, HTV_FIN_INCOMEONLINE_DIVIDE.PAYEROPBKNAME, HTV_FIN_INCOMEONLINE_DIVIDE.S_HANDORGNAME, HTV_FIN_INCOMEONLINE_DIVIDE.S_PAYERACCT, HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXVOUNO, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_BILLDATE, HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXPAYCODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXPAYNAME, HTV_FIN_INCOMEONLINE_DIVIDE.C_BDGKIND, HTV_FIN_INCOMEONLINE_DIVIDE.C_TRIMFLAG, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_ETPCODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_ETPNAME, HTV_FIN_INCOMEONLINE_DIVIDE.S_ETPTYPE, HTV_FIN_INCOMEONLINE_DIVIDE.S_BDGSBTCODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_BDGSBTNAME, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_LIMIT, HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXTYPECODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXKINDNAME, HTV_FIN_INCOMEONLINE_DIVIDE.C_BDGLEVEL, HTV_FIN_INCOMEONLINE_DIVIDE.C_BDGLEVELNAME, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXSTARTDATE, HTV_FIN_INCOMEONLINE_DIVIDE.S_TAXENDDATE, HTV_FIN_INCOMEONLINE_DIVIDE.S_ASTFLAG, HTV_FIN_INCOMEONLINE_DIVIDE.C_TAXTYPE, HTV_FIN_INCOMEONLINE_DIVIDE.S_ACCT, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.S_TRASTATE, HTV_FIN_INCOMEONLINE_DIVIDE.S_REMARK, HTV_FIN_INCOMEONLINE_DIVIDE.S_REMARK1, HTV_FIN_INCOMEONLINE_DIVIDE.S_REMARK2, HTV_FIN_INCOMEONLINE_DIVIDE.S_INPUTERID, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.TS_SYSUPDATE, HTV_FIN_INCOMEONLINE_DIVIDE.S_AFTTRECODE, HTV_FIN_INCOMEONLINE_DIVIDE.S_AFTTAXORGCODE, HTV_FIN_INCOMEONLINE_DIVIDE.C_AFTBDGLEVEL, HTV_FIN_INCOMEONLINE_DIVIDE.S_AFTBDGSBTCODE, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.C_AFTBDGTYPE, HTV_FIN_INCOMEONLINE_DIVIDE.S_AFTASTFLAG, HTV_FIN_INCOMEONLINE_DIVIDE.F_JOINDIVIDERATE, HTV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT_DIVIDE, HTV_FIN_INCOMEONLINE_DIVIDE.S_AMTCHECKFLAG, "
        + "HTV_FIN_INCOMEONLINE_DIVIDE.C_GOVERNRALATION, HTV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT_DIVIDE2, HTV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT_DIVIDE3, HTV_FIN_INCOMEONLINE_DIVIDE.S_SEQ "
        + "FROM HTV_FIN_INCOMEONLINE_DIVIDE "
        +" WHERE " 
        + "S_AFTTRECODE = ? AND S_SEQ = ?"
        ;
    ...
    private static final String SQL_SELECT_FOR_UPDATE =
        ...
        + "FROM HTV_FIN_INCOMEONLINE_DIVIDE "
        +" WHERE " 
        + "S_AFTTRECODE = ? AND S_SEQ = ? FOR UPDATE"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTV_FIN_INCOMEONLINE_DIVIDE SET "
        + "S_ORGCODE =?,S_APPLYDATE =?,S_PACKNO =?,S_TRECODE =?,S_TRENAME =?, "
        + "S_TAXORGCODE =?,S_PAYBNKNO =?,S_TRANO =?,S_ORIMSGNO =?,F_TRAAMT =?, "
        + "S_PAYEROPNBNKNO =?,PAYEROPBKNAME =?,S_HANDORGNAME =?,S_PAYERACCT =?,S_TAXVOUNO =?, "
        + "S_BILLDATE =?,S_TAXPAYCODE =?,S_TAXPAYNAME =?,C_BDGKIND =?,C_TRIMFLAG =?, "
        ...
        + "S_TAXSTARTDATE =?,S_TAXENDDATE =?,S_ASTFLAG =?,C_TAXTYPE =?,S_ACCT =?, "
        + "S_TRASTATE =?,S_REMARK =?,S_REMARK1 =?,S_REMARK2 =?,S_INPUTERID =?, "
        + "TS_SYSUPDATE =CURRENT TIMESTAMP,S_AFTTAXORGCODE =?,C_AFTBDGLEVEL =?,S_AFTBDGSBTCODE =?,C_AFTBDGTYPE =?, "
        + "S_AFTASTFLAG =?,F_JOINDIVIDERATE =?,F_TRAAMT_DIVIDE =?,S_AMTCHECKFLAG =?,C_GOVERNRALATION =?, "
        + "F_TRAAMT_DIVIDE2 =?,F_TRAAMT_DIVIDE3 =? "
        + "WHERE "
        + "S_AFTTRECODE = ? AND S_SEQ = ?"
        ;
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTV_FIN_INCOMEONLINE_DIVIDE " 
        + " WHERE "
        + "S_AFTTRECODE = ? AND S_SEQ = ?"
        ;
  ...
  {
     HtvFinIncomeonlineDivideDto dto = (HtvFinIncomeonlineDivideDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(14, dto.getSpayeracct());
          ...
          ps.setString(19, dto.getCbdgkind());
          ...
          ps.setString(40, dto.getSinputerid());
           ...
           ps.setString(41, dto.getSafttrecode());

          ps.setString(42, dto.getSafttaxorgcode());

          ps.setString(43, dto.getCaftbdglevel());

          ps.setString(44, dto.getSaftbdgsbtcode());

          ps.setString(45, dto.getCaftbdgtype());

          ps.setString(46, dto.getSaftastflag());

          ps.setBigDecimal(47, dto.getFjoindividerate());

          ps.setBigDecimal(48, dto.getFtraamtdivide());

          ps.setString(49, dto.getSamtcheckflag());

          ps.setString(50, dto.getCgovernralation());

          ps.setBigDecimal(51, dto.getFtraamtdivide2());

          ps.setBigDecimal(52, dto.getFtraamtdivide3());

          ps.setString(53, dto.getSseq());
   ...
   */
	...
	*/
    ...
    {
        HtvFinIncomeonlineDivideDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvFinIncomeonlineDivideDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvFinIncomeonlineDividePK pk = (HtvFinIncomeonlineDividePK)_pk ;

       PreparedStatement ps = null;
       ResultSet rs = null;
       try {
           ps = conn.prepareStatement(SQL_SELECT);
           ps.setString(1, pk.getSafttrecode());

           ps.setString(2, pk.getSseq());
    ...
    {
        HtvFinIncomeonlineDividePK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtvFinIncomeonlineDividePK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtvFinIncomeonlineDividePK)(pks.get(i)) ; 
                   ps.setString((i-iBegin)*2+1, pk.getSafttrecode());

                   ps.setString((i-iBegin)*2+2, pk.getSseq());
        ...
        if (results!=null && results.size() > 0)
        {
            HtvFinIncomeonlineDivideDto[] dtos = new HtvFinIncomeonlineDivideDto[0];
		    dtos = (HtvFinIncomeonlineDivideDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvFinIncomeonlineDivideDto  dto = new  HtvFinIncomeonlineDivideDto ();
             //S_ORGCODE
           ...
           dto.setFjoindividerate(rs.getBigDecimal("F_JOINDIVIDERATE"));
             ...
             //F_TRAAMT_DIVIDE
           dto.setFtraamtdivide(rs.getBigDecimal("F_TRAAMT_DIVIDE"));

             //S_AMTCHECKFLAG
             str = rs.getString("S_AMTCHECKFLAG");
             if (str == null)
                dto.setSamtcheckflag(null);
             else
                dto.setSamtcheckflag(str.trim());
             ...
             //F_TRAAMT_DIVIDE2
           dto.setFtraamtdivide2(rs.getBigDecimal("F_TRAAMT_DIVIDE2"));

             //F_TRAAMT_DIVIDE3
           dto.setFtraamtdivide3(rs.getBigDecimal("F_TRAAMT_DIVIDE3"));
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            //F_TRAAMT_DIVIDE
            ps.setBigDecimal(pos, dto.getFtraamtdivide());
            pos++;

            //S_AMTCHECKFLAG
            ps.setString(pos, dto.getSamtcheckflag());
            pos++;
            ...
            //F_TRAAMT_DIVIDE2
            ps.setBigDecimal(pos, dto.getFtraamtdivide2());
            pos++;

            //F_TRAAMT_DIVIDE3
            ps.setBigDecimal(pos, dto.getFtraamtdivide3());
            pos++;
    ...
    */
    ...
    {
                                                                                                                                                            		throw new SQLException("数据库表：HTV_FIN_INCOMEONLINE_DIVIDE没有检查修改的字段");
    }
