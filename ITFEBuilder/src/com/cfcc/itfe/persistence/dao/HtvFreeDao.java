...
/**
 * <p>Title: DAO of table: HTV_FREE</p>
...
public class HtvFreeDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_FREE ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_FREE.I_VOUSRLNO, HTV_FREE.S_TAXORGCODE, HTV_FREE.S_PACKNO, HTV_FREE.S_TRANO, HTV_FREE.D_BILLDATE, "
        + "HTV_FREE.S_ELECTROTAXVOUNO, HTV_FREE.S_FREEVOUNO, HTV_FREE.C_FREEPLUTYPE, HTV_FREE.S_FREEPLUSUBJECTCODE, HTV_FREE.C_FREEPLULEVEL, "
        + "HTV_FREE.S_FREEPLUSIGN, HTV_FREE.S_FREEPLUPTRECODE, HTV_FREE.F_FREEPLUAMT, HTV_FREE.C_FREEMIKIND, HTV_FREE.S_FREEMISUBJECT, "
        + "HTV_FREE.C_FREEMILEVEL, HTV_FREE.S_FREEMISIGN, HTV_FREE.S_FREEMIPTRE, HTV_FREE.F_FREEMIAMT, HTV_FREE.S_CORPCODE, "
        + "HTV_FREE.C_TRIMSIGN, HTV_FREE.S_STATUS, HTV_FREE.S_FILENAME, HTV_FREE.S_BOOKORGCODE, HTV_FREE.TS_SYSUPDATE, "
        + "HTV_FREE.D_ACCEPTDATE, HTV_FREE.D_AUDITDATE, HTV_FREE.S_CHANNELCODE, HTV_FREE.S_ADDWORD, HTV_FREE.TS_UPDATE "
        + "FROM HTV_FREE "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     HtvFreeDto dto = (HtvFreeDto)_dto ;
   ...
   */
	...
	*/
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            HtvFreeDto[] dtos = new HtvFreeDto[0];
		    dtos = (HtvFreeDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                       		throw new SQLException("数据库表：HTV_FREE没有检查修改的字段");
    }
