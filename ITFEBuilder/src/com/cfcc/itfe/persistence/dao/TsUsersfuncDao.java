...
/**
 * <p>Title: DAO of table: TS_USERSFUNC</p>
...
public class TsUsersfuncDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TS_USERSFUNC ("
          + "S_ORGCODE,S_USERCODE,S_FUNCCODE,I_MODICOUNT"
        + ") VALUES ("
        + "?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TS_USERSFUNC.S_ORGCODE, TS_USERSFUNC.S_USERCODE, TS_USERSFUNC.S_FUNCCODE, TS_USERSFUNC.I_MODICOUNT "
        + "FROM TS_USERSFUNC "
        +" WHERE " 
        + "S_ORGCODE = ? AND S_USERCODE = ? AND S_FUNCCODE = ?"
        ;
    ...
    private static final String SQL_SELECT_FOR_UPDATE =
        ...
        + "FROM TS_USERSFUNC "
        +" WHERE " 
        + "S_ORGCODE = ? AND S_USERCODE = ? AND S_FUNCCODE = ? FOR UPDATE"
        ;
  ...
  {
     TsUsersfuncDto dto = (TsUsersfuncDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(3, dto.getSfunccode());
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TsUsersfuncPK pk = (TsUsersfuncPK)_pk ;
       ...
       try {
           ...
           ps.setString(3, pk.getSfunccode());
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TsUsersfuncDto[] dtos = new TsUsersfuncDto[0];
		    dtos = (TsUsersfuncDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TsUsersfuncDto  dto = new  TsUsersfuncDto ();
             //S_ORGCODE
             ...
             //S_FUNCCODE
             str = rs.getString("S_FUNCCODE");
             if (str == null)
                dto.setSfunccode(null);
             else
                dto.setSfunccode(str.trim());
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
           ...
           pos++;
           //S_FUNCCODE
           ps.setString(pos, dto.getSfunccode());
           pos++;
           ps.executeUpdate();
        }
        finally
    ...
    */
    ...
    {
   		throw new SQLException("数据库表：TS_USERSFUNC没有检查修改的字段");
    }
