...
import com.cfcc.itfe.persistence.dto.HtfReportDefrayMainDto ;
import com.cfcc.itfe.persistence.pk.HtfReportDefrayMainPK ;


/**
 * <p>Title: DAO of table: HTF_REPORT_DEFRAY_MAIN</p>
 * <p>Description:支出报表对帐主表历史表3512 Data Access Object  </p>
...
public class HtfReportDefrayMainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_REPORT_DEFRAY_MAIN ("
          ...
          + ",S_BILLKIND,S_FINORGCODE,S_TRENAME,S_BGTTYPECODE,S_BGTTYPENAME"
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_REPORT_DEFRAY_MAIN.I_VOUSRLNO, HTF_REPORT_DEFRAY_MAIN.S_ORGCODE, HTF_REPORT_DEFRAY_MAIN.S_TRECODE, HTF_REPORT_DEFRAY_MAIN.S_STATUS, HTF_REPORT_DEFRAY_MAIN.S_DEMO, "
        + "HTF_REPORT_DEFRAY_MAIN.TS_SYSUPDATE, HTF_REPORT_DEFRAY_MAIN.S_PACKAGENO, HTF_REPORT_DEFRAY_MAIN.S_ADMDIVCODE, HTF_REPORT_DEFRAY_MAIN.S_STYEAR, HTF_REPORT_DEFRAY_MAIN.S_VTCODE, "
        + "HTF_REPORT_DEFRAY_MAIN.S_VOUDATE, HTF_REPORT_DEFRAY_MAIN.S_VOUCHERNO, HTF_REPORT_DEFRAY_MAIN.S_VOUCHERCHECKNO, HTF_REPORT_DEFRAY_MAIN.S_CHILDPACKNUM, HTF_REPORT_DEFRAY_MAIN.S_CURPACKNO, "
        + "HTF_REPORT_DEFRAY_MAIN.S_BILLKIND, HTF_REPORT_DEFRAY_MAIN.S_FINORGCODE, HTF_REPORT_DEFRAY_MAIN.S_TRENAME, HTF_REPORT_DEFRAY_MAIN.S_BGTTYPECODE, HTF_REPORT_DEFRAY_MAIN.S_BGTTYPENAME, "
        + "HTF_REPORT_DEFRAY_MAIN.S_BEGINDATE, HTF_REPORT_DEFRAY_MAIN.S_ENDDATE, HTF_REPORT_DEFRAY_MAIN.S_ALLNUM, HTF_REPORT_DEFRAY_MAIN.N_ALLAMT, HTF_REPORT_DEFRAY_MAIN.S_XCHECKRESULT, "
        + "HTF_REPORT_DEFRAY_MAIN.S_XDIFFNUM, HTF_REPORT_DEFRAY_MAIN.S_HOLD1, HTF_REPORT_DEFRAY_MAIN.S_HOLD2, HTF_REPORT_DEFRAY_MAIN.S_EXT1, HTF_REPORT_DEFRAY_MAIN.S_EXT2, "
        + "HTF_REPORT_DEFRAY_MAIN.S_EXT3, HTF_REPORT_DEFRAY_MAIN.S_EXT4, HTF_REPORT_DEFRAY_MAIN.S_EXT5 "
        + "FROM HTF_REPORT_DEFRAY_MAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTF_REPORT_DEFRAY_MAIN SET "
        + "S_ORGCODE =?,S_TRECODE =?,S_STATUS =?,S_DEMO =?,TS_SYSUPDATE =CURRENT TIMESTAMP, "
        + "S_PACKAGENO =?,S_ADMDIVCODE =?,S_STYEAR =?,S_VTCODE =?,S_VOUDATE =?, "
        + "S_VOUCHERNO =?,S_VOUCHERCHECKNO =?,S_CHILDPACKNUM =?,S_CURPACKNO =?,S_BILLKIND =?, "
        + "S_FINORGCODE =?,S_TRENAME =?,S_BGTTYPECODE =?,S_BGTTYPENAME =?,S_BEGINDATE =?, "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_REPORT_DEFRAY_MAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     HtfReportDefrayMainDto dto = (HtfReportDefrayMainDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(15, dto.getSbillkind());

          ps.setString(16, dto.getSfinorgcode());

          ps.setString(17, dto.getStrename());

          ps.setString(18, dto.getSbgttypecode());

          ps.setString(19, dto.getSbgttypename());

          ps.setString(20, dto.getSbegindate());

          ps.setString(21, dto.getSenddate());

          ps.setString(22, dto.getSallnum());

          ps.setBigDecimal(23, dto.getNallamt());

          ps.setString(24, dto.getSxcheckresult());

          ps.setString(25, dto.getSxdiffnum());

          ps.setString(26, dto.getShold1());

          ps.setString(27, dto.getShold2());

          ps.setString(28, dto.getSext1());

          ps.setString(29, dto.getSext2());

          ps.setString(30, dto.getSext3());

          ps.setString(31, dto.getSext4());

          ps.setString(32, dto.getSext5());
   ...
   */
	...
	*/
    ...
    {
        HtfReportDefrayMainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfReportDefrayMainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfReportDefrayMainPK pk = (HtfReportDefrayMainPK)_pk ;
    ...
    {
        HtfReportDefrayMainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfReportDefrayMainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfReportDefrayMainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfReportDefrayMainDto[] dtos = new HtfReportDefrayMainDto[0];
		    dtos = (HtfReportDefrayMainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfReportDefrayMainDto  dto = new  HtfReportDefrayMainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                		throw new SQLException("数据库表：HTF_REPORT_DEFRAY_MAIN没有检查修改的字段");
    }
