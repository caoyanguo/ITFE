...
/**
 * <p>Title: DAO of table: TV_TAX_CANCEL</p>
...
public class TvTaxCancelDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_TAX_CANCEL ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_TAX_CANCEL.S_TAXORGCODE, TV_TAX_CANCEL.S_ENTRUSTDATE, TV_TAX_CANCEL.S_CANCELAPPNO, TV_TAX_CANCEL.S_MSGID, TV_TAX_CANCEL.S_ORITRANO, "
        + "TV_TAX_CANCEL.S_ORIENTRUSTDATE, TV_TAX_CANCEL.S_CANCELREASON, TV_TAX_CANCEL.C_CANCELANSWER, TV_TAX_CANCEL.S_ADDWORD, TV_TAX_CANCEL.TS_UPDATE, "
        + "TV_TAX_CANCEL.S_SEQ "
        + "FROM TV_TAX_CANCEL "
        +" WHERE " 
        + "S_SEQ = ?"
  ...
  {
     TvTaxCancelDto dto = (TvTaxCancelDto)_dto ;
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvTaxCancelPK pk = (TvTaxCancelPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TvTaxCancelDto[] dtos = new TvTaxCancelDto[0];
		    dtos = (TvTaxCancelDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvTaxCancelDto  dto = new  TvTaxCancelDto ();
             //S_TAXORGCODE
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                              		throw new SQLException("数据库表：TV_TAX_CANCEL没有检查修改的字段");
    }
