...
/**
 * <p>Title: DAO of table: TV_DIRECTPAYMSGSUB_SX</p>
...
public class TvDirectpaymsgsubSxDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_DIRECTPAYMSGSUB_SX ("
          ...
          + ",S_ECOSUBJECTCODE,N_MONEY,S_ACCDATE,S_USERCODE,S_DEMO"
          + ",TS_SYSUPDATE,S_AGENCYCODE,S_AGENCYNAME,S_EXPFUNCNAME,S_EXPFUNCCODE1"
          + ",S_EXPFUNCNAME1,S_EXPFUNCCODE2,S_EXPFUNCNAME2,S_EXPFUNCCODE3,S_EXPFUNCNAME3"
          + ",S_PROCATCODE,S_PROCATNAME,S_HOLD1,S_HOLD2,S_HOLD3"
          + ",S_HOLD4"
        + ") VALUES ("
        + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,CURRENT TIMESTAMP ,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_DIRECTPAYMSGSUB_SX.I_VOUSRLNO, TV_DIRECTPAYMSGSUB_SX.I_DETAILSEQNO, TV_DIRECTPAYMSGSUB_SX.S_ORGCODE, TV_DIRECTPAYMSGSUB_SX.S_PACKAGENO, TV_DIRECTPAYMSGSUB_SX.S_BUDGETUNITCODE, "
        + "TV_DIRECTPAYMSGSUB_SX.S_TAXTICKETNO, TV_DIRECTPAYMSGSUB_SX.S_LINE, TV_DIRECTPAYMSGSUB_SX.S_OFYEAR, TV_DIRECTPAYMSGSUB_SX.I_NOAFTERPACKAGE, TV_DIRECTPAYMSGSUB_SX.S_FUNSUBJECTCODE, "
        + "TV_DIRECTPAYMSGSUB_SX.S_ECOSUBJECTCODE, TV_DIRECTPAYMSGSUB_SX.N_MONEY, TV_DIRECTPAYMSGSUB_SX.S_ACCDATE, TV_DIRECTPAYMSGSUB_SX.S_USERCODE, TV_DIRECTPAYMSGSUB_SX.S_DEMO, "
        + "TV_DIRECTPAYMSGSUB_SX.TS_SYSUPDATE, TV_DIRECTPAYMSGSUB_SX.S_AGENCYCODE, TV_DIRECTPAYMSGSUB_SX.S_AGENCYNAME, TV_DIRECTPAYMSGSUB_SX.S_EXPFUNCNAME, TV_DIRECTPAYMSGSUB_SX.S_EXPFUNCCODE1, "
        + "TV_DIRECTPAYMSGSUB_SX.S_EXPFUNCNAME1, TV_DIRECTPAYMSGSUB_SX.S_EXPFUNCCODE2, TV_DIRECTPAYMSGSUB_SX.S_EXPFUNCNAME2, TV_DIRECTPAYMSGSUB_SX.S_EXPFUNCCODE3, TV_DIRECTPAYMSGSUB_SX.S_EXPFUNCNAME3, "
        + "TV_DIRECTPAYMSGSUB_SX.S_PROCATCODE, TV_DIRECTPAYMSGSUB_SX.S_PROCATNAME, TV_DIRECTPAYMSGSUB_SX.S_HOLD1, TV_DIRECTPAYMSGSUB_SX.S_HOLD2, TV_DIRECTPAYMSGSUB_SX.S_HOLD3, "
        + "TV_DIRECTPAYMSGSUB_SX.S_HOLD4 "
        + "FROM TV_DIRECTPAYMSGSUB_SX "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_DIRECTPAYMSGSUB_SX SET "
        + "S_ORGCODE =?,S_PACKAGENO =?,S_BUDGETUNITCODE =?,S_TAXTICKETNO =?,S_LINE =?, "
        + "S_OFYEAR =?,I_NOAFTERPACKAGE =?,S_FUNSUBJECTCODE =?,S_ECOSUBJECTCODE =?,N_MONEY =?, "
        + "S_ACCDATE =?,S_USERCODE =?,S_DEMO =?,TS_SYSUPDATE =CURRENT TIMESTAMP,S_AGENCYCODE =?, "
        + "S_AGENCYNAME =?,S_EXPFUNCNAME =?,S_EXPFUNCCODE1 =?,S_EXPFUNCNAME1 =?,S_EXPFUNCCODE2 =?, "
        + "S_EXPFUNCNAME2 =?,S_EXPFUNCCODE3 =?,S_EXPFUNCNAME3 =?,S_PROCATCODE =?,S_PROCATNAME =?, "
        + "S_HOLD1 =?,S_HOLD2 =?,S_HOLD3 =?,S_HOLD4 =? "
        + "WHERE "
        + "I_VOUSRLNO = ? AND I_DETAILSEQNO = ?"
        ;
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_DIRECTPAYMSGSUB_SX " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_DETAILSEQNO = ?"
        ;
  ...
  {
     TvDirectpaymsgsubSxDto dto = (TvDirectpaymsgsubSxDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(5, dto.getSbudgetunitcode());

          ps.setString(6, dto.getStaxticketno());

          ps.setString(7, dto.getSline());

          ps.setString(8, dto.getSofyear());

          if (dto.getInoafterpackage()==null)
            ps.setNull(9, java.sql.Types.INTEGER);
         else
            ps.setInt(9, dto.getInoafterpackage().intValue());
          ps.setString(10, dto.getSfunsubjectcode());

          ps.setString(11, dto.getSecosubjectcode());

          ps.setBigDecimal(12, dto.getNmoney());

          ps.setString(13, dto.getSaccdate());

          ps.setString(14, dto.getSusercode());

          ps.setString(15, dto.getSdemo());
          ...
          ps.setString(19, dto.getSexpfunccode1());

          ps.setString(20, dto.getSexpfuncname1());

          ps.setString(21, dto.getSexpfunccode2());

          ps.setString(22, dto.getSexpfuncname2());

          ps.setString(23, dto.getSexpfunccode3());

          ps.setString(24, dto.getSexpfuncname3());

          ps.setString(25, dto.getSprocatcode());

          ps.setString(26, dto.getSprocatname());

          ps.setString(27, dto.getShold1());

          ps.setString(28, dto.getShold2());

          ps.setString(29, dto.getShold3());

          ps.setString(30, dto.getShold4());
   ...
   */
	...
	*/
    ...
    {
        TvDirectpaymsgsubSxDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvDirectpaymsgsubSxDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvDirectpaymsgsubSxPK pk = (TvDirectpaymsgsubSxPK)_pk ;
    ...
    {
        TvDirectpaymsgsubSxPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvDirectpaymsgsubSxPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvDirectpaymsgsubSxPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TvDirectpaymsgsubSxDto[] dtos = new TvDirectpaymsgsubSxDto[0];
		    dtos = (TvDirectpaymsgsubSxDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvDirectpaymsgsubSxDto  dto = new  TvDirectpaymsgsubSxDto ();
             //I_VOUSRLNO
             ...
             //I_NOAFTERPACKAGE
             str = rs.getString("I_NOAFTERPACKAGE");
             if(str!=null){
                dto.setInoafterpackage(new Integer(str));
             }
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            if (dto.getInoafterpackage()==null)
                ...
                ps.setInt(pos, dto.getInoafterpackage().intValue());
            pos++;
    ...
    */
    ...
    {
                                                                                       		throw new SQLException("数据库表：TV_DIRECTPAYMSGSUB_SX没有检查修改的字段");
    }
