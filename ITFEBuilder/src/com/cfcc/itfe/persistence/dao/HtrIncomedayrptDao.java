...
/**
 * <p>Title: DAO of table: HTR_INCOMEDAYRPT</p>
...
public class HtrIncomedayrptDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTR_INCOMEDAYRPT ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTR_INCOMEDAYRPT.S_FINORGCODE, HTR_INCOMEDAYRPT.S_TAXORGCODE, HTR_INCOMEDAYRPT.S_TRECODE, HTR_INCOMEDAYRPT.S_RPTDATE, HTR_INCOMEDAYRPT.S_BUDGETTYPE, "
        + "HTR_INCOMEDAYRPT.S_BUDGETLEVELCODE, HTR_INCOMEDAYRPT.S_BUDGETSUBCODE, HTR_INCOMEDAYRPT.S_BUDGETSUBNAME, HTR_INCOMEDAYRPT.N_MONEYDAY, HTR_INCOMEDAYRPT.N_MONEYTENDAY, "
        + "HTR_INCOMEDAYRPT.N_MONEYMONTH, HTR_INCOMEDAYRPT.N_MONEYQUARTER, HTR_INCOMEDAYRPT.N_MONEYYEAR, HTR_INCOMEDAYRPT.S_BELONGFLAG, HTR_INCOMEDAYRPT.S_TRIMFLAG, "
        + "HTR_INCOMEDAYRPT.S_DIVIDEGROUP, HTR_INCOMEDAYRPT.S_BILLKIND "
        + "FROM HTR_INCOMEDAYRPT "
        +" WHERE " 
  ...
  {
     HtrIncomedayrptDto dto = (HtrIncomedayrptDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtrIncomedayrptDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtrIncomedayrptDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtrIncomedayrptPK pk = (HtrIncomedayrptPK)_pk ;
    ...
    {
        HtrIncomedayrptPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtrIncomedayrptPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtrIncomedayrptPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            HtrIncomedayrptDto[] dtos = new HtrIncomedayrptDto[0];
		    dtos = (HtrIncomedayrptDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtrIncomedayrptDto  dto = new  HtrIncomedayrptDto ();
             //S_FINORGCODE
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                     		throw new SQLException("数据库表：HTR_INCOMEDAYRPT没有检查修改的字段");
    }
