...
/**
 * <p>Title: DAO of table: TV_GRANTPAYMSGMAIN_SX</p>
...
public class TvGrantpaymsgmainSxDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_GRANTPAYMSGMAIN_SX ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_GRANTPAYMSGMAIN_SX.I_VOUSRLNO, TV_GRANTPAYMSGMAIN_SX.S_ORGCODE, TV_GRANTPAYMSGMAIN_SX.S_LIMITID, TV_GRANTPAYMSGMAIN_SX.S_COMMITDATE, TV_GRANTPAYMSGMAIN_SX.S_ACCDATE, "
        + "TV_GRANTPAYMSGMAIN_SX.S_FILENAME, TV_GRANTPAYMSGMAIN_SX.S_TRECODE, TV_GRANTPAYMSGMAIN_SX.S_PACKAGENO, TV_GRANTPAYMSGMAIN_SX.S_PAYUNIT, TV_GRANTPAYMSGMAIN_SX.S_TRANSBANKCODE, "
        + "TV_GRANTPAYMSGMAIN_SX.N_MONEY, TV_GRANTPAYMSGMAIN_SX.S_PACKAGETICKETNO, TV_GRANTPAYMSGMAIN_SX.S_GENTICKETDATE, TV_GRANTPAYMSGMAIN_SX.S_OFYEAR, TV_GRANTPAYMSGMAIN_SX.S_OFMONTH, "
        + "TV_GRANTPAYMSGMAIN_SX.S_TRANSACTUNIT, TV_GRANTPAYMSGMAIN_SX.S_AMTTYPE, TV_GRANTPAYMSGMAIN_SX.S_USERCODE, TV_GRANTPAYMSGMAIN_SX.S_STATUS, TV_GRANTPAYMSGMAIN_SX.S_DEMO, "
        + "TV_GRANTPAYMSGMAIN_SX.TS_SYSUPDATE, TV_GRANTPAYMSGMAIN_SX.S_DEALNO, TV_GRANTPAYMSGMAIN_SX.S_BUDGETUNITCODE, TV_GRANTPAYMSGMAIN_SX.S_BUDGETTYPE, TV_GRANTPAYMSGMAIN_SX.S_ID, "
        + "TV_GRANTPAYMSGMAIN_SX.S_DEPTNUM, TV_GRANTPAYMSGMAIN_SX.S_FUNDTYPECODE, TV_GRANTPAYMSGMAIN_SX.S_FUNDTYPENAME, TV_GRANTPAYMSGMAIN_SX.S_CLEARBANKCODE, TV_GRANTPAYMSGMAIN_SX.S_CLEARBANKNAME, "
        + "TV_GRANTPAYMSGMAIN_SX.S_PAYBANKCODE, TV_GRANTPAYMSGMAIN_SX.S_PAYBANKNAME, TV_GRANTPAYMSGMAIN_SX.S_PAYBANKNO, TV_GRANTPAYMSGMAIN_SX.S_XACCTDATE, TV_GRANTPAYMSGMAIN_SX.S_HOLD1, "
        + "TV_GRANTPAYMSGMAIN_SX.S_HOLD2 "
        + "FROM TV_GRANTPAYMSGMAIN_SX "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_GRANTPAYMSGMAIN_SX SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_GRANTPAYMSGMAIN_SX " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND S_PACKAGETICKETNO = ?"
        ;
  ...
  {
     TvGrantpaymsgmainSxDto dto = (TvGrantpaymsgmainSxDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvGrantpaymsgmainSxDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvGrantpaymsgmainSxDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvGrantpaymsgmainSxPK pk = (TvGrantpaymsgmainSxPK)_pk ;
    ...
    {
        TvGrantpaymsgmainSxPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvGrantpaymsgmainSxPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvGrantpaymsgmainSxPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TvGrantpaymsgmainSxDto[] dtos = new TvGrantpaymsgmainSxDto[0];
		    dtos = (TvGrantpaymsgmainSxDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvGrantpaymsgmainSxDto  dto = new  TvGrantpaymsgmainSxDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                      		throw new SQLException("数据库表：TV_GRANTPAYMSGMAIN_SX没有检查修改的字段");
    }
