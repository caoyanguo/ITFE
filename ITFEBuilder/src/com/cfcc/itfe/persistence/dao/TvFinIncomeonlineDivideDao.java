...
/**
 * <p>Title: DAO of table: TV_FIN_INCOMEONLINE_DIVIDE</p>
...
public class TvFinIncomeonlineDivideDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_FIN_INCOMEONLINE_DIVIDE ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_ORGCODE, TV_FIN_INCOMEONLINE_DIVIDE.S_APPLYDATE, TV_FIN_INCOMEONLINE_DIVIDE.S_PACKNO, TV_FIN_INCOMEONLINE_DIVIDE.S_TRECODE, TV_FIN_INCOMEONLINE_DIVIDE.S_TRENAME, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_TAXORGCODE, TV_FIN_INCOMEONLINE_DIVIDE.S_PAYBNKNO, TV_FIN_INCOMEONLINE_DIVIDE.S_TRANO, TV_FIN_INCOMEONLINE_DIVIDE.S_ORIMSGNO, TV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_PAYEROPNBNKNO, TV_FIN_INCOMEONLINE_DIVIDE.PAYEROPBKNAME, TV_FIN_INCOMEONLINE_DIVIDE.S_HANDORGNAME, TV_FIN_INCOMEONLINE_DIVIDE.S_PAYERACCT, TV_FIN_INCOMEONLINE_DIVIDE.S_TAXVOUNO, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_BILLDATE, TV_FIN_INCOMEONLINE_DIVIDE.S_TAXPAYCODE, TV_FIN_INCOMEONLINE_DIVIDE.S_TAXPAYNAME, TV_FIN_INCOMEONLINE_DIVIDE.C_BDGKIND, TV_FIN_INCOMEONLINE_DIVIDE.C_TRIMFLAG, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_ETPCODE, TV_FIN_INCOMEONLINE_DIVIDE.S_ETPNAME, TV_FIN_INCOMEONLINE_DIVIDE.S_ETPTYPE, TV_FIN_INCOMEONLINE_DIVIDE.S_BDGSBTCODE, TV_FIN_INCOMEONLINE_DIVIDE.S_BDGSBTNAME, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_LIMIT, TV_FIN_INCOMEONLINE_DIVIDE.S_TAXTYPECODE, TV_FIN_INCOMEONLINE_DIVIDE.S_TAXKINDNAME, TV_FIN_INCOMEONLINE_DIVIDE.C_BDGLEVEL, TV_FIN_INCOMEONLINE_DIVIDE.C_BDGLEVELNAME, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_TAXSTARTDATE, TV_FIN_INCOMEONLINE_DIVIDE.S_TAXENDDATE, TV_FIN_INCOMEONLINE_DIVIDE.S_ASTFLAG, TV_FIN_INCOMEONLINE_DIVIDE.C_TAXTYPE, TV_FIN_INCOMEONLINE_DIVIDE.S_ACCT, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.S_TRASTATE, TV_FIN_INCOMEONLINE_DIVIDE.S_REMARK, TV_FIN_INCOMEONLINE_DIVIDE.S_REMARK1, TV_FIN_INCOMEONLINE_DIVIDE.S_REMARK2, TV_FIN_INCOMEONLINE_DIVIDE.S_INPUTERID, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.TS_SYSUPDATE, TV_FIN_INCOMEONLINE_DIVIDE.S_AFTTRECODE, TV_FIN_INCOMEONLINE_DIVIDE.S_AFTTAXORGCODE, TV_FIN_INCOMEONLINE_DIVIDE.C_AFTBDGLEVEL, TV_FIN_INCOMEONLINE_DIVIDE.S_AFTBDGSBTCODE, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.C_AFTBDGTYPE, TV_FIN_INCOMEONLINE_DIVIDE.S_AFTASTFLAG, TV_FIN_INCOMEONLINE_DIVIDE.F_JOINDIVIDERATE, TV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT_DIVIDE, TV_FIN_INCOMEONLINE_DIVIDE.S_AMTCHECKFLAG, "
        + "TV_FIN_INCOMEONLINE_DIVIDE.C_GOVERNRALATION, TV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT_DIVIDE2, TV_FIN_INCOMEONLINE_DIVIDE.F_TRAAMT_DIVIDE3, TV_FIN_INCOMEONLINE_DIVIDE.S_SEQ "
        + "FROM TV_FIN_INCOMEONLINE_DIVIDE "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_FIN_INCOMEONLINE_DIVIDE SET "
        + "S_ORGCODE =?,S_APPLYDATE =?,S_PACKNO =?,S_TRECODE =?,S_TRENAME =?, "
        + "S_TAXORGCODE =?,S_PAYBNKNO =?,S_TRANO =?,S_ORIMSGNO =?,F_TRAAMT =?, "
        + "S_PAYEROPNBNKNO =?,PAYEROPBKNAME =?,S_HANDORGNAME =?,S_PAYERACCT =?,S_TAXVOUNO =?, "
        + "S_BILLDATE =?,S_TAXPAYCODE =?,S_TAXPAYNAME =?,C_BDGKIND =?,C_TRIMFLAG =?, "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_FIN_INCOMEONLINE_DIVIDE " 
        + " WHERE "
        + "S_AFTTRECODE = ? AND S_SEQ = ?"
        ;
  ...
  {
     TvFinIncomeonlineDivideDto dto = (TvFinIncomeonlineDivideDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvFinIncomeonlineDivideDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvFinIncomeonlineDivideDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvFinIncomeonlineDividePK pk = (TvFinIncomeonlineDividePK)_pk ;
    ...
    {
        TvFinIncomeonlineDividePK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvFinIncomeonlineDividePK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvFinIncomeonlineDividePK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TvFinIncomeonlineDivideDto[] dtos = new TvFinIncomeonlineDivideDto[0];
		    dtos = (TvFinIncomeonlineDivideDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvFinIncomeonlineDivideDto  dto = new  TvFinIncomeonlineDivideDto ();
             //S_ORGCODE
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                                            		throw new SQLException("数据库表：TV_FIN_INCOMEONLINE_DIVIDE没有检查修改的字段");
    }
