...
/**
 * <p>Title: DAO of table: TV_PAYOUTMSGSUB_SX</p>
...
public class TvPayoutmsgsubSxDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_PAYOUTMSGSUB_SX ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_PAYOUTMSGSUB_SX.S_BIZNO, TV_PAYOUTMSGSUB_SX.S_SEQNO, TV_PAYOUTMSGSUB_SX.S_ACCDATE, TV_PAYOUTMSGSUB_SX.S_ECNOMICSUBJECTCODE, TV_PAYOUTMSGSUB_SX.S_BUDGETPRJCODE, "
        + "TV_PAYOUTMSGSUB_SX.N_MONEY, TV_PAYOUTMSGSUB_SX.S_FUNSUBJECTCODE, TV_PAYOUTMSGSUB_SX.TS_SYSUPDATE, TV_PAYOUTMSGSUB_SX.S_TAXTICKETNO, TV_PAYOUTMSGSUB_SX.S_BGTTYPECODE, "
        + "TV_PAYOUTMSGSUB_SX.S_BGTTYPENAME, TV_PAYOUTMSGSUB_SX.S_PROCATCODE, TV_PAYOUTMSGSUB_SX.S_PROCATNAME, TV_PAYOUTMSGSUB_SX.S_AGENCYCODE, TV_PAYOUTMSGSUB_SX.S_AGENCYNAME, "
        + "TV_PAYOUTMSGSUB_SX.S_EXPFUNCNAME, TV_PAYOUTMSGSUB_SX.S_EXPFUNCCODE1, TV_PAYOUTMSGSUB_SX.S_EXPFUNCNAME1, TV_PAYOUTMSGSUB_SX.S_EXPFUNCCODE2, TV_PAYOUTMSGSUB_SX.S_EXPFUNCNAME2, "
        + "TV_PAYOUTMSGSUB_SX.S_EXPFUNCCODE3, TV_PAYOUTMSGSUB_SX.S_EXPFUNCNAME3, TV_PAYOUTMSGSUB_SX.S_EXPECOCODE, TV_PAYOUTMSGSUB_SX.S_EXPECONAME, TV_PAYOUTMSGSUB_SX.S_EXPECOCODE1, "
        + "TV_PAYOUTMSGSUB_SX.S_EXPECONAME1, TV_PAYOUTMSGSUB_SX.S_EXPECOCODE2, TV_PAYOUTMSGSUB_SX.S_EXPECONAME2, TV_PAYOUTMSGSUB_SX.S_HOLD1, TV_PAYOUTMSGSUB_SX.S_HOLD2, "
        + "TV_PAYOUTMSGSUB_SX.S_HOLD3, TV_PAYOUTMSGSUB_SX.S_HOLD4 "
        + "FROM TV_PAYOUTMSGSUB_SX "
        +" WHERE " 
        + "S_BIZNO = ? AND S_SEQNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_PAYOUTMSGSUB_SX " 
        + " WHERE "
        + "S_BIZNO = ? AND S_SEQNO = ?"
        ;
  ...
  {
     TvPayoutmsgsubSxDto dto = (TvPayoutmsgsubSxDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvPayoutmsgsubSxDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvPayoutmsgsubSxDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvPayoutmsgsubSxPK pk = (TvPayoutmsgsubSxPK)_pk ;
    ...
    {
        TvPayoutmsgsubSxPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvPayoutmsgsubSxPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvPayoutmsgsubSxPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TvPayoutmsgsubSxDto[] dtos = new TvPayoutmsgsubSxDto[0];
		    dtos = (TvPayoutmsgsubSxDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvPayoutmsgsubSxDto  dto = new  TvPayoutmsgsubSxDto ();
             //S_BIZNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                          		throw new SQLException("数据库表：TV_PAYOUTMSGSUB_SX没有检查修改的字段");
    }
