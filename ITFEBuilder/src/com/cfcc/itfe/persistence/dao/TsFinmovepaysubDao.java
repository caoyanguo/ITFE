...
/**
 * <p>Title: DAO of table: TS_FINMOVEPAYSUB</p>
...
public class TsFinmovepaysubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TS_FINMOVEPAYSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TS_FINMOVEPAYSUB.S_ORGCODE, TS_FINMOVEPAYSUB.S_SUBJECTCODE, TS_FINMOVEPAYSUB.S_SUBJECTNAME "
        + "FROM TS_FINMOVEPAYSUB "
        +" WHERE " 
  ...
  {
     TsFinmovepaysubDto dto = (TsFinmovepaysubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TsFinmovepaysubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TsFinmovepaysubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TsFinmovepaysubPK pk = (TsFinmovepaysubPK)_pk ;
    ...
    {
        TsFinmovepaysubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TsFinmovepaysubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TsFinmovepaysubPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TsFinmovepaysubDto[] dtos = new TsFinmovepaysubDto[0];
		    dtos = (TsFinmovepaysubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
   		throw new SQLException("数据库表：TS_FINMOVEPAYSUB没有检查修改的字段");
    }
