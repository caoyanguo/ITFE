...
import com.cfcc.itfe.persistence.dto.HtfReportDepositMainDto ;
import com.cfcc.itfe.persistence.pk.HtfReportDepositMainPK ;


/**
 * <p>Title: DAO of table: HTF_REPORT_DEPOSIT_MAIN</p>
 * <p>Description:库款账户对帐主表历史表3513 Data Access Object  </p>
...
public class HtfReportDepositMainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_REPORT_DEPOSIT_MAIN ("
          + "I_VOUSRLNO,S_ORGCODE,S_TRECODE,S_STATUS,S_DEMO"
          + ",TS_SYSUPDATE,S_PACKAGENO,S_ADMDIVCODE,S_STYEAR,S_VTCODE"
          + ",S_VOUDATE,S_VOUCHERNO,S_VOUCHERCHECKNO,S_TRENAME,S_ACCTNO"
          + ",S_ACCTNAME,S_BEGINDATE,S_ENDDATE,S_ALLNUM,N_ACCTAMT"
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_REPORT_DEPOSIT_MAIN.I_VOUSRLNO, HTF_REPORT_DEPOSIT_MAIN.S_ORGCODE, HTF_REPORT_DEPOSIT_MAIN.S_TRECODE, HTF_REPORT_DEPOSIT_MAIN.S_STATUS, HTF_REPORT_DEPOSIT_MAIN.S_DEMO, "
        + "HTF_REPORT_DEPOSIT_MAIN.TS_SYSUPDATE, HTF_REPORT_DEPOSIT_MAIN.S_PACKAGENO, HTF_REPORT_DEPOSIT_MAIN.S_ADMDIVCODE, HTF_REPORT_DEPOSIT_MAIN.S_STYEAR, HTF_REPORT_DEPOSIT_MAIN.S_VTCODE, "
        + "HTF_REPORT_DEPOSIT_MAIN.S_VOUDATE, HTF_REPORT_DEPOSIT_MAIN.S_VOUCHERNO, HTF_REPORT_DEPOSIT_MAIN.S_VOUCHERCHECKNO, HTF_REPORT_DEPOSIT_MAIN.S_TRENAME, HTF_REPORT_DEPOSIT_MAIN.S_ACCTNO, "
        + "HTF_REPORT_DEPOSIT_MAIN.S_ACCTNAME, HTF_REPORT_DEPOSIT_MAIN.S_BEGINDATE, HTF_REPORT_DEPOSIT_MAIN.S_ENDDATE, HTF_REPORT_DEPOSIT_MAIN.S_ALLNUM, HTF_REPORT_DEPOSIT_MAIN.N_ACCTAMT, "
        + "HTF_REPORT_DEPOSIT_MAIN.S_XCHECKRESULT, HTF_REPORT_DEPOSIT_MAIN.S_XDIFFNUM, HTF_REPORT_DEPOSIT_MAIN.S_HOLD1, HTF_REPORT_DEPOSIT_MAIN.S_HOLD2, HTF_REPORT_DEPOSIT_MAIN.S_EXT1, "
        + "HTF_REPORT_DEPOSIT_MAIN.S_EXT2, HTF_REPORT_DEPOSIT_MAIN.S_EXT3, HTF_REPORT_DEPOSIT_MAIN.S_EXT4, HTF_REPORT_DEPOSIT_MAIN.S_EXT5 "
        + "FROM HTF_REPORT_DEPOSIT_MAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTF_REPORT_DEPOSIT_MAIN SET "
        + "S_ORGCODE =?,S_TRECODE =?,S_STATUS =?,S_DEMO =?,TS_SYSUPDATE =CURRENT TIMESTAMP, "
        + "S_PACKAGENO =?,S_ADMDIVCODE =?,S_STYEAR =?,S_VTCODE =?,S_VOUDATE =?, "
        + "S_VOUCHERNO =?,S_VOUCHERCHECKNO =?,S_TRENAME =?,S_ACCTNO =?,S_ACCTNAME =?, "
        + "S_BEGINDATE =?,S_ENDDATE =?,S_ALLNUM =?,N_ACCTAMT =?,S_XCHECKRESULT =?, "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_REPORT_DEPOSIT_MAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     HtfReportDepositMainDto dto = (HtfReportDepositMainDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(13, dto.getStrename());

          ps.setString(14, dto.getSacctno());

          ps.setString(15, dto.getSacctname());

          ps.setString(16, dto.getSbegindate());

          ps.setString(17, dto.getSenddate());

          ps.setString(18, dto.getSallnum());

          ps.setBigDecimal(19, dto.getNacctamt());

          ps.setString(20, dto.getSxcheckresult());

          ps.setString(21, dto.getSxdiffnum());
   ...
   */
	...
	*/
    ...
    {
        HtfReportDepositMainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfReportDepositMainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfReportDepositMainPK pk = (HtfReportDepositMainPK)_pk ;
    ...
    {
        HtfReportDepositMainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfReportDepositMainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfReportDepositMainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfReportDepositMainDto[] dtos = new HtfReportDepositMainDto[0];
		    dtos = (HtfReportDepositMainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfReportDepositMainDto  dto = new  HtfReportDepositMainDto ();
             //I_VOUSRLNO
           ...
           dto.setTssysupdate(rs.getTimestamp("TS_SYSUPDATE"));
             ...
             //S_ACCTNO
             str = rs.getString("S_ACCTNO");
             if (str == null)
                dto.setSacctno(null);
             else
                dto.setSacctno(str.trim());

             //S_ACCTNAME
             str = rs.getString("S_ACCTNAME");
             if (str == null)
                dto.setSacctname(null);
             else
                dto.setSacctname(str.trim());
             ...
             //N_ACCTAMT
           dto.setNacctamt(rs.getBigDecimal("N_ACCTAMT"));
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            //S_ACCTNO
            ps.setString(pos, dto.getSacctno());
            pos++;

            //S_ACCTNAME
            ps.setString(pos, dto.getSacctname());
            pos++;
            ...
            //N_ACCTAMT
            ps.setBigDecimal(pos, dto.getNacctamt());
            pos++;
    ...
    */
    ...
    {
                                                                                    		throw new SQLException("数据库表：HTF_REPORT_DEPOSIT_MAIN没有检查修改的字段");
    }
