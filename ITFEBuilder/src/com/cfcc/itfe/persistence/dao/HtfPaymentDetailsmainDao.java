...
/**
 * <p>Title: DAO of table: HTF_PAYMENT_DETAILSMAIN</p>
...
public class HtfPaymentDetailsmainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_PAYMENT_DETAILSMAIN ("
          ...
          + ",S_EXT5,S_FUNDTYPECODE,S_FUNDTYPENAME,S_PAYDICTATENO,S_PAYMSGNO"
          + ",S_PAYENTRUSTDATE,S_PAYSNDBNKNO"
        + ") VALUES ("
        + "?,?,?,?,?,?,CURRENT TIMESTAMP ,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_PAYMENT_DETAILSMAIN.I_VOUSRLNO, HTF_PAYMENT_DETAILSMAIN.S_ORGCODE, HTF_PAYMENT_DETAILSMAIN.S_TRECODE, HTF_PAYMENT_DETAILSMAIN.S_STATUS, HTF_PAYMENT_DETAILSMAIN.S_DEMO, "
        + "HTF_PAYMENT_DETAILSMAIN.S_FILENAME, HTF_PAYMENT_DETAILSMAIN.TS_SYSUPDATE, HTF_PAYMENT_DETAILSMAIN.S_PACKAGENO, HTF_PAYMENT_DETAILSMAIN.S_ADMDIVCODE, HTF_PAYMENT_DETAILSMAIN.S_STYEAR, "
        + "HTF_PAYMENT_DETAILSMAIN.S_VTCODE, HTF_PAYMENT_DETAILSMAIN.S_VOUDATE, HTF_PAYMENT_DETAILSMAIN.S_VOUCHERNO, HTF_PAYMENT_DETAILSMAIN.S_ORIGINALVTCODE, HTF_PAYMENT_DETAILSMAIN.S_ORIGINALVOUCHERNO, "
        + "HTF_PAYMENT_DETAILSMAIN.N_SUMAMT, HTF_PAYMENT_DETAILSMAIN.S_AGENCYCODE, HTF_PAYMENT_DETAILSMAIN.S_AGENCYNAME, HTF_PAYMENT_DETAILSMAIN.S_PAYACCTNO, HTF_PAYMENT_DETAILSMAIN.S_PAYACCTNAME, "
        + "HTF_PAYMENT_DETAILSMAIN.S_PAYACCTBANKNAME, HTF_PAYMENT_DETAILSMAIN.S_PAYBANKCODE, HTF_PAYMENT_DETAILSMAIN.S_PAYBANKNAME, HTF_PAYMENT_DETAILSMAIN.S_BUSINESSTYPECODE, HTF_PAYMENT_DETAILSMAIN.S_BUSINESSTYPENAME, "
        + "HTF_PAYMENT_DETAILSMAIN.S_PAYTYPECODE, HTF_PAYMENT_DETAILSMAIN.S_PAYTYPENAME, HTF_PAYMENT_DETAILSMAIN.S_XPAYDATE, HTF_PAYMENT_DETAILSMAIN.N_XSUMAMT, HTF_PAYMENT_DETAILSMAIN.S_HOLD1, "
        + "HTF_PAYMENT_DETAILSMAIN.S_HOLD2, HTF_PAYMENT_DETAILSMAIN.S_EXT1, HTF_PAYMENT_DETAILSMAIN.S_EXT2, HTF_PAYMENT_DETAILSMAIN.S_EXT3, HTF_PAYMENT_DETAILSMAIN.S_EXT4, "
        + "HTF_PAYMENT_DETAILSMAIN.S_EXT5, HTF_PAYMENT_DETAILSMAIN.S_FUNDTYPECODE, HTF_PAYMENT_DETAILSMAIN.S_FUNDTYPENAME, HTF_PAYMENT_DETAILSMAIN.S_PAYDICTATENO, HTF_PAYMENT_DETAILSMAIN.S_PAYMSGNO, "
        + "HTF_PAYMENT_DETAILSMAIN.S_PAYENTRUSTDATE, HTF_PAYMENT_DETAILSMAIN.S_PAYSNDBNKNO "
        + "FROM HTF_PAYMENT_DETAILSMAIN "
        +" WHERE " 
        + "I_VOUSRLNO = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTF_PAYMENT_DETAILSMAIN SET "
        + "S_ORGCODE =?,S_TRECODE =?,S_STATUS =?,S_DEMO =?,S_FILENAME =?, "
        + "TS_SYSUPDATE =CURRENT TIMESTAMP,S_PACKAGENO =?,S_ADMDIVCODE =?,S_STYEAR =?,S_VTCODE =?, "
        + "S_VOUDATE =?,S_VOUCHERNO =?,S_ORIGINALVTCODE =?,S_ORIGINALVOUCHERNO =?,N_SUMAMT =?, "
        + "S_AGENCYCODE =?,S_AGENCYNAME =?,S_PAYACCTNO =?,S_PAYACCTNAME =?,S_PAYACCTBANKNAME =?, "
        + "S_PAYBANKCODE =?,S_PAYBANKNAME =?,S_BUSINESSTYPECODE =?,S_BUSINESSTYPENAME =?,S_PAYTYPECODE =?, "
        + "S_PAYTYPENAME =?,S_XPAYDATE =?,N_XSUMAMT =?,S_HOLD1 =?,S_HOLD2 =?, "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_PAYMENT_DETAILSMAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ?"
        ;
  ...
  {
     HtfPaymentDetailsmainDto dto = (HtfPaymentDetailsmainDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setBigDecimal(15, dto.getNsumamt());

          ps.setString(16, dto.getSagencycode());

          ps.setString(17, dto.getSagencyname());

          ps.setString(18, dto.getSpayacctno());

          ps.setString(19, dto.getSpayacctname());

          ps.setString(20, dto.getSpayacctbankname());

          ps.setString(21, dto.getSpaybankcode());

          ps.setString(22, dto.getSpaybankname());

          ps.setString(23, dto.getSbusinesstypecode());

          ps.setString(24, dto.getSbusinesstypename());

          ps.setString(25, dto.getSpaytypecode());

          ps.setString(26, dto.getSpaytypename());

          ps.setString(27, dto.getSxpaydate());

          ps.setBigDecimal(28, dto.getNxsumamt());

          ps.setString(29, dto.getShold1());

          ps.setString(30, dto.getShold2());

          ps.setString(31, dto.getSext1());

          ps.setString(32, dto.getSext2());

          ps.setString(33, dto.getSext3());

          ps.setString(34, dto.getSext4());

          ps.setString(35, dto.getSext5());

          ps.setString(36, dto.getSfundtypecode());

          ps.setString(37, dto.getSfundtypename());

          ps.setString(38, dto.getSpaydictateno());

          ps.setString(39, dto.getSpaymsgno());

          ps.setString(40, dto.getSpayentrustdate());

          ps.setString(41, dto.getSpaysndbnkno());
   ...
   */
	...
	*/
    ...
    {
        HtfPaymentDetailsmainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfPaymentDetailsmainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfPaymentDetailsmainPK pk = (HtfPaymentDetailsmainPK)_pk ;
    ...
    {
        HtfPaymentDetailsmainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfPaymentDetailsmainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfPaymentDetailsmainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfPaymentDetailsmainDto[] dtos = new HtfPaymentDetailsmainDto[0];
		    dtos = (HtfPaymentDetailsmainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfPaymentDetailsmainDto  dto = new  HtfPaymentDetailsmainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                           		throw new SQLException("数据库表：HTF_PAYMENT_DETAILSMAIN没有检查修改的字段");
    }
