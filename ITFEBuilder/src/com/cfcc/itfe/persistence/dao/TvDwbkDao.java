...
/**
 * <p>Title: DAO of table: TV_DWBK</p>
...
public class TvDwbkDao  implements IDao
{
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_DWBK.I_VOUSRLNO, TV_DWBK.S_ELECVOUNO, TV_DWBK.S_DWBKVOUCODE, TV_DWBK.S_TAXORGCODE, TV_DWBK.S_AGENTTAXORGCODE, "
        + "TV_DWBK.S_PAYERTRECODE, TV_DWBK.S_AIMTRECODE, TV_DWBK.C_BDGKIND, TV_DWBK.C_BDGLEVEL, TV_DWBK.S_BDGSBTCODE, "
        + "TV_DWBK.S_DWBKREASONCODE, TV_DWBK.S_ASTFLAG, TV_DWBK.S_DWBKBY, TV_DWBK.F_DWBKRATIO, TV_DWBK.F_DWBKAMT, "
        + "TV_DWBK.S_EXAMORG, TV_DWBK.F_AMT, TV_DWBK.C_BCKFLAG, TV_DWBK.S_PAYEECODE, TV_DWBK.S_PAYEEACCT, "
        + "TV_DWBK.S_PAYEENAME, TV_DWBK.S_PAYEEOPNBNKNO, TV_DWBK.D_ACCEPT, TV_DWBK.D_ACCT, TV_DWBK.D_VOUCHER, "
        + "TV_DWBK.D_BILL, TV_DWBK.S_ETPCODE, TV_DWBK.S_ECOCODE, TV_DWBK.C_TRIMFLAG, TV_DWBK.S_BIZTYPE, "
        + "TV_DWBK.S_PACKAGENO, TV_DWBK.S_STATUS, TV_DWBK.S_DEALNO, TV_DWBK.S_FILENAME, TV_DWBK.S_BOOKORGCODE, "
        + "TV_DWBK.TS_SYSUPDATE, TV_DWBK.S_TBSASTFLAG, TV_DWBK.S_DEMO, TV_DWBK.S_BIZNO, TV_DWBK.S_RETURNREASONNAME, "
        + "TV_DWBK.S_FUNDTYPECODE, TV_DWBK.S_FUNDTYPENAME, TV_DWBK.S_CLEARBANKCODE, TV_DWBK.S_CLEARBANKNAME, TV_DWBK.XPAYAMT, "
        + "TV_DWBK.XAGENTBUSINESSNO, TV_DWBK.S_HOLD1, TV_DWBK.S_HOLD2, TV_DWBK.S_BGTTYPECODE, TV_DWBK.S_BGTTYPENAME, "
        + "TV_DWBK.S_PROCATCODE, TV_DWBK.S_PROCATNAME, TV_DWBK.S_AGENCYNAME, TV_DWBK.S_INCOMESORTNAME, TV_DWBK.S_INCOMESORTNAME1, "
        + "TV_DWBK.S_INCOMESORTNAME2, TV_DWBK.S_INCOMESORTNAME3, TV_DWBK.S_INCOMESORTNAME4, TV_DWBK.S_INCOMESORTCODE1, TV_DWBK.S_INCOMESORTCODE2, "
        + "TV_DWBK.S_INCOMESORTCODE3, TV_DWBK.S_INCOMESORTCODE4, TV_DWBK.S_DETAILHOLD1, TV_DWBK.S_DETAILHOLD2, TV_DWBK.S_DETAILHOLD3, "
        + "TV_DWBK.S_DETAILHOLD4, TV_DWBK.S_INPUTRECBANKNAME, TV_DWBK.S_INPUTRECBANKNO, TV_DWBK.S_PAYACCTNO, TV_DWBK.S_PAYACCTNAME, "
        + "TV_DWBK.S_PAYACCTBANKNAME, TV_DWBK.S_IFMATCH, TV_DWBK.S_CHECKSTATUS, TV_DWBK.S_RECBANKNAME, TV_DWBK.S_INPUTUSERCODE, "
        + "TV_DWBK.S_CHECKUSERCODE "
        + "FROM TV_DWBK "
        +" WHERE " 
   ...
   */
	...
	*/
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TvDwbkDto[] dtos = new TvDwbkDto[0];
		    dtos = (TvDwbkDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                                                                                                              		throw new SQLException("数据库表：TV_DWBK没有检查修改的字段");
    }
