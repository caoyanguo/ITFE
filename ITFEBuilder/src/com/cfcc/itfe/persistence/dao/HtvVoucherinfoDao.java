...
/**
 * <p>Title: DAO of table: HTV_VOUCHERINFO</p>
...
public class HtvVoucherinfoDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTV_VOUCHERINFO ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_VOUCHERINFO.S_DEALNO, HTV_VOUCHERINFO.S_ORGCODE, HTV_VOUCHERINFO.S_TRECODE, HTV_VOUCHERINFO.S_FILENAME, HTV_VOUCHERINFO.S_ADMDIVCODE, "
        + "HTV_VOUCHERINFO.S_STYEAR, HTV_VOUCHERINFO.S_VTCODE, HTV_VOUCHERINFO.S_VOUCHERNO, HTV_VOUCHERINFO.S_VOUCHERFLAG, HTV_VOUCHERINFO.S_ATTACH, "
        + "HTV_VOUCHERINFO.S_RETURNERRMSG, HTV_VOUCHERINFO.S_CREATDATE, HTV_VOUCHERINFO.N_MONEY, HTV_VOUCHERINFO.S_STATUS, HTV_VOUCHERINFO.S_CONFIRUSERCODE, "
        + "HTV_VOUCHERINFO.S_VERIFYUSERCODE, HTV_VOUCHERINFO.S_DEMO, HTV_VOUCHERINFO.S_STAMPID, HTV_VOUCHERINFO.S_PACKNO, HTV_VOUCHERINFO.I_COUNT, "
        + "HTV_VOUCHERINFO.N_CHECKMONEY, HTV_VOUCHERINFO.I_CHECKCOUNT, HTV_VOUCHERINFO.TS_SYSUPDATE, HTV_VOUCHERINFO.S_STAMPUSER, HTV_VOUCHERINFO.S_CHECKDATE, "
        + "HTV_VOUCHERINFO.S_CHECKVOUCHERTYPE, HTV_VOUCHERINFO.S_PAYBANKCODE, HTV_VOUCHERINFO.S_RECVTIME, HTV_VOUCHERINFO.S_HOLD1, HTV_VOUCHERINFO.S_HOLD2, "
        + "HTV_VOUCHERINFO.S_HOLD3, HTV_VOUCHERINFO.S_HOLD4, HTV_VOUCHERINFO.S_EXT1, HTV_VOUCHERINFO.S_EXT2, HTV_VOUCHERINFO.S_EXT3, "
        + "HTV_VOUCHERINFO.S_EXT4, HTV_VOUCHERINFO.S_EXT5 "
        + "FROM HTV_VOUCHERINFO "
        +" WHERE " 
        + "S_DEALNO = ?"
        ;
  ...
  {
     HtvVoucherinfoDto dto = (HtvVoucherinfoDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(32, dto.getSext1());

          ps.setString(33, dto.getSext2());

          ps.setString(34, dto.getSext3());

          ps.setString(35, dto.getSext4());

          ps.setString(36, dto.getSext5());
   ...
   */
	...
	*/
    ...
    {
        HtvVoucherinfoDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtvVoucherinfoDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtvVoucherinfoPK pk = (HtvVoucherinfoPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            HtvVoucherinfoDto[] dtos = new HtvVoucherinfoDto[0];
		    dtos = (HtvVoucherinfoDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtvVoucherinfoDto  dto = new  HtvVoucherinfoDto ();
             //S_DEALNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                            		throw new SQLException("数据库表：HTV_VOUCHERINFO没有检查修改的字段");
    }
