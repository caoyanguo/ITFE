...
import com.cfcc.itfe.persistence.dto.TdEnumtypeDto ;
import com.cfcc.itfe.persistence.pk.TdEnumtypePK ;


/**
 * <p>Title: DAO of table: TD_ENUMTYPE</p>
...
public class TdEnumtypeDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TD_ENUMTYPE ("
          + "S_TYPECODE,S_TYPENAME,S_OFCOLUMN,S_IFAVAILABLE,S_REMARK"
        + ") VALUES ("
        + "?,?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TD_ENUMTYPE.S_TYPECODE, TD_ENUMTYPE.S_TYPENAME, TD_ENUMTYPE.S_OFCOLUMN, TD_ENUMTYPE.S_IFAVAILABLE, TD_ENUMTYPE.S_REMARK "
        + "FROM TD_ENUMTYPE "
        +" WHERE " 
        + "S_TYPECODE = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TD_ENUMTYPE SET "
        + "S_TYPENAME =?,S_OFCOLUMN =?,S_IFAVAILABLE =?,S_REMARK =? "
        + "WHERE "
        + "S_TYPECODE = ?"
        ;
  ...
  {
     TdEnumtypeDto dto = (TdEnumtypeDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(2, dto.getStypename());

          ps.setString(3, dto.getSofcolumn());
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TdEnumtypePK pk = (TdEnumtypePK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TdEnumtypePK)(pks.get(i)) ; 
                   ps.setString((i-iBegin)*1+1, pk.getStypecode());
        ...
        if (results!=null && results.size() > 0)
        {
            TdEnumtypeDto[] dtos = new TdEnumtypeDto[0];
		    dtos = (TdEnumtypeDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TdEnumtypeDto  dto = new  TdEnumtypeDto ();
             //S_TYPECODE
             ...
             //S_TYPENAME
             str = rs.getString("S_TYPENAME");
             if (str == null)
                dto.setStypename(null);
             else
                dto.setStypename(str.trim());

             //S_OFCOLUMN
             str = rs.getString("S_OFCOLUMN");
             if (str == null)
                dto.setSofcolumn(null);
             else
                dto.setSofcolumn(str.trim());
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            int pos = 1;
            //S_TYPENAME
            ps.setString(pos, dto.getStypename());
            pos++;

            //S_OFCOLUMN
            ps.setString(pos, dto.getSofcolumn());
            pos++;
    ...
    */
    ...
    {
            		throw new SQLException("数据库表：TD_ENUMTYPE没有检查修改的字段");
    }
