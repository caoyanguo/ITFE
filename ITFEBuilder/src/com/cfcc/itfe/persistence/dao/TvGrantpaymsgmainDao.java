...
/**
 * <p>Title: DAO of table: TV_GRANTPAYMSGMAIN</p>
...
public class TvGrantpaymsgmainDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_GRANTPAYMSGMAIN ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_GRANTPAYMSGMAIN.I_VOUSRLNO, TV_GRANTPAYMSGMAIN.S_ORGCODE, TV_GRANTPAYMSGMAIN.S_LIMITID, TV_GRANTPAYMSGMAIN.S_COMMITDATE, TV_GRANTPAYMSGMAIN.S_ACCDATE, "
        + "TV_GRANTPAYMSGMAIN.S_FILENAME, TV_GRANTPAYMSGMAIN.S_TRECODE, TV_GRANTPAYMSGMAIN.S_PACKAGENO, TV_GRANTPAYMSGMAIN.S_PAYUNIT, TV_GRANTPAYMSGMAIN.S_TRANSBANKCODE, "
        + "TV_GRANTPAYMSGMAIN.N_MONEY, TV_GRANTPAYMSGMAIN.S_PACKAGETICKETNO, TV_GRANTPAYMSGMAIN.S_GENTICKETDATE, TV_GRANTPAYMSGMAIN.S_OFYEAR, TV_GRANTPAYMSGMAIN.S_OFMONTH, "
        + "TV_GRANTPAYMSGMAIN.S_TRANSACTUNIT, TV_GRANTPAYMSGMAIN.S_AMTTYPE, TV_GRANTPAYMSGMAIN.S_USERCODE, TV_GRANTPAYMSGMAIN.S_STATUS, TV_GRANTPAYMSGMAIN.S_DEMO, "
        + "TV_GRANTPAYMSGMAIN.TS_SYSUPDATE, TV_GRANTPAYMSGMAIN.S_DEALNO, TV_GRANTPAYMSGMAIN.S_BUDGETUNITCODE, TV_GRANTPAYMSGMAIN.S_BUDGETTYPE, TV_GRANTPAYMSGMAIN.S_ID, "
        + "TV_GRANTPAYMSGMAIN.S_DEPTNUM, TV_GRANTPAYMSGMAIN.S_FUNDTYPECODE, TV_GRANTPAYMSGMAIN.S_FUNDTYPENAME, TV_GRANTPAYMSGMAIN.S_CLEARBANKCODE, TV_GRANTPAYMSGMAIN.S_CLEARBANKNAME, "
        + "TV_GRANTPAYMSGMAIN.S_PAYBANKCODE, TV_GRANTPAYMSGMAIN.S_PAYBANKNAME, TV_GRANTPAYMSGMAIN.S_PAYBANKNO, TV_GRANTPAYMSGMAIN.S_XACCTDATE, TV_GRANTPAYMSGMAIN.S_HOLD1, "
        + "TV_GRANTPAYMSGMAIN.S_HOLD2, TV_GRANTPAYMSGMAIN.S_CLEARVOUCHERNO, TV_GRANTPAYMSGMAIN.N_XALLAMT "
        + "FROM TV_GRANTPAYMSGMAIN "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_GRANTPAYMSGMAIN " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND S_PACKAGETICKETNO = ?"
        ;
  ...
  {
     TvGrantpaymsgmainDto dto = (TvGrantpaymsgmainDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvGrantpaymsgmainDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvGrantpaymsgmainDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvGrantpaymsgmainPK pk = (TvGrantpaymsgmainPK)_pk ;
    ...
    {
        TvGrantpaymsgmainPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvGrantpaymsgmainPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvGrantpaymsgmainPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TvGrantpaymsgmainDto[] dtos = new TvGrantpaymsgmainDto[0];
		    dtos = (TvGrantpaymsgmainDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvGrantpaymsgmainDto  dto = new  TvGrantpaymsgmainDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                            		throw new SQLException("数据库表：TV_GRANTPAYMSGMAIN没有检查修改的字段");
    }
