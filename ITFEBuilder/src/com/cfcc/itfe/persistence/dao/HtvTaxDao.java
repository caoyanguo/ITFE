...
/**
 * <p>Title: DAO of table: HTV_TAX</p>
...
public class HtvTaxDao  implements IDao
{
    ...
    private static final String SQL_INSERT =
        "INSERT INTO HTV_TAX ("
          ...
          + ",C_RECKONTYPE,S_PROCSTAT,S_RESULT,S_STATUS,S_ADDWORD"
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTV_TAX.S_SEQ, HTV_TAX.S_TAXORGCODE, HTV_TAX.S_ENTRUSTDATE, HTV_TAX.S_TRANO, HTV_TAX.S_MSGID, "
        + "HTV_TAX.S_TAXVOUNO, HTV_TAX.C_HANDLETYPE, HTV_TAX.S_BILLDATE, HTV_TAX.C_BUDGETTYPE, HTV_TAX.S_PAYEEBANKNO, "
        + "HTV_TAX.S_PAYEEOPBKCODE, HTV_TAX.S_PAYEEACCT, HTV_TAX.S_PAYEENAME, HTV_TAX.S_PAYEEORGCODE, HTV_TAX.S_PAYBKCODE, "
        + "HTV_TAX.S_PAYOPBKCODE, HTV_TAX.S_PAYACCT, HTV_TAX.S_CORPCODE, HTV_TAX.S_PROTOCOLNO, HTV_TAX.S_CORPTYPE, "
        + "HTV_TAX.S_HANDORGNAME, HTV_TAX.S_TAXPAYCODE, HTV_TAX.S_TAXPAYNAME, HTV_TAX.C_PRINTFLAG, HTV_TAX.C_TRIMSIGN, "
        + "HTV_TAX.F_TRAAMT, HTV_TAX.S_REMARK, HTV_TAX.S_REMARK1, HTV_TAX.S_REMARK2, HTV_TAX.I_TAXKINDCOUNT, "
        + "HTV_TAX.C_RECKONTYPE, HTV_TAX.S_PROCSTAT, HTV_TAX.S_RESULT, HTV_TAX.S_STATUS, HTV_TAX.S_ADDWORD, "
        + "HTV_TAX.C_CANCELSTAT, HTV_TAX.S_CHKBATCH, HTV_TAX.S_EXPORTER, HTV_TAX.S_ACCEPTDATE, HTV_TAX.S_PAYDATE, "
        + "HTV_TAX.S_CHKDATE, HTV_TAX.TS_UPDATE "
        + "FROM HTV_TAX "
        +" WHERE " 
        + "S_SEQ = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        ...
        + "S_PROCSTAT =?,S_RESULT =?,S_STATUS =?,S_ADDWORD =?,C_CANCELSTAT =?, "
  ...
  public void create(IDto _dto,  Connection conn) throws SQLException
  {
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(33, dto.getSresult());

          ps.setString(34, dto.getSstatus());
   ...
   */
	...
	*/
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            HtvTaxDto[] dtos = new HtvTaxDto[0];
		    dtos = (HtvTaxDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                           		throw new SQLException("数据库表：HTV_TAX没有检查修改的字段");
    }
