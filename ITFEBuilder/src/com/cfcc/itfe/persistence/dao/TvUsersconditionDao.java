...
/**
 * <p>Title: DAO of table: TV_USERSCONDITION</p>
...
public class TvUsersconditionDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_USERSCONDITION ("
          + "S_ORGCODE,S_USERCODE,S_USERNAME,S_CONDITIONS"
        + ") VALUES ("
        + "?,?,?,?)";
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_USERSCONDITION.S_ORGCODE, TV_USERSCONDITION.S_USERCODE, TV_USERSCONDITION.S_USERNAME, TV_USERSCONDITION.S_CONDITIONS "
        + "FROM TV_USERSCONDITION "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_USERSCONDITION SET "
        + "S_USERNAME =?,S_CONDITIONS =? "
        + "WHERE "
        + "S_ORGCODE = ? AND S_USERCODE = ?"
        ;
  ...
  {
     TvUsersconditionDto dto = (TvUsersconditionDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(4, dto.getSconditions());
   ...
   */
	...
	*/
    ...
    {
        TvUsersconditionDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvUsersconditionDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvUsersconditionPK pk = (TvUsersconditionPK)_pk ;
    ...
    {
        TvUsersconditionPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvUsersconditionPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvUsersconditionPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TvUsersconditionDto[] dtos = new TvUsersconditionDto[0];
		    dtos = (TvUsersconditionDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvUsersconditionDto  dto = new  TvUsersconditionDto ();
             //S_ORGCODE
             ...
             //S_CONDITIONS
             str = rs.getString("S_CONDITIONS");
             if (str == null)
                dto.setSconditions(null);
             else
                dto.setSconditions(str.trim());
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            //S_CONDITIONS
            ps.setString(pos, dto.getSconditions());
            pos++;
    ...
    */
    ...
    {
      		throw new SQLException("数据库表：TV_USERSCONDITION没有检查修改的字段");
    }
