...
/**
 * <p>Title: DAO of table: TF_UNITRECORDSUB</p>
 * <p>Description:单位清册5951子表 Data Access Object  </p>
...
public class TfUnitrecordsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TF_UNITRECORDSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TF_UNITRECORDSUB.I_VOUSRLNO, TF_UNITRECORDSUB.I_SEQNO, TF_UNITRECORDSUB.S_ID, TF_UNITRECORDSUB.S_AGENCYCODE, TF_UNITRECORDSUB.S_AGENCYNAME, "
        + "TF_UNITRECORDSUB.S_FUNDTYPECODE, TF_UNITRECORDSUB.S_FUNDTYPENAME, TF_UNITRECORDSUB.S_AGENCYACCONO, TF_UNITRECORDSUB.S_AGENCYACCONAME, TF_UNITRECORDSUB.S_AGENCYBANKNAME, "
        + "TF_UNITRECORDSUB.S_ACCSTATUS, TF_UNITRECORDSUB.S_HOLD1, TF_UNITRECORDSUB.S_HOLD2, TF_UNITRECORDSUB.S_HOLD3, TF_UNITRECORDSUB.S_HOLD4, "
        + "TF_UNITRECORDSUB.S_EXT1, TF_UNITRECORDSUB.S_EXT2, TF_UNITRECORDSUB.S_EXT3 "
        + "FROM TF_UNITRECORDSUB "
        +" WHERE " 
  ...
  {
     TfUnitrecordsubDto dto = (TfUnitrecordsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TfUnitrecordsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TfUnitrecordsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TfUnitrecordsubPK pk = (TfUnitrecordsubPK)_pk ;
    ...
    {
        TfUnitrecordsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TfUnitrecordsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TfUnitrecordsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TfUnitrecordsubDto[] dtos = new TfUnitrecordsubDto[0];
		    dtos = (TfUnitrecordsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TfUnitrecordsubDto  dto = new  TfUnitrecordsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                		throw new SQLException("数据库表：TF_UNITRECORDSUB没有检查修改的字段");
    }
