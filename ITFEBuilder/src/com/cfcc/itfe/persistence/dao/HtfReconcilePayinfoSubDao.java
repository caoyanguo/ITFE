...
import com.cfcc.itfe.persistence.dto.HtfReconcilePayinfoSubDto ;
import com.cfcc.itfe.persistence.pk.HtfReconcilePayinfoSubPK ;


/**
 * <p>Title: DAO of table: HTF_RECONCILE_PAYINFO_SUB</p>
...
public class HtfReconcilePayinfoSubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_RECONCILE_PAYINFO_SUB ("
          + "I_VOUSRLNO,I_SEQNO,S_ID,S_PAYAGENTBILLNO,S_PAYDETAILID"
          + ",S_SUPDEPCODE,S_SUPDEPNAME,S_FUNDTYPECODE,S_FUNDTYPENAME,S_PAYBANKCODE"
          + ",S_PAYBANKNAME,S_PAYBANKNO,S_EXPFUNCCODE,S_EXPFUNCNAME,S_PROCATCODE"
          + ",S_PROCATNAME,S_PAYTYPECODE,S_PAYTYPENAME,N_PAYAMT,S_XCHECKRESULT"
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_RECONCILE_PAYINFO_SUB.I_VOUSRLNO, HTF_RECONCILE_PAYINFO_SUB.I_SEQNO, HTF_RECONCILE_PAYINFO_SUB.S_ID, HTF_RECONCILE_PAYINFO_SUB.S_PAYAGENTBILLNO, HTF_RECONCILE_PAYINFO_SUB.S_PAYDETAILID, "
        + "HTF_RECONCILE_PAYINFO_SUB.S_SUPDEPCODE, HTF_RECONCILE_PAYINFO_SUB.S_SUPDEPNAME, HTF_RECONCILE_PAYINFO_SUB.S_FUNDTYPECODE, HTF_RECONCILE_PAYINFO_SUB.S_FUNDTYPENAME, HTF_RECONCILE_PAYINFO_SUB.S_PAYBANKCODE, "
        + "HTF_RECONCILE_PAYINFO_SUB.S_PAYBANKNAME, HTF_RECONCILE_PAYINFO_SUB.S_PAYBANKNO, HTF_RECONCILE_PAYINFO_SUB.S_EXPFUNCCODE, HTF_RECONCILE_PAYINFO_SUB.S_EXPFUNCNAME, HTF_RECONCILE_PAYINFO_SUB.S_PROCATCODE, "
        + "HTF_RECONCILE_PAYINFO_SUB.S_PROCATNAME, HTF_RECONCILE_PAYINFO_SUB.S_PAYTYPECODE, HTF_RECONCILE_PAYINFO_SUB.S_PAYTYPENAME, HTF_RECONCILE_PAYINFO_SUB.N_PAYAMT, HTF_RECONCILE_PAYINFO_SUB.S_XCHECKRESULT, "
        + "HTF_RECONCILE_PAYINFO_SUB.S_XCHECKREASON, HTF_RECONCILE_PAYINFO_SUB.S_HOLD1, HTF_RECONCILE_PAYINFO_SUB.S_HOLD2, HTF_RECONCILE_PAYINFO_SUB.S_HOLD3, HTF_RECONCILE_PAYINFO_SUB.S_HOLD4, "
        + "HTF_RECONCILE_PAYINFO_SUB.S_EXT1, HTF_RECONCILE_PAYINFO_SUB.S_EXT2, HTF_RECONCILE_PAYINFO_SUB.S_EXT3, HTF_RECONCILE_PAYINFO_SUB.S_EXT4, HTF_RECONCILE_PAYINFO_SUB.S_EXT5 "
        + "FROM HTF_RECONCILE_PAYINFO_SUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTF_RECONCILE_PAYINFO_SUB SET "
        + "S_ID =?,S_PAYAGENTBILLNO =?,S_PAYDETAILID =?,S_SUPDEPCODE =?,S_SUPDEPNAME =?, "
        ...
        + "S_PAYTYPENAME =?,N_PAYAMT =?,S_XCHECKRESULT =?,S_XCHECKREASON =?,S_HOLD1 =?, "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_RECONCILE_PAYINFO_SUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_SEQNO = ?"
        ;
  ...
  {
     HtfReconcilePayinfoSubDto dto = (HtfReconcilePayinfoSubDto)_dto ;
     ...
     try
     {
         ps = conn.prepareStatement(SQL_INSERT);
          ...
          ps.setString(4, dto.getSpayagentbillno());

          ps.setString(5, dto.getSpaydetailid());

          ps.setString(6, dto.getSsupdepcode());

          ps.setString(7, dto.getSsupdepname());

          ps.setString(8, dto.getSfundtypecode());

          ps.setString(9, dto.getSfundtypename());
          ...
          ps.setString(13, dto.getSexpfunccode());

          ps.setString(14, dto.getSexpfuncname());

          ps.setString(15, dto.getSprocatcode());

          ps.setString(16, dto.getSprocatname());

          ps.setString(17, dto.getSpaytypecode());

          ps.setString(18, dto.getSpaytypename());

          ps.setBigDecimal(19, dto.getNpayamt());

          ps.setString(20, dto.getSxcheckresult());

          ps.setString(21, dto.getSxcheckreason());

          ps.setString(22, dto.getShold1());

          ps.setString(23, dto.getShold2());

          ps.setString(24, dto.getShold3());

          ps.setString(25, dto.getShold4());

          ps.setString(26, dto.getSext1());

          ps.setString(27, dto.getSext2());

          ps.setString(28, dto.getSext3());

          ps.setString(29, dto.getSext4());

          ps.setString(30, dto.getSext5());
   ...
   */
	...
	*/
    ...
    {
        HtfReconcilePayinfoSubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfReconcilePayinfoSubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfReconcilePayinfoSubPK pk = (HtfReconcilePayinfoSubPK)_pk ;
    ...
    {
        HtfReconcilePayinfoSubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfReconcilePayinfoSubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfReconcilePayinfoSubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfReconcilePayinfoSubDto[] dtos = new HtfReconcilePayinfoSubDto[0];
		    dtos = (HtfReconcilePayinfoSubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfReconcilePayinfoSubDto  dto = new  HtfReconcilePayinfoSubDto ();
             //I_VOUSRLNO
             ...
             //S_PAYAGENTBILLNO
             str = rs.getString("S_PAYAGENTBILLNO");
             if (str == null)
                dto.setSpayagentbillno(null);
             else
                dto.setSpayagentbillno(str.trim());
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    public void update(IDto _dto, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        try {
            ...
            //S_PAYAGENTBILLNO
            ps.setString(pos, dto.getSpayagentbillno());
            pos++;
    ...
    */
    ...
    {
                                                                                    		throw new SQLException("数据库表：HTF_RECONCILE_PAYINFO_SUB没有检查修改的字段");
    }
