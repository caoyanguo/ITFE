...
/**
 * <p>Title: DAO of table: TV_PAYOUT_DETAIL_LIST</p>
...
public class TvPayoutDetailListDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_PAYOUT_DETAIL_LIST ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_PAYOUT_DETAIL_LIST.S_ID, TV_PAYOUT_DETAIL_LIST.S_VOUCHERBILLID, TV_PAYOUT_DETAIL_LIST.S_PAYVOUCHERNO, TV_PAYOUT_DETAIL_LIST.S_FUNDTYPECODE, TV_PAYOUT_DETAIL_LIST.S_FUNDTYPENAME, "
        + "TV_PAYOUT_DETAIL_LIST.S_PAYTYPECODE, TV_PAYOUT_DETAIL_LIST.S_PAYTYPENAME, TV_PAYOUT_DETAIL_LIST.S_PAYEEACCTNO, TV_PAYOUT_DETAIL_LIST.S_PAYEEACCTNAME, TV_PAYOUT_DETAIL_LIST.S_PAYEEACCTBANKNAME, "
        + "TV_PAYOUT_DETAIL_LIST.S_PAYEEACCTBANKNO, TV_PAYOUT_DETAIL_LIST.S_PAYACCTNO, TV_PAYOUT_DETAIL_LIST.S_PAYACCTNAME, TV_PAYOUT_DETAIL_LIST.S_PAYACCTBANKNAME, TV_PAYOUT_DETAIL_LIST.S_AGENCYCODE, "
        + "TV_PAYOUT_DETAIL_LIST.S_AGENCYNAME, TV_PAYOUT_DETAIL_LIST.S_EXPFUNCCODE, TV_PAYOUT_DETAIL_LIST.S_EXPFUNCNAME, TV_PAYOUT_DETAIL_LIST.S_EXPECOCODE, TV_PAYOUT_DETAIL_LIST.S_EXPECONAME, "
        + "TV_PAYOUT_DETAIL_LIST.S_PAYSUMMARYCODE, TV_PAYOUT_DETAIL_LIST.S_PAYSUMMARYNAME, TV_PAYOUT_DETAIL_LIST.N_PAYAMT, TV_PAYOUT_DETAIL_LIST.D_PAYDATE, TV_PAYOUT_DETAIL_LIST.S_HOLD1, "
        + "TV_PAYOUT_DETAIL_LIST.S_HOLD2, TV_PAYOUT_DETAIL_LIST.S_HOLD3, TV_PAYOUT_DETAIL_LIST.S_HOLD4 "
        + "FROM TV_PAYOUT_DETAIL_LIST "
        +" WHERE " 
        + "S_ID = ?"
        ;
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE TV_PAYOUT_DETAIL_LIST SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_PAYOUT_DETAIL_LIST " 
        + " WHERE "
        + "S_ID = ?"
        ;
  ...
  {
     TvPayoutDetailListDto dto = (TvPayoutDetailListDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvPayoutDetailListDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvPayoutDetailListDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvPayoutDetailListPK pk = (TvPayoutDetailListPK)_pk ;
    ...
    {
        TvPayoutDetailListPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvPayoutDetailListPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvPayoutDetailListPK)(pks.get(i)) ; 
        ...
        if (results!=null && results.size() > 0)
        {
            TvPayoutDetailListDto[] dtos = new TvPayoutDetailListDto[0];
		    dtos = (TvPayoutDetailListDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvPayoutDetailListDto  dto = new  TvPayoutDetailListDto ();
             //S_ID
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                 		throw new SQLException("数据库表：TV_PAYOUT_DETAIL_LIST没有检查修改的字段");
    }
