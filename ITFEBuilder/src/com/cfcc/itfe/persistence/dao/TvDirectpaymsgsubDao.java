...
/**
 * <p>Title: DAO of table: TV_DIRECTPAYMSGSUB</p>
...
public class TvDirectpaymsgsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_DIRECTPAYMSGSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_DIRECTPAYMSGSUB.I_VOUSRLNO, TV_DIRECTPAYMSGSUB.I_DETAILSEQNO, TV_DIRECTPAYMSGSUB.S_ORGCODE, TV_DIRECTPAYMSGSUB.S_PACKAGENO, TV_DIRECTPAYMSGSUB.S_BUDGETUNITCODE, "
        + "TV_DIRECTPAYMSGSUB.S_TAXTICKETNO, TV_DIRECTPAYMSGSUB.S_LINE, TV_DIRECTPAYMSGSUB.S_OFYEAR, TV_DIRECTPAYMSGSUB.I_NOAFTERPACKAGE, TV_DIRECTPAYMSGSUB.S_FUNSUBJECTCODE, "
        + "TV_DIRECTPAYMSGSUB.S_ECOSUBJECTCODE, TV_DIRECTPAYMSGSUB.N_MONEY, TV_DIRECTPAYMSGSUB.S_ACCDATE, TV_DIRECTPAYMSGSUB.S_USERCODE, TV_DIRECTPAYMSGSUB.S_DEMO, "
        + "TV_DIRECTPAYMSGSUB.TS_SYSUPDATE, TV_DIRECTPAYMSGSUB.S_AGENCYCODE, TV_DIRECTPAYMSGSUB.S_AGENCYNAME, TV_DIRECTPAYMSGSUB.S_EXPFUNCNAME, TV_DIRECTPAYMSGSUB.S_EXPFUNCCODE1, "
        + "TV_DIRECTPAYMSGSUB.S_EXPFUNCNAME1, TV_DIRECTPAYMSGSUB.S_EXPFUNCCODE2, TV_DIRECTPAYMSGSUB.S_EXPFUNCNAME2, TV_DIRECTPAYMSGSUB.S_EXPFUNCCODE3, TV_DIRECTPAYMSGSUB.S_EXPFUNCNAME3, "
        + "TV_DIRECTPAYMSGSUB.S_PROCATCODE, TV_DIRECTPAYMSGSUB.S_PROCATNAME, TV_DIRECTPAYMSGSUB.S_HOLD1, TV_DIRECTPAYMSGSUB.S_HOLD2, TV_DIRECTPAYMSGSUB.S_HOLD3, "
        + "TV_DIRECTPAYMSGSUB.S_HOLD4, TV_DIRECTPAYMSGSUB.S_ID "
        + "FROM TV_DIRECTPAYMSGSUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_DELETE =
        "DELETE FROM TV_DIRECTPAYMSGSUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_DETAILSEQNO = ?"
        ;
  ...
  {
     TvDirectpaymsgsubDto dto = (TvDirectpaymsgsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvDirectpaymsgsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvDirectpaymsgsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvDirectpaymsgsubPK pk = (TvDirectpaymsgsubPK)_pk ;
    ...
    {
        TvDirectpaymsgsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (TvDirectpaymsgsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (TvDirectpaymsgsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            TvDirectpaymsgsubDto[] dtos = new TvDirectpaymsgsubDto[0];
		    dtos = (TvDirectpaymsgsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvDirectpaymsgsubDto  dto = new  TvDirectpaymsgsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                          		throw new SQLException("数据库表：TV_DIRECTPAYMSGSUB没有检查修改的字段");
    }
