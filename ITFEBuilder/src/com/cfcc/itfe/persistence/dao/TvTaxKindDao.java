...
/**
 * <p>Title: DAO of table: TV_TAX_KIND</p>
...
public class TvTaxKindDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_TAX_KIND ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_TAX_KIND.S_SEQ, TV_TAX_KIND.I_PROJECTID, TV_TAX_KIND.S_LIMITDATE, TV_TAX_KIND.S_BUDGETSUBJECTCODE, TV_TAX_KIND.S_TAXTYPENAME, "
        + "TV_TAX_KIND.C_BUDGETLEVEL, TV_TAX_KIND.S_VICESIGN, TV_TAX_KIND.F_SUBJECTAMT, TV_TAX_KIND.C_TAXTYPE, TV_TAX_KIND.S_TAXSTARTDATE, "
        + "TV_TAX_KIND.I_DETAILNO, TV_TAX_KIND.S_TAXENDDATE, TV_TAX_KIND.TS_UPDATE "
        + "FROM TV_TAX_KIND "
        +" WHERE " 
  ...
  {
     TvTaxKindDto dto = (TvTaxKindDto)_dto ;
   ...
   */
	...
	*/
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvTaxKindPK pk = (TvTaxKindPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TvTaxKindDto[] dtos = new TvTaxKindDto[0];
		    dtos = (TvTaxKindDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvTaxKindDto  dto = new  TvTaxKindDto ();
             //S_SEQ
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                 		throw new SQLException("数据库表：TV_TAX_KIND没有检查修改的字段");
    }
