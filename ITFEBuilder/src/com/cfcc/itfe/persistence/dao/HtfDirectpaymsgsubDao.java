...
/**
 * <p>Title: DAO of table: HTF_DIRECTPAYMSGSUB</p>
...
public class HtfDirectpaymsgsubDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO HTF_DIRECTPAYMSGSUB ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "HTF_DIRECTPAYMSGSUB.I_VOUSRLNO, HTF_DIRECTPAYMSGSUB.I_SEQNO, HTF_DIRECTPAYMSGSUB.S_ID, HTF_DIRECTPAYMSGSUB.S_VOUCHERBILLID, HTF_DIRECTPAYMSGSUB.S_VOUCHERBILLNO, "
        + "HTF_DIRECTPAYMSGSUB.S_VOUCHERNO, HTF_DIRECTPAYMSGSUB.S_FUNDTYPECODE, HTF_DIRECTPAYMSGSUB.S_FUNDTYPENAME, HTF_DIRECTPAYMSGSUB.S_BGTTYPECODE, HTF_DIRECTPAYMSGSUB.S_BGTTYPENAME, "
        + "HTF_DIRECTPAYMSGSUB.S_PROCATCODE, HTF_DIRECTPAYMSGSUB.S_PROCATNAME, HTF_DIRECTPAYMSGSUB.S_PAYKINDCODE, HTF_DIRECTPAYMSGSUB.S_PAYKINDNAME, HTF_DIRECTPAYMSGSUB.S_MOFDEPCODE, "
        + "HTF_DIRECTPAYMSGSUB.S_MOFDEPNAME, HTF_DIRECTPAYMSGSUB.S_FILENOCODE, HTF_DIRECTPAYMSGSUB.S_FILENONAME, HTF_DIRECTPAYMSGSUB.S_SUPDEPCODE, HTF_DIRECTPAYMSGSUB.S_SUPDEPNAME, "
        + "HTF_DIRECTPAYMSGSUB.S_AGENCYCODE, HTF_DIRECTPAYMSGSUB.S_AGENCYNAME, HTF_DIRECTPAYMSGSUB.S_EXPFUNCCODE, HTF_DIRECTPAYMSGSUB.S_EXPFUNCNAME, HTF_DIRECTPAYMSGSUB.S_EXPECOCODE, "
        + "HTF_DIRECTPAYMSGSUB.S_EXPECONAME, HTF_DIRECTPAYMSGSUB.S_DEPPROCODE, HTF_DIRECTPAYMSGSUB.S_DEPPRONAME, HTF_DIRECTPAYMSGSUB.S_PAYEEACCTNO, HTF_DIRECTPAYMSGSUB.S_PAYEEACCTNAME, "
        + "HTF_DIRECTPAYMSGSUB.S_PAYEEACCTBANKNAME, HTF_DIRECTPAYMSGSUB.S_PAYEEACCTBANKNO, HTF_DIRECTPAYMSGSUB.N_PAYAMT, HTF_DIRECTPAYMSGSUB.S_REMARK, HTF_DIRECTPAYMSGSUB.S_XPAYDATE, "
        + "HTF_DIRECTPAYMSGSUB.S_XAGENTBUSINESSNO, HTF_DIRECTPAYMSGSUB.S_XCHECKNO, HTF_DIRECTPAYMSGSUB.N_XPAYAMT, HTF_DIRECTPAYMSGSUB.S_XPAYEEACCTBANKNAME, HTF_DIRECTPAYMSGSUB.S_XPAYEEACCTNO, "
        + "HTF_DIRECTPAYMSGSUB.S_XPAYEEACCTNAME, HTF_DIRECTPAYMSGSUB.S_XADDWORD, HTF_DIRECTPAYMSGSUB.S_HOLD1, HTF_DIRECTPAYMSGSUB.S_HOLD2, HTF_DIRECTPAYMSGSUB.S_HOLD3, "
        + "HTF_DIRECTPAYMSGSUB.S_HOLD4, HTF_DIRECTPAYMSGSUB.S_EXT1, HTF_DIRECTPAYMSGSUB.S_EXT2, HTF_DIRECTPAYMSGSUB.S_EXT3 "
        + "FROM HTF_DIRECTPAYMSGSUB "
        +" WHERE " 
   ...
   /* SQL to select batch data where condition  */
    ...
    private static final String SQL_UPDATE =
        "UPDATE HTF_DIRECTPAYMSGSUB SET "
    ...
    private static final String SQL_DELETE =
        "DELETE FROM HTF_DIRECTPAYMSGSUB " 
        + " WHERE "
        + "I_VOUSRLNO = ? AND I_SEQNO = ?"
        ;
  ...
  {
     HtfDirectpaymsgsubDto dto = (HtfDirectpaymsgsubDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        HtfDirectpaymsgsubDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (HtfDirectpaymsgsubDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       HtfDirectpaymsgsubPK pk = (HtfDirectpaymsgsubPK)_pk ;
    ...
    {
        HtfDirectpaymsgsubPK pk ;
        
        List pks = new ArrayList();  
	  
		for (int i= 0; i< _pks.length ; i++)
 		{
 			pk  = (HtfDirectpaymsgsubPK)_pks[i] ; 
		...
		for (int iBegin = 0; iBegin < pks.size(); iBegin += FIND_BATCH_SIZE)   //
		{
            ...
            try {
                ...
                {
                    pk  = (HtfDirectpaymsgsubPK)(pks.get(i)) ; 
                   if (pk.getIvousrlno()==null)
        ...
        if (results!=null && results.size() > 0)
        {
            HtfDirectpaymsgsubDto[] dtos = new HtfDirectpaymsgsubDto[0];
		    dtos = (HtfDirectpaymsgsubDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             HtfDirectpaymsgsubDto  dto = new  HtfDirectpaymsgsubDto ();
             //I_VOUSRLNO
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                                                                                                             		throw new SQLException("数据库表：HTF_DIRECTPAYMSGSUB没有检查修改的字段");
    }
