...
/**
 * <p>Title: DAO of table: TV_INFILE_DETAIL</p>
...
public class TvInfileDetailDao  implements IDao
{


    /* SQL to insert data */
    private static final String SQL_INSERT =
        "INSERT INTO TV_INFILE_DETAIL ("
    ...
    private static final String SQL_SELECT =
        "SELECT "
        + "TV_INFILE_DETAIL.S_UNITCODE, TV_INFILE_DETAIL.S_RECVTRECODE, TV_INFILE_DETAIL.S_DESCTRECODE, TV_INFILE_DETAIL.S_TBS_TAXORGCODE, TV_INFILE_DETAIL.S_TAXTICKETNO, "
        + "TV_INFILE_DETAIL.S_PAYBOOKKIND, TV_INFILE_DETAIL.S_OPENACCBANKCODE, TV_INFILE_DETAIL.S_BUDGETLEVELCODE, TV_INFILE_DETAIL.S_BUDGETTYPE, TV_INFILE_DETAIL.S_BUDGETSUBCODE, "
        + "TV_INFILE_DETAIL.S_TBS_ASSITSIGN, TV_INFILE_DETAIL.N_MONEY, TV_INFILE_DETAIL.S_FILENAME, TV_INFILE_DETAIL.S_ORGCODE, TV_INFILE_DETAIL.I_NUM, "
        + "TV_INFILE_DETAIL.S_DEALNO, TV_INFILE_DETAIL.S_PACKAGENO, TV_INFILE_DETAIL.S_TAXORGCODE, TV_INFILE_DETAIL.S_ASSITSIGN, TV_INFILE_DETAIL.S_STATUS, "
        + "TV_INFILE_DETAIL.S_SUM_TAXTICKETNO, TV_INFILE_DETAIL.S_TRASRLNO, TV_INFILE_DETAIL.S_COMMITDATE "
        + "FROM TV_INFILE_DETAIL "
        +" WHERE " 
  ...
  {
     TvInfileDetailDto dto = (TvInfileDetailDto)_dto ;
   ...
   */
	...
	*/
    ...
    {
        TvInfileDetailDto dto  ;
     	for (int i= 0; i< _dtos.length ; i++)
 	    {
 		    dto  = (TvInfileDetailDto)_dtos[i] ; 
    	    String msgValid = dto.checkValid() ;
        	if (msgValid != null)
     	    	throw new SQLException("插入错误，"+msgValid) ;
     	}
    ...
    public IDto find(IPK _pk, Connection conn, boolean isLobSupport) throws SQLException
    {
       ...
       TvInfileDetailPK pk = (TvInfileDetailPK)_pk ;
    ...
    public IDto[] find(IPK[] _pks, Connection conn, boolean isLobSupport) throws SQLException
    {
        ...
        if (results!=null && results.size() > 0)
        {
            TvInfileDetailDto[] dtos = new TvInfileDetailDto[0];
		    dtos = (TvInfileDetailDto[]) results.toArray(dtos) ;
		    return dtos ;
        }
        else
        {
    ...
    public List getResults(ResultSet rs, int maxSize, boolean isLobSupport) throws SQLException
    {
        ...
        while (rs.next())
         {
             TvInfileDetailDto  dto = new  TvInfileDetailDto ();
             //S_UNITCODE
  ...
  protected IDto[] getChildrenResults(ResultSet rs ,Class _dto) throws SQLException{
    ...
    */
    ...
    {
                                                            		throw new SQLException("数据库表：TV_INFILE_DETAIL没有检查修改的字段");
    }
